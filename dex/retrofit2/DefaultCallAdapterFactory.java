...
public final class DefaultCallAdapterFactory extends CallAdapter.Factory {
    ...
    public static final class ExecutorCallbackCall<T> implements Call<T> {
        ...
        public class AnonymousClass1 implements Callback<T> {
            ...
            public void onResponse(Call<T> call, final Response<T> response) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.DefaultCallAdapterFactory$ExecutorCallbackCall$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.AnonymousClass1.this.m1890lambda$onResponse$0$retrofit2DefaultCallAdapterFactory$ExecutorCallbackCall$1(callback, response);
                    }
                });
            }
            ...
            public /* synthetic */ void m1890lambda$onResponse$0$retrofit2DefaultCallAdapterFactory$ExecutorCallbackCall$1(Callback callback, Response response) {
            ...
            public /* synthetic */ void m1889lambda$onFailure$1$retrofit2DefaultCallAdapterFactory$ExecutorCallbackCall$1(Callback callback, Throwable t) {
            ...
            public void onFailure(Call<T> call, final Throwable t) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.DefaultCallAdapterFactory$ExecutorCallbackCall$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.AnonymousClass1.this.m1889lambda$onFailure$1$retrofit2DefaultCallAdapterFactory$ExecutorCallbackCall$1(callback, t);
                    }
                });
            }
        }
        ...
        @Override // retrofit2.Call
        public Call<T> clone() {
            return new ExecutorCallbackCall(this.callbackExecutor, this.delegate.mo1888clone());
        }
