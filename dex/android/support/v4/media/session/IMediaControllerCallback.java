        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 11:
                    ...
                    return true;
                case TRANSACTION_onShuffleModeChanged /* 12 */:
                    data.enforceInterface(DESCRIPTOR);
                    onShuffleModeChanged(data.readInt());
                    return true;
                case TRANSACTION_onSessionReady /* 13 */:
                    data.enforceInterface(DESCRIPTOR);
                    onSessionReady();
                    return true;
                case 1598968902:
        ...
        public static class Proxy implements IMediaControllerCallback {
            ...
            public void onShuffleModeChanged(int shuffleMode) throws RemoteException {
                ...
                try {
                    ...
                    boolean _status = this.mRemote.transact(Stub.TRANSACTION_onShuffleModeChanged, _data, null, 1);
                    if (!_status && Stub.getDefaultImpl() != null) {
            ...
            public void onSessionReady() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    boolean _status = this.mRemote.transact(Stub.TRANSACTION_onSessionReady, _data, null, 1);
                    if (!_status && Stub.getDefaultImpl() != null) {
