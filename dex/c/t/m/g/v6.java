...
public class v6 {
    ...
    public static double f110c = 360.0d;
    ...
    public static boolean b(double d2, double d3) {
        ...
        while (i2 <= size) {
            ...
            if (d2 > Math.min(aVar.a(), aVar2.a()) && d2 <= Math.max(aVar.a(), aVar2.a()) && d3 <= Math.max(aVar.b(), aVar2.b()) && Math.abs(aVar.a() - aVar2.a()) >= 1.0E-8d) {
                double a2 = (((d2 - aVar.a()) * (aVar2.b() - aVar.b())) / (aVar2.a() - aVar.a())) + aVar.b();
                if (Math.abs(aVar.b() - aVar2.b()) < 1.0E-8d || d3 <= a2) {
                    i++;
                }
            }
            i2++;
    ...
    public static boolean a(double d2, double d3) {
        return d2 >= f110c && d3 >= b && d2 <= e && d3 <= d && b(d2, d3);
    }
}