...
public class a1 {
        ...
        if (Looper.myLooper() != Looper.getMainLooper()) {
            ...
            if (this.a.bindService(intent, this.d, 1)) {
                try {
                    ...
                    w3.a("OnePlusDeviceIDHelper", "getID", e);
                }
                if (this.f3c != null) {
                    String a2 = a("OUID");
                    boolean a3 = a();
        ...
        if (this.b == null) {
            ...
            if (signatureArr != null && signatureArr.length > 0) {
                ...
                try {
                    ...
                    w3.a("OnePlusDeviceIDHelper", "getID", e2);
                }
            }
            this.b = str2;
        }
        return ((j1.a.C0000a) this.f3c).a(packageName, this.b, str);
    }
    ...
    public final boolean a() {
        ...
        try {
            ...
            w3.a("OnePlusDeviceIDHelper", "isSupport 1+", e);
            return false;
        }
    }
