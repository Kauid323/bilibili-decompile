...
@DebugMetadata(c = "video.biz.offline.base.infra.storage.db.DBDataStorage", f = "DBDataStorage.kt", i = {0, 0, 0, 0, 0, 0, 0}, l = {AddCustomDanmaku.TYPE_LIVE_DANMU_V2}, m = "search", n = {ChronosDanmakuSender.KEY_MARK_DANMAKU, "this_$iv", "logTag$iv", "$this$safeCall_u24lambda_u240$iv", "$i$f$safeCall", "$i$a$-runCatching-DBDataStorage$safeCall$1$iv", "$i$a$-safeCall-DBDataStorage$search$2"}, s = {"L$0", "L$1", "L$2", "L$3", "I$0", "I$1", "I$2"}, v = 1)
public final class DBDataStorage$search$1 extends ContinuationImpl {
    int I$0;
    int I$1;
    int I$2;
    Object L$0;
    ...
    public DBDataStorage$search$1(DBDataStorage dBDataStorage, Continuation<? super DBDataStorage$search$1> continuation) {
        super(continuation);
