...
@DebugMetadata(c = "video.biz.offline.base.infra.storage.db.DBDataStorage", f = "DBDataStorage.kt", i = {0, 0, 0, 0, 0, 0, 0}, l = {24}, m = "addVideos", n = {"videos", "this_$iv", "logTag$iv", "$this$safeCallUnit_u24lambda_u240$iv", "$i$f$safeCallUnit", "$i$a$-runCatching-DBDataStorage$safeCallUnit$1$iv", "$i$a$-safeCallUnit-DBDataStorage$addVideos$2"}, s = {"L$0", "L$1", "L$2", "L$3", "I$0", "I$1", "I$2"}, v = 1)
public final class DBDataStorage$addVideos$1 extends ContinuationImpl {
    int I$0;
    int I$1;
    int I$2;
    Object L$0;
    ...
    public DBDataStorage$addVideos$1(DBDataStorage dBDataStorage, Continuation<? super DBDataStorage$addVideos$1> continuation) {
        super(continuation);
