...
public final class XMLDanmakuTask implements ITask {
    ...
    public XMLDanmakuTask(String url, String fullPath, TaskType type, String md5, long size, String key) {
    ...
    */
    public /* synthetic */ XMLDanmakuTask(String str, String str2, TaskType taskType, String str3, long j, String str4, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private final void downloadDanmaku() {
        BuildersKt.launch$default(OfflineScopeKt.getDownloadScope(), (CoroutineContext) null, (CoroutineStart) null, new XMLDanmakuTask$downloadDanmaku$1(this, null), 3, (Object) null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void updateDanmakuCount(String str) {
        int count;
        if (!StringsKt.isBlank(str) && StringsKt.split$default(str, new String[]{"</d>"}, false, 0, 6, (Object) null).size() - 1 > 0) {
            new DownloadLog(getKey()).info("update XMLDanmakuTask count: " + count);
    ...
    public String toString() {
        ...
        String url = getUrl();
        return type + " XMLDanmakuTask Task(url='" + url + "', fullPath='" + getFullPath() + "')";
    }
}