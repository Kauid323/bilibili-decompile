...
@DebugMetadata(c = "video.biz.offline.list.logic.statemachine.OfflineHomePageStateMachine$childSpec$7", f = "OfflineHomePageStateMachine.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class OfflineHomePageStateMachine$childSpec$7 extends SuspendLambda implements Function3<OfflineListAction.Delete, State<OfflinePageState>, Continuation<? super ChangedState<? extends OfflinePageState>>, Object> {
    /* synthetic */ Object L$0;
    /* synthetic */ Object L$1;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    public OfflineHomePageStateMachine$childSpec$7(Continuation<? super OfflineHomePageStateMachine$childSpec$7> continuation) {
    ...
    public final Object invoke(OfflineListAction.Delete delete, State<OfflinePageState> state, Continuation<? super ChangedState<OfflinePageState>> continuation) {
        OfflineHomePageStateMachine$childSpec$7 offlineHomePageStateMachine$childSpec$7 = new OfflineHomePageStateMachine$childSpec$7(continuation);
        offlineHomePageStateMachine$childSpec$7.L$0 = delete;
        offlineHomePageStateMachine$childSpec$7.L$1 = state;
        return offlineHomePageStateMachine$childSpec$7.invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                LogKt.getVBLog().info("OfflineHomePageStateMachine delete action: " + action + ", taskKeys: " + taskKeys + ", hasGroup: " + ($this$any$iv != null));
                final boolean z = $this$any$iv != null;
                return state.override(new Function1() { // from class: video.biz.offline.list.logic.statemachine.OfflineHomePageStateMachine$childSpec$7$$ExternalSyntheticLambda0
                    public final Object invoke(Object obj) {
                        OfflinePageState invokeSuspend$lambda$2;
                        invokeSuspend$lambda$2 = OfflineHomePageStateMachine$childSpec$7.invokeSuspend$lambda$2(taskKeys, z, (OfflinePageState) obj);
