...
@DebugMetadata(c = "video.biz.offline.list.logic.statemachine.OfflineDownloadingPageStateMachine$childSpec$8", f = "OfflineDownloadingPageStateMachine.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class OfflineDownloadingPageStateMachine$childSpec$8 extends SuspendLambda implements Function3<OfflineListAction.DeleteConfirmed, State<OfflinePageState>, Continuation<? super ChangedState<? extends OfflinePageState>>, Object> {
    ...
    public OfflineDownloadingPageStateMachine$childSpec$8(OfflineDownloadingPageStateMachine offlineDownloadingPageStateMachine, Continuation<? super OfflineDownloadingPageStateMachine$childSpec$8> continuation) {
    ...
    public final Object invoke(OfflineListAction.DeleteConfirmed deleteConfirmed, State<OfflinePageState> state, Continuation<? super ChangedState<OfflinePageState>> continuation) {
        OfflineDownloadingPageStateMachine$childSpec$8 offlineDownloadingPageStateMachine$childSpec$8 = new OfflineDownloadingPageStateMachine$childSpec$8(this.this$0, continuation);
        offlineDownloadingPageStateMachine$childSpec$8.L$0 = deleteConfirmed;
        offlineDownloadingPageStateMachine$childSpec$8.L$1 = state;
        return offlineDownloadingPageStateMachine$childSpec$8.invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: OfflineDownloadingPageStateMachine.kt */
    @Metadata(d1 = {"\u0000\u0006\n\u0000\n\u0002\u0010\u0002\u0010\u0000\u001a\u00020\u0001H\n"}, d2 = {"<anonymous>", ""}, k = 3, mv = {2, 2, 0}, xi = PlayerToastConfig.QUEUE_INSERT)
    @DebugMetadata(c = "video.biz.offline.list.logic.statemachine.OfflineDownloadingPageStateMachine$childSpec$8$1", f = "OfflineDownloadingPageStateMachine.kt", i = {}, l = {140}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    /* renamed from: video.biz.offline.list.logic.statemachine.OfflineDownloadingPageStateMachine$childSpec$8$1  reason: invalid class name */
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                return state.override(new Function1() { // from class: video.biz.offline.list.logic.statemachine.OfflineDownloadingPageStateMachine$childSpec$8$$ExternalSyntheticLambda0
                    public final Object invoke(Object obj) {
                        OfflinePageState invokeSuspend$lambda$0;
                        invokeSuspend$lambda$0 = OfflineDownloadingPageStateMachine$childSpec$8.invokeSuspend$lambda$0((OfflinePageState) obj);
