...
@DebugMetadata(c = "video.biz.offline.list.ui.page.OfflineHomePageKt$OfflineCacheHome$4$3$1$4$1$1", f = "OfflineHomePage.kt", i = {0}, l = {233, 237, 238}, m = "invokeSuspend", n = {"keys"}, s = {"L$0"}, v = 1)
public final class OfflineHomePageKt$OfflineCacheHome$4$3$1$4$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ String $key;
    final /* synthetic */ OfflineHomePageStateMachine $machine;
    ...
    public OfflineHomePageKt$OfflineCacheHome$4$3$1$4$1$1(OfflinePageOperation offlinePageOperation, String str, OfflineHomePageStateMachine offlineHomePageStateMachine, State<OfflinePageState> state, Toaster toaster, Continuation<? super OfflineHomePageKt$OfflineCacheHome$4$3$1$4$1$1> continuation) {
        super(2, continuation);
        this.$operations = offlinePageOperation;
        this.$key = str;
        this.$machine = offlineHomePageStateMachine;
        this.$state$delegate = state;
        this.$toaster = toaster;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OfflineHomePageKt$OfflineCacheHome$4$3$1$4$1$1(this.$operations, this.$key, this.$machine, this.$state$delegate, this.$toaster, continuation);
    }
    ...
    */
    public final Object invokeSuspend(Object $result) {
        OfflinePageState OfflineCacheHome$lambda$1;
        ...
        switch (this.label) {
            case 0:
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[this.$operations.ordinal()]) {
                    case 1:
                        OfflineCacheHome$lambda$1 = OfflineHomePageKt.OfflineCacheHome$lambda$1(this.$state$delegate);
                        Iterable $this$map$iv = OfflineCacheHome$lambda$1.selectedCompletedTask(this.$key);
    ...
    /* compiled from: OfflineHomePage.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 2, 0}, xi = PlayerToastConfig.QUEUE_INSERT)
    @DebugMetadata(c = "video.biz.offline.list.ui.page.OfflineHomePageKt$OfflineCacheHome$4$3$1$4$1$1$1", f = "OfflineHomePage.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    /* renamed from: video.biz.offline.list.ui.page.OfflineHomePageKt$OfflineCacheHome$4$3$1$4$1$1$1  reason: invalid class name */
    /* loaded from: /data/np/file-convert/20260228071740acaead6b-f6d3-43df-b685-c5417486b61a/20260228071740acaead6b-f6d3-43df-b685-c5417486b61a.dex */
