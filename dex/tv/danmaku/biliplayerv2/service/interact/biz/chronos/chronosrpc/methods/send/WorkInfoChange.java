...
public final class WorkInfoChange {
    ...
    public static final class Request {
        ...
        public final List<GetWorkInfo.Attachment> getAttachment() {
            return EnhancedUnmodifiabilityKt.unmodifiable(this.attachment);
        }

        public final void setAttachment(List<GetWorkInfo.Attachment> list) {
