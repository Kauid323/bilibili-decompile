...
public class IjkMediaMeta {
    ...
    public static final String IJKM_ASSET_KEY_BACKUP_URL0 = "backup_url0";
    public static final String IJKM_ASSET_KEY_BACKUP_URL1 = "backup_url1";
    public static final String IJKM_ASSET_KEY_BASE_URL = "base_url";
    public static final String IJKM_ASSET_KEY_CODEC_TYPE = "codec_type";
    public static final String IJKM_ASSET_KEY_DRM_KID = "stream_drm_kid";
    public static final String IJKM_ASSET_KEY_DRM_TYPE = "stream_drm_type";
    public static final String IJKM_ASSET_KEY_NORMAL_VIDEO = "normal_video";
    public static final String IJKM_ASSET_KEY_RELATED_AUDIO_ID = "related_audio_id";
    public static final String IJKM_ASSET_KEY_SOLUTION_TYPE = "stream_solution_type";
    public static final String IJKM_ASSET_KEY_STREAM_BANDWIDTH = "stream_bandwidth";
    public static final String IJKM_ASSET_KEY_STREAM_ID = "stream_id";
    public static final String IJKM_ASSET_KEY_STREAM_SIZE = "stream_size";
    public static final String IJKM_ASSET_KEY_TARGET_QN = "stream_target_qn";
    public static final String IJKM_ASSET_KEY_USAGE_SCENARIO = "stream_usage_scenario";
    ...
    public static final String IJKM_DASH_KEY_VIDEO_266 = "dash_video_266";
    public static final String IJKM_DASH_KEY_VIDEO_AV1 = "dash_video_av1";
    ...
    public static final String IJKM_KEY_ENCODER = "encoder";
    ...
    public String getDurationInline() {
        long duration = this.mDurationUS + PlayerToastConfig.DURATION_5;
    ...
    public static IjkMediaMeta parse(Bundle mediaMeta) {
        ...
        while (it.hasNext()) {
            ...
            if (streamBundle != null) {
                ...
                streamMeta.mEncoder = streamMeta.getString(IJKM_KEY_ENCODER);
                if (!TextUtils.isEmpty(streamMeta.mType)) {
                    ...
                    if (!streamMeta.mType.equalsIgnoreCase("video")) {
                        if (streamMeta.mType.equalsIgnoreCase("audio")) {
    ...
    public static class IjkStreamMeta {
        ...
        public int[] getResolution() {
            int[] result = {0, 0, 1, 1};
            if (this.mWidth > 0 && this.mHeight > 0) {
                result[0] = this.mWidth;
                result[1] = this.mHeight;
            }
            if (this.mSarNum > 0 && this.mSarDen > 0) {
                result[2] = this.mSarNum;
                result[3] = this.mSarDen;
            }
            return result;
        }
        ...
        public float getFps() {
            ...
            return this.mFpsNum / this.mFpsDen;
        }
