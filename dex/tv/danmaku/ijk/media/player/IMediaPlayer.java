...
public interface IMediaPlayer {
    ...
    public static final int MEDIA_INFO_MEDIA_APP_INFO_TRIGGER = 10112;
    ...
    public interface OnTrackerListener {
        void onTrackerReport(boolean z, String str, Map<String, String> map);
    }
    ...
    void setOnPlayerClockChangedListener(Looper looper, OnPlayerClockChangedListener onPlayerClockChangedListener);
