...
public final class BiliAppAdSplashFragmentBinding implements ViewBinding {
    ...
    public static BiliAppAdSplashFragmentBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BiliAppAdSplashFragmentBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.bili_app_ad_splash_fragment, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static BiliAppAdSplashFragmentBinding bind(View rootView) {
        Guideline guideline;
        BiliImageView logo;
                                            ...
                                            if (splashInteractView != null) {
                                                ...
                                                if (splashSecondPageContainer != null) {
                                                    ...
                                                    if (splashView != null) {
                                                        ...
                                                        if (stubFloat != null) {
                                                            return new BiliAppAdSplashFragmentBinding((SplashContainerView) rootView, countDown, countDown2, guideline, labelAd, labelAd2, labelAd3, labelLayout, labelLayout2, labelLayout3, logo, logoLayout, lottieShadow, rootContainer, splashButtonContainer, splashInteractView, splashSecondPageContainer, splashView, stubFloat);
                                                        }
                                                    }
                                                }
                                            }
