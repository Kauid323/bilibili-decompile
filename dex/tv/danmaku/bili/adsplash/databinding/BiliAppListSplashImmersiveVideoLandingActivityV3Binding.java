...
public final class BiliAppListSplashImmersiveVideoLandingActivityV3Binding implements ViewBinding {
    ...
    public static BiliAppListSplashImmersiveVideoLandingActivityV3Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BiliAppListSplashImmersiveVideoLandingActivityV3Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.bili_app_list_splash_immersive_video_landing_activity_v3, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static BiliAppListSplashImmersiveVideoLandingActivityV3Binding bind(View rootView) {
                            ...
                            if (title != null && (topLeftRoundContainer = ViewBindings.findChildViewById(rootView, (id = R.id.top_left_round_container))) != null && (topLiveContainer = ViewBindings.findChildViewById(rootView, (id = R.id.top_live_container))) != null) {
                                ...
                                if (tvEnterLive != null) {
                                    ...
                                    if (videoBackground != null) {
                                        ...
                                        if (videoLayer != null) {
                                            return new BiliAppListSplashImmersiveVideoLandingActivityV3Binding((ConstraintLayout) rootView, btnBack, desc, enterLiveLottie, icon, livingIcon, livingText, maskLayer, muteBtn, textArea, title, topLeftRoundContainer, topLiveContainer, tvEnterLive, videoBackground, videoLayer);
                                        }
                                    }
                                }
                            }
