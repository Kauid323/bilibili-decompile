...
import tv.danmaku.bili.rating.MarketResponse;

/* compiled from: MarketHelper.kt */
@Metadata(d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\bÇ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\b\u0010\u0004\u001a\u00020\u0005H\u0002J\u0006\u0010\f\u001a\u00020\rJ;\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\u00072\b\b\u0002\u0010\u0013\u001a\u00020\r2\u0019\b\u0002\u0010\u0014\u001a\u0013\u0012\u0004\u0012\u00020\u0016\u0012\u0004\u0012\u00020\u00170\u0015¢\u0006\u0002\b\u0018J\u0018\u0010\u000e\u001a\u00020\u00052\u0006\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0019\u001a\u00020\u0016H\u0002R\u001d\u0010\u0006\u001a\u0004\u0018\u00010\u00078BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\b\u0010\t¨\u0006\u001a"}, d2 = {"Ltv/danmaku/bili/rating/MarketHelper;", "", "<init>", "()V", "isSmartisanRom", "", "currentBrand", "", "getCurrentBrand", "()Ljava/lang/String;", "currentBrand$delegate", "Lkotlin/Lazy;", "getSystemMarket", "Ltv/danmaku/bili/rating/AbsMarket;", "launchAppDetail", "Ltv/danmaku/bili/rating/MarketResponse;", "context", "Landroid/content/Context;", "appPkg", "market", "intentAction", "Lkotlin/Function1;", "Landroid/content/Intent;", "", "Lkotlin/ExtensionFunctionType;", "goToMarketIntent", "core_apinkDebug"}, k = 1, mv = {2, 0, 0}, xi = BR.badgeVisibility)
public final class MarketHelper {
    public static final MarketHelper INSTANCE = new MarketHelper();
    private static final Lazy currentBrand$delegate = LazyKt.lazy(new Function0() { // from class: tv.danmaku.bili.rating.MarketHelper$$ExternalSyntheticLambda1
    ...
    public static final String currentBrand_delegate$lambda$0() {
        if (RomUtils.isHuaweiRom()) {
            return AndroidReferenceMatchers.HUAWEI;
        }
        if (RomUtils.isHonorRom()) {
            return "HONOR";
        }
        if (RomUtils.isMiuiRom()) {
            return AndroidReferenceMatchers.XIAOMI;
        }
        if (RomUtils.isOppoRom()) {
            return "OPPO";
        }
        if (RomUtils.isOnePlusRom()) {
            return AndroidReferenceMatchers.ONE_PLUS;
        }
        if (RomUtils.isRealmeRom()) {
            return AndroidReferenceMatchers.REALME;
        }
        if (RomUtils.isVivoRom()) {
            return AndroidReferenceMatchers.VIVO;
        }
        if (RomUtils.isMeizuRom()) {
            return AndroidReferenceMatchers.MEIZU;
        }
    ...
    public final AbsMarket getSystemMarket() {
        AbsMarket systemMarket;
        systemMarket = MarketHelperKt.getSystemMarket(getCurrentBrand());
        return systemMarket;
    }
    ...
    public static /* synthetic */ MarketResponse launchAppDetail$default(MarketHelper marketHelper, Context context, String str, AbsMarket absMarket, Function1 function1, int i, Object obj) {
        ...
        if ((i & 8) != 0) {
            function1 = new Function1() { // from class: tv.danmaku.bili.rating.MarketHelper$$ExternalSyntheticLambda0
