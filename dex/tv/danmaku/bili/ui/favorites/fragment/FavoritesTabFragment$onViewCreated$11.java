...
@DebugMetadata(c = "tv.danmaku.bili.ui.favorites.fragment.FavoritesTabFragment$onViewCreated$11", f = "FavoritesTabFragment.kt", i = {}, l = {BR.paddingStartAndEnd}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class FavoritesTabFragment$onViewCreated$11 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ FavoritesTabFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FavoritesTabFragment$onViewCreated$11(FavoritesTabFragment favoritesTabFragment, Continuation<? super FavoritesTabFragment$onViewCreated$11> continuation) {
        super(2, continuation);
        this.this$0 = favoritesTabFragment;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FavoritesTabFragment$onViewCreated$11(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (flowWithLifecycle.collect(new FlowCollector() { // from class: tv.danmaku.bili.ui.favorites.fragment.FavoritesTabFragment$onViewCreated$11.1
                    ...
                    public final Object emit(FavoritesPageEvent event, Continuation<? super Unit> continuation) {
                        if (Intrinsics.areEqual(event, FavoritesPageEvent.QuitBatchManage.INSTANCE)) {
                            FavoritesTabFragment.this.getViewModel().sendAction(FavoritesAction.QuitBatchManage.INSTANCE);
                            final BiliAppFragmentFavoritesTabBinding $this$emit_u24lambda_u240 = FavoritesTabFragment.this.getBinding();
                            ...
                            Animator.AnimatorListener animatorListener = new Animator.AnimatorListener() { // from class: tv.danmaku.bili.ui.favorites.fragment.FavoritesTabFragment$onViewCreated$11$1$emit$lambda$0$0$$inlined$doOnEnd$1
                            ...
                            Animator.AnimatorListener animatorListener2 = new Animator.AnimatorListener() { // from class: tv.danmaku.bili.ui.favorites.fragment.FavoritesTabFragment$onViewCreated$11$1$emit$lambda$0$1$$inlined$doOnEnd$1
                                @Override // android.animation.Animator.AnimatorListener
                                public void onAnimationRepeat(Animator animator) {
                                }
                            ...
                            FavoritesTabFragment.this.getViewModel().sendAction(FavoritesAction.StartBatchManage.INSTANCE);
                            final BiliAppFragmentFavoritesTabBinding $this$emit_u24lambda_u241 = FavoritesTabFragment.this.getBinding();
                            ...
                            Animator.AnimatorListener animatorListener3 = new Animator.AnimatorListener() { // from class: tv.danmaku.bili.ui.favorites.fragment.FavoritesTabFragment$onViewCreated$11$1$emit$lambda$1$0$$inlined$doOnStart$1
                                @Override // android.animation.Animator.AnimatorListener
                                public void onAnimationRepeat(Animator animator) {
                                }
                            ...
                            Animator.AnimatorListener animatorListener4 = new Animator.AnimatorListener() { // from class: tv.danmaku.bili.ui.favorites.fragment.FavoritesTabFragment$onViewCreated$11$1$emit$lambda$1$1$$inlined$doOnStart$1
                                @Override // android.animation.Animator.AnimatorListener
                                public void onAnimationRepeat(Animator animator) {
                                }
