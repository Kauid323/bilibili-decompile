...
@Metadata(d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\u001a\f\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u0000\u001a\f\u0010\u0003\u001a\u00020\u0001*\u00020\u0002H\u0002\"\u000e\u0010\u0004\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"observerPlayerState", "", "Ltv/danmaku/bili/ui/splash/ad/page/BaseSplash;", "handleRenderStart", "TAG", "", "splash_debug"}, k = 2, mv = {2, 0, 0}, xi = PlayerToastConfig.QUEUE_INSERT)
public final class PlayerStateComponentKt {
    ...
    public static final void observerPlayerState(BaseSplash $this$observerPlayerState) {
        ...
        SplashViewModel viewModel = $this$observerPlayerState.mSplashViewModel;
        if (viewModel == null) {
            return;
        }
        BuildersKt.launch$default(LifecycleOwnerKt.getLifecycleScope((LifecycleOwner) $this$observerPlayerState), (CoroutineContext) null, (CoroutineStart) null, new PlayerStateComponentKt$observerPlayerState$1(viewModel, $this$observerPlayerState, null), 3, (Object) null);
    }
