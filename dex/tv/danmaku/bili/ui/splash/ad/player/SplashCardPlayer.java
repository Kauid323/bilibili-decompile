...
import tv.danmaku.bili.ui.splash.ad.player.dataprovider.SplashCardPlayerConfigKt;
import tv.danmaku.bili.ui.splash.ad.player.dataprovider.SplashPlayableParams;
...
@Metadata(d1 = {"\u0000X\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\n\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\t\n\u0002\b\u0007\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0007\u0018\u00002\u00020\u0001BG\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007\u0012\u0012\u0010\b\u001a\u000e\u0012\u0004\u0012\u00020\u0000\u0012\u0004\u0012\u00020\n0\t\u0012\u0012\u0010\u000b\u001a\u000e\u0012\u0004\u0012\u00020\u0000\u0012\u0004\u0012\u00020\n0\t¢\u0006\u0004\b\f\u0010\rJ\u0006\u0010\u001f\u001a\u00020\nJ\u0006\u0010&\u001a\u00020\nJ\u001c\u0010'\u001a\u00020\n2\u0006\u0010(\u001a\u00020)2\f\u0010*\u001a\b\u0012\u0004\u0012\u00020\n0+J\u0010\u0010,\u001a\u00020\n2\u0006\u0010(\u001a\u00020)H\u0002R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u000e\u0010\u000fR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0010\u0010\u0011R\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u0012\u0010\u0013R\u0010\u0010\u0014\u001a\u0004\u0018\u00010\u0015X\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0016\u001a\u0004\u0018\u00010\u0017X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0018\u001a\u00020\u0019X\u0082\u000e¢\u0006\u0002\n\u0000R\"\u0010\u001c\u001a\u0004\u0018\u00010\u001b2\b\u0010\u001a\u001a\u0004\u0018\u00010\u001b@BX\u0086\u000e¢\u0006\b\n\u0000\u001a\u0004\b\u001d\u0010\u001eR\u0011\u0010 \u001a\u00020!8F¢\u0006\u0006\u001a\u0004\b\"\u0010#R\u0011\u0010$\u001a\u00020!8F¢\u0006\u0006\u001a\u0004\b%\u0010#¨\u0006-"}, d2 = {"Ltv/danmaku/bili/ui/splash/ad/player/SplashCardPlayer;", "", "fragment", "Landroidx/fragment/app/Fragment;", "container", "Landroid/view/ViewGroup;", "splash", "Ltv/danmaku/bili/ui/splash/ad/model/Splash;", "onInitPlayerReporter", "Lkotlin/Function1;", "", "onRegisterStateCallback", "<init>", "(Landroidx/fragment/app/Fragment;Landroid/view/ViewGroup;Ltv/danmaku/bili/ui/splash/ad/model/Splash;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;)V", "getFragment", "()Landroidx/fragment/app/Fragment;", "getContainer", "()Landroid/view/ViewGroup;", "getSplash", "()Ltv/danmaku/bili/ui/splash/ad/model/Splash;", "token", "Ltv/danmaku/video/bilicardplayer/player/BiliCardPlayerScene$CardPlayTask$Token;", "playerScene", "Ltv/danmaku/video/bilicardplayer/player/BiliCardPlayerScene;", "isPlayerShared", "", "value", "Ltv/danmaku/video/bilicardplayer/player/BiliCardPlayerScene$CardPlayTask;", "task", "getTask", "()Ltv/danmaku/video/bilicardplayer/player/BiliCardPlayerScene$CardPlayTask;", "play", "currentPosition", "", "getCurrentPosition", "()J", "duration", "getDuration", "stop", "sharePlayer", "jumpUrl", "", "onEnd", "Lkotlin/Function0;", "jumpToStory", "splash_debug"}, k = 1, mv = {2, 0, 0}, xi = PlayerToastConfig.QUEUE_INSERT)
public final class SplashCardPlayer {
    ...
    public SplashCardPlayer(Fragment fragment, ViewGroup container, Splash splash, Function1<? super SplashCardPlayer, Unit> function1, Function1<? super SplashCardPlayer, Unit> function12) {
    ...
    public final void sharePlayer(final String jumpUrl, final Function0<Unit> function0) {
        ...
        ValueAnimator $this$sharePlayer_u24lambda_u240 = ValueAnimator.ofFloat(DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN, 1.0f);
        ...
        $this$sharePlayer_u24lambda_u240.addListener(new Animator.AnimatorListener() { // from class: tv.danmaku.bili.ui.splash.ad.player.SplashCardPlayer$sharePlayer$1
        ...
        $this$sharePlayer_u24lambda_u240.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: tv.danmaku.bili.ui.splash.ad.player.SplashCardPlayer$$ExternalSyntheticLambda0
    ...
    public static final void sharePlayer$lambda$1(int $statusBarDrawHeight, int $storyVideoOffset, int $videoStartHeight, int $videoInterval, Rect $rect, SplashCardPlayer this$0, ValueAnimator animation) {
        ...
        if (biliCardPlayerScene != null) {
            BiliCardPlayerScene.updateViewPort$default(biliCardPlayerScene, $rect, CollectionsKt.listOf(BuiltInLayer.LayerRender), null, true, 4, null);
        }
    ...
    public final void jumpToStory(String jumpUrl) {
        ...
        BiliCardPlayerScene biliCardPlayerScene = this.playerScene;
        final Integer shareId = biliCardPlayerScene != null ? Integer.valueOf(BiliCardPlayerScene.prepareForShare$default(biliCardPlayerScene, false, 1, null)) : null;
        BiliCardPlayerScene.CardPlayTask.Token token = this.token;
        ...
        if (Intrinsics.areEqual(originUri.getScheme(), "bilibili") && Intrinsics.areEqual(originUri.getAuthority(), "story")) {
            Uri build = originUri.buildUpon().authority("story_translucent").build();
            Intrinsics.checkNotNullExpressionValue(build, "build(...)");
            routeRequest.setTargetUri(build);
        }
        BLRouter.routeTo(routeRequest.extras(new Function1() { // from class: tv.danmaku.bili.ui.splash.ad.player.SplashCardPlayer$$ExternalSyntheticLambda1
    ...
    public static final Unit jumpToStory$lambda$0(SplashCardPlayer this$0, Integer $shareId, Object $aspect, MutableBundleLike $this$extras) {
        ...
        SplashVideoInfo splashVideoInfo = this$0.splash.splashStoryInfo;
        $this$extras.put("avid", String.valueOf(splashVideoInfo != null ? splashVideoInfo.getAvid() : 0L));
        ...
        $this$extras.put(AuthorSpaceHeaderVideoModel.EXTRA_PARAM_PLAYER_HEIGHT, String.valueOf(this$0.splash.videoHeight));
        $this$extras.put(AuthorSpaceHeaderVideoModel.EXTRA_PARAM_PLAYER_WIDTH, String.valueOf(this$0.splash.videoWidth));
        $this$extras.put(AuthorSpaceHeaderVideoModel.EXTRA_PARAM_PLAYER_ROTATE, "0");
        $this$extras.put("from_spmid", SplashConstantKt.SPLASH_SPMID);
