...
public final class SplashCircleCountdownButtonKt {
    ...
    public static final Unit CircleCountdownView_vRFhKjU$lambda$9(float f, float f2, float f3, long j, long j2, int i, Function0 function0, int i2, int i3, Composer composer, int i4) {
        m1498CircleCountdownViewvRFhKjU(f, f2, f3, j, j2, i, function0, composer, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
    ...
    public static /* synthetic */ ComposeView createCircleCountdownButton$default(Context context, int i, Function0 function0, Function0 function02, int i2, Object obj) {
        ...
        if ((i2 & 4) != 0) {
            function0 = new Function0() { // from class: tv.danmaku.bili.ui.splash.ad.button.widget.SplashCircleCountdownButtonKt$$ExternalSyntheticLambda0
        ...
        if ((i2 & 8) != 0) {
            function02 = new Function0() { // from class: tv.danmaku.bili.ui.splash.ad.button.widget.SplashCircleCountdownButtonKt$$ExternalSyntheticLambda1
                public final Object invoke() {
                    Unit unit;
                    unit = Unit.INSTANCE;
                    return unit;
    ...
    public static final ComposeView createCircleCountdownButton(Context context, final int duration, final Function0<Unit> function0, final Function0<Unit> function02) {
        ...
        final ComposeView $this$createCircleCountdownButton_u24lambda_u242 = new ComposeView(context2, (AttributeSet) null, 0, 6, (DefaultConstructorMarker) null);
        ...
        ((ConstraintLayout.LayoutParams) layoutParams).bottomMargin = ListExtentionsKt.toPx((int) Player.PLAYER_QUALITY_HDR);
        $this$createCircleCountdownButton_u24lambda_u242.setLayoutParams(layoutParams);
        $this$createCircleCountdownButton_u24lambda_u242.setOnClickListener(new View.OnClickListener() { // from class: tv.danmaku.bili.ui.splash.ad.button.widget.SplashCircleCountdownButtonKt$$ExternalSyntheticLambda7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                SplashCircleCountdownButtonKt.createCircleCountdownButton$lambda$2$1(function0, $this$createCircleCountdownButton_u24lambda_u242, view2);
            }
        });
        $this$createCircleCountdownButton_u24lambda_u242.setContent(ComposableLambdaKt.composableLambdaInstance(-142593809, true, new Function2() { // from class: tv.danmaku.bili.ui.splash.ad.button.widget.SplashCircleCountdownButtonKt$$ExternalSyntheticLambda8
    ...
    public static final Unit createCircleCountdownButton$lambda$2$2(int $duration, final Function0 $onFinish, final ComposeView $this_apply, Composer $composer, int $changed) {
        ComposerKt.sourceInformation($composer, "C47@1944L76,47@1903L117:SplashCircleCountdownButton.kt#ceavq9");
        if (!$composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            $composer.skipToGroupEnd();
        } else {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-142593809, $changed, -1, "tv.danmaku.bili.ui.splash.ad.button.widget.createCircleCountdownButton.<anonymous>.<anonymous> (SplashCircleCountdownButton.kt:47)");
            }
            ComposerKt.sourceInformationMarkerStart($composer, 406304731, "CC(remember):SplashCircleCountdownButton.kt#9igjgp");
            boolean invalid$iv = $composer.changed($onFinish) | $composer.changedInstance($this_apply);
            Object it$iv = $composer.rememberedValue();
            if (invalid$iv || it$iv == Composer.Companion.getEmpty()) {
                Object value$iv = new Function0() { // from class: tv.danmaku.bili.ui.splash.ad.button.widget.SplashCircleCountdownButtonKt$$ExternalSyntheticLambda6
                    public final Object invoke() {
            ...
            m1498CircleCountdownViewvRFhKjU(DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN, DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN, DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN, 0L, 0L, $duration, (Function0) it$iv, $composer, 0, 31);
            if (ComposerKt.isTraceInProgress()) {
    ...
    */
    private static final void m1498CircleCountdownViewvRFhKjU(float circleWidth, float crossLineWidth, float crossLinePercent, long j, long j2, int duration, Function0<Unit> function0, Composer $composer, final int $changed, final int i) {
        ...
        int i4;
        int i5;
        Composer $composer2 = $composer.startRestartGroup(345730138);
        ComposerKt.sourceInformation($composer2, "C(CircleCountdownView)N(circleWidth,crossLineWidth,crossLinePercent,mainColor:c#ui.graphics.Color,progressColor:c#ui.graphics.Color,duration,onFinish)65@2383L41,68@2441L46,73@2602L41,72@2515L224,79@2816L1650,77@2744L1723,115@4501L27,115@4473L55:SplashCircleCountdownButton.kt#ceavq9");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (i6 != 0) {
            ...
            crossLinePercent2 = crossLinePercent;
            $dirty |= $composer2.changed(crossLinePercent2) ? IjkMediaPlayer.FFP_BUFFERING_END_REASON_UNKNOWN : 128;
        } else {
            crossLinePercent2 = crossLinePercent;
        }
        if (($changed & 3072) == 0) {
        ...
        if (i7 != 0) {
            ...
            i2 = i6;
            j4 = j2;
            $dirty |= $composer2.changed(j4) ? IjkFnHelper.PLAY_URL_FLAG_HDR_VIVID : 8192;
        } else {
            i2 = i6;
            j4 = j2;
        }
        ...
        if (i8 != 0) {
            ...
            duration2 = duration;
            $dirty |= $composer2.changed(duration2) ? 131072 : 65536;
        } else {
            duration2 = duration;
        }
        int i9 = i & 64;
        ...
        if ($composer2.shouldExecute(($dirty & 599187) != 599186, $dirty & 1)) {
            ...
            ComposerKt.sourceInformation($composer2, "63@2353L2");
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i9 != 0) {
                    ComposerKt.sourceInformationMarkerStart($composer2, 1534190236, "CC(remember):SplashCircleCountdownButton.kt#9igjgp");
                    float circleWidth5 = circleWidth3;
                    Object it$iv = $composer2.rememberedValue();
                    int $dirty2 = $dirty;
                    if (it$iv == Composer.Companion.getEmpty()) {
                        Object value$iv = new Function0() { // from class: tv.danmaku.bili.ui.splash.ad.button.widget.SplashCircleCountdownButtonKt$$ExternalSyntheticLambda2
                            public final Object invoke() {
                                Unit unit;
                                unit = Unit.INSTANCE;
                                return unit;
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(345730138, $dirty, -1, "tv.danmaku.bili.ui.splash.ad.button.widget.CircleCountdownView (SplashCircleCountdownButton.kt:64)");
            }
            ComposerKt.sourceInformationMarkerStart($composer2, 1534191235, "CC(remember):SplashCircleCountdownButton.kt#9igjgp");
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ComposerKt.sourceInformationMarkerStart($composer2, 1534193096, "CC(remember):SplashCircleCountdownButton.kt#9igjgp");
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            float f = CircleCountdownView_vRFhKjU$lambda$3(play$delegate) ? DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN : -360.0f;
            AnimationSpec tween$default = AnimationSpecKt.tween$default(duration2, 0, EasingKt.getLinearEasing(), 2, (Object) null);
            ComposerKt.sourceInformationMarkerStart($composer2, 1534198243, "CC(remember):SplashCircleCountdownButton.kt#9igjgp");
            boolean invalid$iv = (3670016 & $dirty) == 1048576;
            Object it$iv3 = $composer2.rememberedValue();
            if (invalid$iv) {
            }
            Object value$iv4 = new Function1() { // from class: tv.danmaku.bili.ui.splash.ad.button.widget.SplashCircleCountdownButtonKt$$ExternalSyntheticLambda3
            ...
            it$iv3 = value$iv4;
            ComposerKt.sourceInformationMarkerEnd($composer2);
            final State angleAnimation$delegate = AnimateAsStateKt.animateFloatAsState(f, tween$default, (float) DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN, "angle", (Function1) it$iv3, $composer2, 3072, 4);
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1534206700, "CC(remember):SplashCircleCountdownButton.kt#9igjgp");
            boolean invalid$iv2 = ((57344 & $dirty) == 16384) | (((($dirty & 14) ^ 6) > 4 && $composer2.changed(circleWidth3)) || ($dirty & 6) == 4) | (((($dirty & 7168) ^ 3072) > 2048 && $composer2.changed(j3)) || ($dirty & 3072) == 2048) | (($dirty & 896) == 256) | (((($dirty & 112) ^ 48) > 32 && $composer2.changed(crossLineWidth2)) || ($dirty & 48) == 32) | $composer2.changed(angleAnimation$delegate);
            ...
            Object value$iv5 = new Function1() { // from class: tv.danmaku.bili.ui.splash.ad.button.widget.SplashCircleCountdownButtonKt$$ExternalSyntheticLambda4
                public final Object invoke(Object obj) {
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1534258997, "CC(remember):SplashCircleCountdownButton.kt#9igjgp");
        ...
        if (endRestartGroup != null) {
            ...
            endRestartGroup.updateScope(new Function2() { // from class: tv.danmaku.bili.ui.splash.ad.button.widget.SplashCircleCountdownButtonKt$$ExternalSyntheticLambda5
                public final Object invoke(Object obj, Object obj2) {
    ...
    public static final Unit CircleCountdownView_vRFhKjU$lambda$7$0(long j, float $circleRadius, float $circleWidth, long j2, float $crossLinePercent, float $crossLineWidth, State $angleAnimation$delegate, ContentDrawScope $this$drawWithContent) {
        ...
        float f = 2;
        DrawScope.-CC.drawCircle-VaOC9Bg$default((DrawScope) $this$drawWithContent, j, (Size.getMinDimension-impl($this$drawWithContent.getSize-NH-jbRc()) / f) - $circleRadius, 0L, (float) DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN, new Stroke($circleWidth, (float) DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN, 0, 0, (PathEffect) null, 30, (DefaultConstructorMarker) null), (ColorFilter) null, 0, (int) AddCustomDanmaku.TYPE_LIVE_DANMU_V2, (Object) null);
        ...
        DrawScope.-CC.drawLine-NGM6Ib0$default((DrawScope) $this$drawWithContent, j2, j3, Offset.constructor-impl((v1$iv$iv2 << 32) | (v2$iv$iv2 & 4294967295L)), $crossLineWidth, StrokeCap.Companion.getRound-KaPHkGw(), (PathEffect) null, (float) DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN, (ColorFilter) null, 0, 480, (Object) null);
        ...
        DrawScope.-CC.drawLine-NGM6Ib0$default((DrawScope) $this$drawWithContent, j2, j4, Offset.constructor-impl((v1$iv$iv4 << 32) | (v2$iv$iv4 & 4294967295L)), $crossLineWidth, StrokeCap.Companion.getRound-KaPHkGw(), (PathEffect) null, (float) DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN, (ColorFilter) null, 0, 480, (Object) null);
        ...
        DrawScope.-CC.drawArc-yD3GUKo$default((DrawScope) $this$drawWithContent, j2, -90.0f, CircleCountdownView_vRFhKjU$lambda$6, false, Offset.constructor-impl((v1$iv$iv6 << 32) | (v2$iv$iv6 & 4294967295L)), j5, (float) DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN, new Stroke($circleWidth, (float) DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN, StrokeCap.Companion.getRound-KaPHkGw(), 0, (PathEffect) null, 26, (DefaultConstructorMarker) null), (ColorFilter) null, 0, 832, (Object) null);
        return Unit.INSTANCE;
    }
}