...
@DebugMetadata(c = "tv.danmaku.bili.ui.splash.ad.button.card.SplashShopButtonCardKt$createSplashShopButtonCard$1$2$1$1$1", f = "SplashShopButtonCard.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                splashButtonClickListener.onClickV2(new ButtonClickData(splashActionType, this.$buttonData, this.$buttonData.getJumpUrl(), schema, Boxing.boxInt(this.$index), this.$card.getJumpUrl(), this.$card.getSchema(), this.$card.getWxProgramInfo()));
