...
@DebugMetadata(c = "tv.danmaku.bili.ui.splash.ad.button.card.SplashCountdownV2CardKt$CountdownCard$4$1", f = "SplashCountdownV2Card.kt", i = {}, l = {154}, m = "invokeSuspend", n = {}, s = {}, v = 1)
            ...
            case 0:
                ...
                if (CountdownCard_wBJOh4Y$lambda$1 > 0) {
                    ...
                    if (!CountdownCard_wBJOh4Y$lambda$10) {
                        ...
                        splashCountdownV2CardKt$CountdownCard$4$1.$timeLeft$delegate.setLongValue(RangesKt.coerceAtLeast(splashCountdownV2CardKt$CountdownCard$4$1.$activityStartTime - (System.currentTimeMillis() / ((long) IjkMediaCodecInfo.RANK_MAX)), 0L));
