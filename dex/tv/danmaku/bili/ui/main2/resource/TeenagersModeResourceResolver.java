...
public class TeenagersModeResourceResolver {
    /* JADX INFO: Access modifiers changed from: package-private */
    public static List<PrimaryPage> forPrimaryPages() {
        ...
        if (TeenagersMode.getInstance().getEntranceState("dynamic") == 1) {
    ...
    public static List<MenuItem> forHomeTopMenus() {
        ...
        if (TeenagersMode.getInstance().getEntranceState(AppConfig.HOST_GAME) == 1) {
    ...
    public static List<SecondaryPage> forHomeSubPages() {
        ...
        if (TeenagersMode.getInstance().getEntranceState(AppConfig.HOST_RANK) == 1) {
    ...
    private TeenagersModeResourceResolver() {
    }
}