...
public class InnerMineModulePortTailViewHolder extends BaseMineItemViewHolder {
    private BiliImageView mIcon;
    private EllipsisTailTextView mTitle;

    public InnerMineModulePortTailViewHolder(View itemView, IMineItemClickListener clickListener) {
        super(itemView, clickListener);
        this.mIcon = itemView.findViewById(R.id.icon);
        this.mTitle = (EllipsisTailTextView) itemView.findViewById(R.id.title);
    }

    public static InnerMineModulePortTailViewHolder create(ViewGroup parent, IMineItemClickListener clickListener) {
        return new InnerMineModulePortTailViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.bili_layout_main_user_center_port_tail_item, parent, false), clickListener);
    }
    ...
    public void bind(MenuGroup.Item item, MenuGroup menuGroup) {
        ...
        bindImage(item);
        this.mTitle.setEllipsisTail(item.titleTail);
        this.mTitle.setOriginalText(item.title);
    }
    ...
    public void onClick(View v) {
        ...
        if (MineExtentionsKt.isShowLocalIcon(this.mItem)) {
            ...
            if (findFragmentActivityOrNull != null) {
                LifecycleExtentionsKt.onNextEvent(findFragmentActivityOrNull, Lifecycle.Event.ON_RESUME, new Function0() { // from class: tv.danmaku.bili.ui.main2.mine.holder.InnerMineModulePortTailViewHolder$$ExternalSyntheticLambda0
                    public final Object invoke() {
                        return InnerMineModulePortTailViewHolder.this.m2088lambda$onClick$0$tvdanmakubiliuimain2mineholderInnerMineModulePortTailViewHolder();
                    }
                });
            }
        }
    ...
    /* renamed from: lambda$onClick$0$tv-danmaku-bili-ui-main2-mine-holder-InnerMineModulePortTailViewHolder  reason: not valid java name */
    public /* synthetic */ Unit m2088lambda$onClick$0$tvdanmakubiliuimain2mineholderInnerMineModulePortTailViewHolder() {
