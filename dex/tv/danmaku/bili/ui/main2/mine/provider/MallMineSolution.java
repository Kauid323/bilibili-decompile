...
public class MallMineSolution implements IMinePageInfo {
    private static final String MALL_TAG = "mall_tab";
    private IMineMenuItemSolution mMenuSolution = new DefaultMineMenuSolution() { // from class: tv.danmaku.bili.ui.main2.mine.provider.MallMineSolution.1
        ...
        public void onMenuItemUpdate(Context context, MenuGroup.Item item) {
            ...
            if (RestrictedMode.isEnable(RestrictedType.LESSONS, MallMineSolution.MALL_TAG)) {
                setVisible(item, false);
            }
        }
    };
    private IMineMenuItemRedirection mRedirection = new IMineMenuItemRedirection() { // from class: tv.danmaku.bili.ui.main2.mine.provider.MallMineSolution.2
