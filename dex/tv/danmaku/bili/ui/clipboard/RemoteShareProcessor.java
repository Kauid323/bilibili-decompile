...
@Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0001\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J$\u0010\u0004\u001a\u0004\u0018\u00010\u00052\u0006\u0010\u0006\u001a\u00020\u00072\b\u0010\b\u001a\u0004\u0018\u00010\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016J$\u0010\f\u001a\u0004\u0018\u00010\u00052\u0006\u0010\u0006\u001a\u00020\u00072\b\u0010\b\u001a\u0004\u0018\u00010\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016¨\u0006\r"}, d2 = {"Ltv/danmaku/bili/ui/clipboard/RemoteShareProcessor;", "Ltv/danmaku/bili/ui/clipboard/IRegexProcessor;", "<init>", "()V", "process", "Ltv/danmaku/bili/ui/clipboard/RecognizeResult;", "content", "", "regexRule", "Ltv/danmaku/bili/ui/clipboard/RegexRule;", "environment", "Ltv/danmaku/bili/ui/clipboard/ClipboardChecker$Environment;", "processAsync", "core_apinkDebug"}, k = 1, mv = {2, 0, 0}, xi = BR.badgeVisibility)
public final class RemoteShareProcessor implements IRegexProcessor {
    ...
    public RecognizeResult processAsync(String content, RegexRule regexRule, ClipboardChecker.Environment environment) {
        ShareWordResult result;
        Intrinsics.checkNotNullParameter(content, "content");
        Intrinsics.checkNotNullParameter(environment, "environment");
        if (TextUtils.isEmpty(content) || regexRule == null || (result = UserGrowApiHelper.Companion.fetchShareWordResult(content)) == null) {
            return null;
        }
        ...
        $this$processAsync_u24lambda_u240_u240.setUrl(result.getSchema());
        $this$processAsync_u24lambda_u240_u240.setRule(4);
