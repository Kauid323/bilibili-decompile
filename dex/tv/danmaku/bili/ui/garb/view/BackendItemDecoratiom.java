...
public final class BackendItemDecoratiom extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        int width = ScreenUtil.dip2px(this.context, 180.0f);
