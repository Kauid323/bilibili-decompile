...
@Metadata(d1 = {"\u0000\u001f\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H\u0016J\u0012\u0010\u0006\u001a\u00020\u00032\b\u0010\u0007\u001a\u0004\u0018\u00010\bH\u0016¨\u0006\t"}, d2 = {"tv/danmaku/bili/ui/main/MineGuideActivity$setupTopImage$1", "Lcom/bilibili/lib/image2/bean/ImageLoadingListener;", "onImageSet", "", "imageInfo", "Lcom/bilibili/lib/image2/bean/ImageInfo;", "onImageLoadFailed", "err", "", "core_apinkDebug"}, k = 1, mv = {2, 0, 0}, xi = BR.badgeVisibility)
public final class MineGuideActivity$setupTopImage$1 implements ImageLoadingListener {
    ...
    public MineGuideActivity$setupTopImage$1(MineGuideActivity $receiver) {
    ...
    public void onImageSet(ImageInfo imageInfo) {
        ...
        this.this$0.mTopAnimatable = (imageInfo == null || (animateInfo = imageInfo.getAnimateInfo()) == null) ? null : animateInfo.getAnimatable();
        biliAnimatable = this.this$0.mTopAnimatable;
        if (biliAnimatable != null) {
            final MineGuideActivity mineGuideActivity = this.this$0;
            biliAnimatable.setAnimationListener(new AnimationListener() { // from class: tv.danmaku.bili.ui.main.MineGuideActivity$setupTopImage$1$onImageSet$1
        ...
        $this$onImageSet_u24lambda_u240 = this.this$0.mBottomAnimatable;
        if ($this$onImageSet_u24lambda_u240 != null) {
            biliAnimatable2 = this.this$0.mTopAnimatable;
        ...
        HandlerThreads.postDelayed(0, new Runnable() { // from class: tv.danmaku.bili.ui.main.MineGuideActivity$setupTopImage$1$$ExternalSyntheticLambda0
