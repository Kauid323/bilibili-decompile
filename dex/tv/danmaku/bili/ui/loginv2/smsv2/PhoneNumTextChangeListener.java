...
public final class PhoneNumTextChangeListener extends BaseTextWatcher {
    ...
    */
    public void afterTextChanged(Editable s) {
        ...
        if (s != null) {
            if (s.length() == 0) {
                ImageView imageView = fragment.clearPhoneNum;
                if (imageView != null) {
                    imageView.setVisibility(8);
                }
                TextView textView = fragment.mGetCaptcha;
                if (textView != null) {
                    textView.setEnabled(false);
                }
            } else {
                ImageView imageView2 = fragment.clearPhoneNum;
                if (imageView2 != null) {
                    imageView2.setVisibility(0);
                }
                TextView textView2 = fragment.mGetCaptcha;
                if (textView2 != null) {
                    textView2.setEnabled(true);
                }
            }
        }
        TintTextView tintTextView = fragment.mSubmitBtn;
    ...
    public void beforeTextChanged(CharSequence s, int start, int count, int after) {
        ...
        EditText editText;
        WeakReference<SmsLoginFragmentV2> mFragmentRef = getMFragmentRef();
        if (mFragmentRef == null || (fragment = mFragmentRef.get()) == null || (context = fragment.getContext()) == null || (editText = fragment.mEtPhoneNum) == null) {
            return;
        }
