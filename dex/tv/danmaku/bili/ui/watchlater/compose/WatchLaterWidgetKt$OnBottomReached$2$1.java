...
@DebugMetadata(c = "tv.danmaku.bili.ui.watchlater.compose.WatchLaterWidgetKt$OnBottomReached$2$1", f = "WatchLaterWidget.kt", i = {}, l = {348}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Flow snapshotFlow = SnapshotStateKt.snapshotFlow(new Function0() { // from class: tv.danmaku.bili.ui.watchlater.compose.WatchLaterWidgetKt$OnBottomReached$2$1$$ExternalSyntheticLambda0
                ...
                this.label = 1;
                if (snapshotFlow.collect(new FlowCollector() { // from class: tv.danmaku.bili.ui.watchlater.compose.WatchLaterWidgetKt$OnBottomReached$2$1.2
