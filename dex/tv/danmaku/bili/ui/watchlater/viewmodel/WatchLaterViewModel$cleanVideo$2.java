...
@DebugMetadata(c = "tv.danmaku.bili.ui.watchlater.viewmodel.WatchLaterViewModel$cleanVideo$2", f = "WatchLaterViewModel.kt", i = {}, l = {614, 614}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class WatchLaterViewModel$cleanVideo$2 extends SuspendLambda implements Function2<FlowCollector<? super GeneralResponse<BaseResponse>>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.L$0 = $this$flow;
                this.label = 1;
                Object cleanWatchLater = WatchLaterApiMangerKt.cleanWatchLater(this.$cleanType, (Continuation) this);
                if (cleanWatchLater == coroutine_suspended) {
                    return coroutine_suspended;
                }
                $result2 = $result;
                $result = cleanWatchLater;
