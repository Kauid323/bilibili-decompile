...
public abstract class BaseDialog<T extends BaseDialog> extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mLlTop.setOnClickListener(new View.OnClickListener() { // from class: tv.danmaku.bili.widget.BaseDialog.1
    ...
    private void delayDismiss() {
        if (this.mAutoDismiss && this.mAutoDismissDelay > 0) {
            this.mHandler.postDelayed(new Runnable() { // from class: tv.danmaku.bili.widget.BaseDialog.2
