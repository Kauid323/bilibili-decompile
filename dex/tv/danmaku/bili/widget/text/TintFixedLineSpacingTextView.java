...
public final class TintFixedLineSpacingTextView extends TintTextView {
    ...
    public TintFixedLineSpacingTextView(Context context) {
        this(context, null, 0, 6, null);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public TintFixedLineSpacingTextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, null);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TintFixedLineSpacingTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        Intrinsics.checkNotNullParameter(context, "context");
        this.mLineSpacing = FixedLineSpacingTextViewKt.toPx(4.0f);
        TypedArray array = null;
        try {
            array = context.obtainStyledAttributes(attrs, R.styleable.TintFixedLineSpacingTextView);
            this.mLineSpacing = array.getDimensionPixelSize(R.styleable.TintFixedLineSpacingTextView_line_spacing_tint, this.mLineSpacing);
        } finally {
            if (array != null) {
                array.recycle();
            }
    ...
    public /* synthetic */ TintFixedLineSpacingTextView(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
