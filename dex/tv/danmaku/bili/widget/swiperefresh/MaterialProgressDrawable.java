...
class MaterialProgressDrawable extends Drawable implements AbsProgressDrawable {
    ...
    private final Drawable.Callback mCallback = new Drawable.Callback() { // from class: tv.danmaku.bili.widget.swiperefresh.MaterialProgressDrawable.3
    ...
    public void onDragPercentChange(float adjustedPercent, float tensionPercent) {
        ...
        setStartEndTrim(DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN, Math.min(0.8f, strokeStart));
        setArrowScale(Math.min(1.0f, adjustedPercent));
    ...
    public void onRefreshCancel() {
        setStartEndTrim(DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN, DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN);
    }

    private void setStartEndTrim(float startAngle, float endAngle) {
        this.mRing.setStartTrim(startAngle);
        this.mRing.setEndTrim(endAngle);
    }

    private void setProgressRotation(float rotation) {
    ...
    public void stop() {
        ...
        setRotation(DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN);
    ...
    private void setupAnimators() {
        ...
        Animation animation = new Animation() { // from class: tv.danmaku.bili.widget.swiperefresh.MaterialProgressDrawable.1
            ...
            public void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                if (interpolatedTime <= 0.5f) {
                    ...
                    float startTrim = ((0.8f - minProgressArc) * MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(scaledTime)) + startingTrim;
                    ring.setStartTrim(startTrim);
                }
                if (interpolatedTime > 0.5f) {
        ...
        animation.setAnimationListener(new Animation.AnimationListener() { // from class: tv.danmaku.bili.widget.swiperefresh.MaterialProgressDrawable.2
            @Override // android.view.animation.Animation.AnimationListener
            public void onAnimationStart(Animation animation2) {
                MaterialProgressDrawable.this.mRotationCount = DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN;
            }
    ...
    public static class Ring {
        ...
        private float mStartTrim = DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN;
        private float mEndTrim = DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN;
        private float mRotation = DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN;
        ...
        private void drawTriangle(Canvas c, float startAngle, float sweepAngle, Rect bounds) {
            if (this.mShowArrow) {
                ...
                this.mArrow.moveTo(DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN, DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN);
                this.mArrow.lineTo(this.mArrowWidth * this.mArrowScale, DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN);
        ...
        public void setInsets(int width, int height) {
            ...
            if (this.mRingCenterRadius <= 0.0d || minEdge < DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN) {
                float insets2 = this.mStrokeWidth;
                insets = (float) Math.ceil(insets2 / 2.0f);
            } else {
        ...
        public void resetOriginals() {
            this.mStartingStartTrim = DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN;
            this.mStartingEndTrim = DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN;
            this.mStartingRotation = DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN;
            setStartTrim(DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN);
            setEndTrim(DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN);
            setRotation(DanmakuConfig.DANMAKU_SCREEN_DOMAIN_UNKNOWN);
        }
