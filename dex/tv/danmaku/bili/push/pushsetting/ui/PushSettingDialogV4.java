...
public final class PushSettingDialogV4 extends BasePushSettingDialog {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (recyclerView2 != null) {
            ...
            if (mPushData == null || (emptyList = mPushData.notices) == null) {
                emptyList = CollectionsKt.emptyList();
            }
            recyclerView2.setAdapter(new PushSettingOptionAdapter(emptyList, false));
        }
    }
}