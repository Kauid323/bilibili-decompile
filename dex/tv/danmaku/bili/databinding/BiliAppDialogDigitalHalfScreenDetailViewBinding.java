...
public final class BiliAppDialogDigitalHalfScreenDetailViewBinding implements ViewBinding {
    ...
    public static BiliAppDialogDigitalHalfScreenDetailViewBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BiliAppDialogDigitalHalfScreenDetailViewBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.bili_app_dialog_digital_half_screen_detail_view, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static BiliAppDialogDigitalHalfScreenDetailViewBinding bind(View rootView) {
