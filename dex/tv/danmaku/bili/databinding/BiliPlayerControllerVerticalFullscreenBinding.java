...
public final class BiliPlayerControllerVerticalFullscreenBinding implements ViewBinding {
    ...
    private BiliPlayerControllerVerticalFullscreenBinding(NormalPlayerInsetControllerWidget rootView, PlayerBackWidget bbplayerFullscreenBack, PlayerPlayPauseWidget bbplayerFullscreenPlay, NormalPlayerInsetControllerWidget playerConstraintLayout, LinearLayout playerContainerProgressbar, RelativeLayout playerContainerTop, HighEnergySeekWidget playerWidgetProgressbar, PlayerProgressTextWidget playerWidgetTimer) {
    ...
    public static BiliPlayerControllerVerticalFullscreenBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BiliPlayerControllerVerticalFullscreenBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.bili_player_controller_vertical_fullscreen, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static BiliPlayerControllerVerticalFullscreenBinding bind(View rootView) {
        ...
        if (bbplayerFullscreenBack != null && (bbplayerFullscreenPlay = ViewBindings.findChildViewById(rootView, (id = R.id.bbplayer_fullscreen_play))) != null) {
            ...
            if (playerContainerProgressbar != null) {
                ...
                if (playerContainerTop != null && (playerWidgetProgressbar = ViewBindings.findChildViewById(rootView, (id = R.id.player_widget_progressbar))) != null && (playerWidgetTimer = ViewBindings.findChildViewById(rootView, (id = R.id.player_widget_timer))) != null) {
                    return new BiliPlayerControllerVerticalFullscreenBinding((NormalPlayerInsetControllerWidget) rootView, bbplayerFullscreenBack, bbplayerFullscreenPlay, playerConstraintLayout, playerContainerProgressbar, playerContainerTop, playerWidgetProgressbar, playerWidgetTimer);
                }
            }
        }
