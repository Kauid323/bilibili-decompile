...
public class ConnectivityManagerHelper {
    ...
    public static boolean isWifi(Context context) {
        ...
        if (!typeName.equals(Splash.NETWORK_WIFI)) {
            return false;
        }
        return true;
    }
    ...
    private static boolean isFlyme6() {
        return StringsKt.equalsIgnoreCase(Build.MANUFACTURER, "meizu") && StringsKt.equalsIgnoreCase(Build.USER, "flyme") && StringsKt.startsWith(Build.DISPLAY, "Flyme 6.", false);
    }
