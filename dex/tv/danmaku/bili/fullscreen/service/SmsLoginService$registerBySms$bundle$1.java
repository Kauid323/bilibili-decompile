...
import com.bilibili.lib.accounts.RegisterParams;
...
@DebugMetadata(c = "tv.danmaku.bili.fullscreen.service.SmsLoginService$registerBySms$bundle$1", f = "SmsLoginService.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class SmsLoginService$registerBySms$bundle$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super VerifyBundle>, Object> {
    ...
    public SmsLoginService$registerBySms$bundle$1(SmsCaptchaStatus smsCaptchaStatus, String str, LoginReportParams loginReportParams, SnsPhoneBindingData snsPhoneBindingData, Continuation<? super SmsLoginService$registerBySms$bundle$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SmsLoginService$registerBySms$bundle$1(this.$captchaStatus, this.$smsCode, this.$reportParams, this.$snsPhoneBindingData, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                CodeInfo regResult = biliAccounts.registerBySms(new RegisterParams(countryCode, phone, str, captchaKey, "", pagePv, pageRoute, loginSessionId, fromSpmId, touristId, extend, platform, appId, snsPhoneBindingData3 != null ? snsPhoneBindingData3.getOpenId() : null));
                return BiliAccounts.get(FoundationAlias.getFapp()).loginByCode(regResult.code);
            default:
