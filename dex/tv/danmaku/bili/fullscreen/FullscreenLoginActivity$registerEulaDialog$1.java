...
@DebugMetadata(c = "tv.danmaku.bili.fullscreen.FullscreenLoginActivity$registerEulaDialog$1", f = "FullscreenLoginActivity.kt", i = {}, l = {BR.lineTextColor}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class FullscreenLoginActivity$registerEulaDialog$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ FullscreenLoginActivity this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FullscreenLoginActivity$registerEulaDialog$1(FullscreenLoginActivity fullscreenLoginActivity, Continuation<? super FullscreenLoginActivity$registerEulaDialog$1> continuation) {
        super(2, continuation);
        this.this$0 = fullscreenLoginActivity;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FullscreenLoginActivity$registerEulaDialog$1(this.this$0, continuation);
    }
    ...
    @DebugMetadata(c = "tv.danmaku.bili.fullscreen.FullscreenLoginActivity$registerEulaDialog$1$1", f = "FullscreenLoginActivity.kt", i = {0}, l = {BR.ratingIsValid}, m = "invokeSuspend", n = {"eula"}, s = {"L$0"}, v = 1)
    /* renamed from: tv.danmaku.bili.fullscreen.FullscreenLoginActivity$registerEulaDialog$1$1  reason: invalid class name */
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (eula != null && eula.getShow()) {
                        ...
                        this.L$0 = eula;
                        this.L$1 = fullscreenLoginActivity;
                        this.label = 1;
                        ...
                        FragmentManager supportFragmentManager = fullscreenLoginActivity.getSupportFragmentManager();
                        Intrinsics.checkNotNullExpressionValue(supportFragmentManager, "getSupportFragmentManager(...)");
                        boolean isPhoneLogin = eula.isPhoneLogin();
                        EulaTriggerType triggerType = eula.getTriggerType();
                        Map mapOf = MapsKt.mapOf(TuplesKt.to("login_type", eula.getLoginType()));
                        String ispName = eula.getIspCode().getIspName();
                        Function0<Unit> function0 = new Function0<Unit>() { // from class: tv.danmaku.bili.fullscreen.FullscreenLoginActivity$registerEulaDialog$1$1$1$1
                            ...
                            public static final /* synthetic */ class WhenMappings {
                                ...
                                static {
                                    ...
                                    try {
                                        iArr[EulaTriggerType.NetCode.ordinal()] = 3;
                            ...
                            public final void m1040invoke() {
                                switch (WhenMappings.$EnumSwitchMapping$0[EulaDisplayInfo.this.getTriggerType().ordinal()]) {
                                    case 1:
                                        fullscreenLoginActivity.getViewModel().checkAndLogin();
                                        return;
                                    case 2:
                                        fullscreenLoginActivity.getViewModel().checkAndSendSmsCode();
                                        return;
                                    case 3:
                                        fullscreenLoginActivity.getViewModel().checkAndNetCodeAuth();
                                        return;
                                    default:
                                        fullscreenLoginActivity.getViewModel().checkAndLogin();
                                        return;
                        ...
                        Function0<Unit> function02 = new Function0<Unit>() { // from class: tv.danmaku.bili.fullscreen.FullscreenLoginActivity$registerEulaDialog$1$1$1$2
                            public /* bridge */ /* synthetic */ Object invoke() {
                                m1041invoke();
                                return Unit.INSTANCE;
                            }
                            ...
                            public final void m1041invoke() {
                                FullscreenLoginActivity.this.getViewModel().dispatchAction(new IFullscreenLoginAction.DismissEulaAction(false));
                            }
                        };
                        if (eula.getTriggerType() == EulaTriggerType.GetSms) {
                            eulaLinkItemListener3 = fullscreenLoginActivity.clickEulaLinkListener2;
                            eulaLinkItemListener2 = eulaLinkItemListener3;
                        } else {
                            eulaLinkItemListener = fullscreenLoginActivity.clickEulaLinkListener3;
                            eulaLinkItemListener2 = eulaLinkItemListener;
                        }
                        LoginEulaDialog.show$default(dialog, supportFragmentManager, "login", isPhoneLogin, triggerType, 0, mapOf, ispName, function0, function02, eulaLinkItemListener2, 16, null);
                        continuation.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: tv.danmaku.bili.fullscreen.FullscreenLoginActivity$registerEulaDialog$1$1$1$3
                ...
                case 1:
                    $result2 = $result;
                    FullscreenLoginActivity fullscreenLoginActivity2 = (FullscreenLoginActivity) this.L$1;
