...
/* compiled from: SplashRealReadyAction.kt */
@Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\b\u0087\b\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0010\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\tH\u0016J\t\u0010\u000b\u001a\u00020\u0003HÆ\u0003J\u0013\u0010\f\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u0003HÆ\u0001J\u0013\u0010\r\u001a\u00020\u000e2\b\u0010\u000f\u001a\u0004\u0018\u00010\u0010HÖ\u0003J\t\u0010\u0011\u001a\u00020\u0012HÖ\u0001J\t\u0010\u0013\u001a\u00020\u0003HÖ\u0001R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u0014"}, d2 = {"Ltv/danmaku/bili/splash/ad/state/actions/SplashRealReadyAction;", "Lcom/bilibili/lib/homepage/splash/actions/SplashStateUpdateAction;", "from", "", "<init>", "(Ljava/lang/String;)V", "getFrom", "()Ljava/lang/String;", "reduce", "Lcom/bilibili/lib/homepage/splash/model/SplashState;", AuthResultCbHelper.ARGS_STATE, "component1", "copy", "equals", "", "other", "", "hashCode", "", "toString", "splashwidget_debug"}, k = 1, mv = {2, 0, 0}, xi = BR.badgeVisibility)
public final class SplashRealReadyAction implements SplashStateUpdateAction {
    public static final int $stable = 0;
    private final String from;

    public static /* synthetic */ SplashRealReadyAction copy$default(SplashRealReadyAction splashRealReadyAction, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            str = splashRealReadyAction.from;
        }
        return splashRealReadyAction.copy(str);
    }
    ...
    public final SplashRealReadyAction copy(String str) {
        Intrinsics.checkNotNullParameter(str, "from");
        return new SplashRealReadyAction(str);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SplashRealReadyAction) && Intrinsics.areEqual(this.from, ((SplashRealReadyAction) obj).from);
    }
    ...
    public String toString() {
        return "SplashRealReadyAction(from=" + this.from + ")";
    }

    public SplashRealReadyAction(String from) {
    ...
    public SplashState reduce(SplashState state) {
        ...
        return SplashState.copy$default(state, (Rect) null, (Rect) null, (PlayerShareData) null, (Boolean) null, (SelectedSplashTopViewIdInfo) null, (String) null, (String) null, (String) null, (String) null, true, (ExecutedPlayerState) null, false, false, (BannerSharePlayInfo) null, false, 32255, (Object) null);
    }
}