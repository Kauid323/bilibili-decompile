...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0018\u0010\u0000\u001a\u00020\u0001*\u00020\u00028@X\u0080\u0004¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, d2 = {"toElement", "Lcom/bilibili/commonanim/elementanim/model/BezierAnimationElement;", "Ltv/danmaku/bili/splash/ad/model/BezierAnimationElement;", "getToElement", "(Ltv/danmaku/bili/splash/ad/model/BezierAnimationElement;)Lcom/bilibili/commonanim/elementanim/model/BezierAnimationElement;", "adsplash_debug"}, k = 2, mv = {2, 0, 0}, xi = BR.badgeVisibility)
public final class SplashBezierAnimationElementKt {
    public static final com.bilibili.commonanim.elementanim.model.BezierAnimationElement getToElement(BezierAnimationElement $this$toElement) {
        ...
        com.bilibili.commonanim.elementanim.model.BezierPoint toPoint = position != null ? SplashBezierPointKt.getToPoint(position) : null;
        String fetchResourceLocalPathByHash = SplashStateStorageHelperKt.getClickGuideShowCountOfElementAnimation() >= SplashConfigKt.getClickGuideShowMaxCount() ? null : BusinessSplashResHelperKt.fetchResourceLocalPathByHash($this$toElement.getGuideImageMd5());
        String fetchResourceLocalPathByHash2 = BusinessSplashResHelperKt.fetchResourceLocalPathByHash($this$toElement.getImageMd5());
        String fetchResourceLocalPathByHash3 = BusinessSplashResHelperKt.fetchResourceLocalPathByHash($this$toElement.getTopImageMd5());
        ...
        if (list != null) {
            ...
            for (Object item$iv$iv : $this$map$iv) {
                ...
                destination$iv$iv.add(SplashBezierAnimationItemKt.getToItem(it));
