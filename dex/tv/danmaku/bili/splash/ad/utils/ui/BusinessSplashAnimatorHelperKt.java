...
@Metadata(d1 = {"\u0000@\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0007\n\u0000\u001a2\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0010\u0010\u0006\u001a\f\u0012\u0006\u0012\u0004\u0018\u00010\b\u0018\u00010\u00072\u0006\u0010\t\u001a\u00020\nH\u0000\u001a4\u0010\u000b\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\f\u001a\u00020\u00052\u0012\b\u0002\u0010\u0006\u001a\f\u0012\u0006\u0012\u0004\u0018\u00010\b\u0018\u00010\u00072\u0006\u0010\t\u001a\u00020\nH\u0000\u001a(\u0010\r\u001a\u00020\u00012\u0006\u0010\u000e\u001a\u00020\b2\u0006\u0010\u0002\u001a\u00020\b2\u0006\u0010\u000f\u001a\u00020\u00052\u0006\u0010\t\u001a\u00020\nH\u0000\u001a4\u0010\u0010\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\b2\u0006\u0010\f\u001a\u00020\u00052\u0012\b\u0002\u0010\u0006\u001a\f\u0012\u0006\u0012\u0004\u0018\u00010\b\u0018\u00010\u00072\u0006\u0010\t\u001a\u00020\nH\u0000\u001a,\u0010\u0011\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\b2\u0012\b\u0002\u0010\u0006\u001a\f\u0012\u0006\u0012\u0004\u0018\u00010\b\u0018\u00010\u00072\u0006\u0010\t\u001a\u00020\nH\u0000\u001a\u001e\u0010\u0012\u001a\u00020\u0013*\u00020\b2\u0006\u0010\f\u001a\u00020\u00052\b\b\u0002\u0010\u0014\u001a\u00020\u0015H\u0002\u001a\u001c\u0010\u0016\u001a\u00020\u0017*\u00020\u00172\u0006\u0010\u0018\u001a\u00020\u00132\u0006\u0010\u0019\u001a\u00020\u001aH\u0002¨\u0006\u001b"}, d2 = {"doBusinessSplashSearchBarLinkageAnimation", "", "transformView", "Landroid/widget/ImageView;", "rect", "Landroid/graphics/Rect;", "alphaViews", "", "Landroid/view/View;", "listener", "Landroid/animation/Animator$AnimatorListener;", "doTopViewScaleAnimation", "targetRect", "doKeepRadioScaleAnimate", "containerView", "bannerRect", "doTvCloseSplashAnimate", "doBgDisappearAnimation", "toLinkageRectParam", "Ltv/danmaku/bili/splash/ad/utils/ui/LinkageRectParam;", "radius", "", "transform", "Landroid/view/ViewGroup$MarginLayoutParams;", "displayParam", "v", "", "adsplash_debug"}, k = 2, mv = {2, 0, 0}, xi = BR.badgeVisibility)
public final class BusinessSplashAnimatorHelperKt {
    public static final void doBusinessSplashSearchBarLinkageAnimation(final ImageView transformView, Rect rect, List<? extends View> list, Animator.AnimatorListener listener) {
        ...
        ValueAnimator alphaAni = ValueAnimator.ofFloat(1.0f, 0.0f);
        alphaAni.setDuration(625L);
        alphaAni.setStartDelay(625L);
        alphaAni.setInterpolator(new BezierInterpolator(0.0f, 0.0f, 0.58f, 1.0f));
        alphaAni.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: tv.danmaku.bili.splash.ad.utils.ui.BusinessSplashAnimatorHelperKt$$ExternalSyntheticLambda0
        ...
        ValueAnimator cornerAni = ValueAnimator.ofFloat(0.0f, 1.0f);
        cornerAni.setDuration(750L);
        cornerAni.setInterpolator(new BezierInterpolator(0.0f, 0.0f, 0.58f, 1.0f));
        cornerAni.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: tv.danmaku.bili.splash.ad.utils.ui.BusinessSplashAnimatorHelperKt$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        ValueAnimator $this$doBusinessSplashSearchBarLinkageAnimation_u24lambda_u243 = ValueAnimator.ofFloat(0.0f, 1.0f);
        $this$doBusinessSplashSearchBarLinkageAnimation_u24lambda_u243.setDuration(750L);
        $this$doBusinessSplashSearchBarLinkageAnimation_u24lambda_u243.setInterpolator(new BezierInterpolator(0.4f, 0.0f, 0.74f, 1.0f));
        $this$doBusinessSplashSearchBarLinkageAnimation_u24lambda_u243.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: tv.danmaku.bili.splash.ad.utils.ui.BusinessSplashAnimatorHelperKt$$ExternalSyntheticLambda2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    public static final void doTopViewScaleAnimation(final ImageView transformView, Rect targetRect, final List<? extends View> list, Animator.AnimatorListener listener) {
        Intrinsics.checkNotNullParameter(transformView, "transformView");
        ...
        scaleAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: tv.danmaku.bili.splash.ad.utils.ui.BusinessSplashAnimatorHelperKt$$ExternalSyntheticLambda3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        alphaAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: tv.danmaku.bili.splash.ad.utils.ui.BusinessSplashAnimatorHelperKt$$ExternalSyntheticLambda4
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                BusinessSplashAnimatorHelperKt.doTopViewScaleAnimation$lambda$1$0(list, valueAnimator);
            }
        });
        ObjectAnimator $this$doTopViewScaleAnimation_u24lambda_u242 = ObjectAnimator.ofFloat(transformView, View.ALPHA, 1.0f, 0.0f);
    ...
    public static final void doKeepRadioScaleAnimate(final View containerView, final View transformView, Rect bannerRect, Animator.AnimatorListener listener) {
        ...
        final LinkageRectParam displayParam = toLinkageRectParam$default(transformView, targetRect, 0, 2, null);
        ValueAnimator $this$doKeepRadioScaleAnimate_u24lambda_u240 = ValueAnimator.ofFloat(0.0f, 1.0f);
        $this$doKeepRadioScaleAnimate_u24lambda_u240.setInterpolator(new BezierInterpolator(0.42f, 0.0f, 0.58f, 1.0f));
        $this$doKeepRadioScaleAnimate_u24lambda_u240.setDuration(500L);
        $this$doKeepRadioScaleAnimate_u24lambda_u240.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: tv.danmaku.bili.splash.ad.utils.ui.BusinessSplashAnimatorHelperKt$$ExternalSyntheticLambda5
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        alphaAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: tv.danmaku.bili.splash.ad.utils.ui.BusinessSplashAnimatorHelperKt$$ExternalSyntheticLambda6
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    public static /* synthetic */ void doTvCloseSplashAnimate$default(View view, Rect rect, List list, Animator.AnimatorListener animatorListener, int i, Object obj) {
        if ((i & 4) != 0) {
            list = null;
        }
        doTvCloseSplashAnimate(view, rect, list, animatorListener);
    }
    ...
    public static final void doTvCloseSplashAnimate(final View transformView, Rect targetRect, List<? extends View> list, Animator.AnimatorListener listener) {
        ...
        Intrinsics.checkNotNullParameter(listener, "listener");
        if (list != null) {
            List<? extends View> $this$forEach$iv = list;
            for (Object element$iv : $this$forEach$iv) {
                View it = (View) element$iv;
                if (it != null) {
                    it.setAlpha(0.0f);
        ...
        scaleAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: tv.danmaku.bili.splash.ad.utils.ui.BusinessSplashAnimatorHelperKt$$ExternalSyntheticLambda7
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                BusinessSplashAnimatorHelperKt.doTvCloseSplashAnimate$lambda$1$0(transformView, displayParam, valueAnimator);
            }
        });
        ValueAnimator transformMaskColor = ValueAnimator.ofInt(0, BR.hallCover);
        transformMaskColor.setDuration(150L);
        transformMaskColor.setStartDelay(500L);
        transformMaskColor.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: tv.danmaku.bili.splash.ad.utils.ui.BusinessSplashAnimatorHelperKt$$ExternalSyntheticLambda8
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    public static final void doTvCloseSplashAnimate$lambda$2$0(View $transformView, ValueAnimator it) {
        ...
        if (imageView != null) {
            imageView.setColorFilter(Color.argb(alpha, (int) BR.hallCover, (int) BR.hallCover, (int) BR.hallCover));
        }
    }

    public static /* synthetic */ void doBgDisappearAnimation$default(View view, List list, Animator.AnimatorListener animatorListener, int i, Object obj) {
        if ((i & 2) != 0) {
            list = null;
        }
        doBgDisappearAnimation(view, list, animatorListener);
    }
    ...
    public static final void doBgDisappearAnimation(View transformView, List<? extends View> list, Animator.AnimatorListener listener) {
        ...
        transformView.animate().alpha(0.0f).setDuration(233L).setListener(listener).start();
    }

    static /* synthetic */ LinkageRectParam toLinkageRectParam$default(View view, Rect rect, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = 0;
        }
        return toLinkageRectParam(view, rect, i);
    }
