...
@Metadata(d1 = {"\u0000.\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\u0010\u0007\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u0018\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0001\u001a\u0018\u0010\u0006\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0001\u001a\f\u0010\u0007\u001a\u00020\b*\u00020\tH\u0002\u001a\u0010\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\rH\u0002\u001a\u0010\u0010\u000e\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\rH\u0000¨\u0006\u000f"}, d2 = {"addTwistDebugView", "", "rootView", "Landroid/view/View;", "sensorSet", "Lcom/bilibili/app/comm/list/common/sensor/SensorSet;", "addRunningBallDebugView", "roundStr", "", "", "isDebugSensorEnable", "", "context", "Landroid/content/Context;", "disableSplashSensor", "adsplash_debug"}, k = 2, mv = {2, 0, 0}, xi = BR.badgeVisibility)
public final class SplashSensorDebugKt {
    public static final void addTwistDebugView(final View rootView, SensorSet sensorSet) {
        ...
        if (rotateSensor != null) {
            rotateSensor.addListener(new RotateDegreeSensor.RotateListener() { // from class: tv.danmaku.bili.splash.ad.utils.sensor.SplashSensorDebugKt$$ExternalSyntheticLambda0
        ...
        if (accSensor != null) {
            accSensor.addListener(new AcceleratorSensor.SpeedChangedListener() { // from class: tv.danmaku.bili.splash.ad.utils.sensor.SplashSensorDebugKt$$ExternalSyntheticLambda1
        ...
        rootView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: tv.danmaku.bili.splash.ad.utils.sensor.SplashSensorDebugKt$addTwistDebugView$$inlined$doOnAttach$1
    ...
    public static final void addRunningBallDebugView(final View rootView, SensorSet sensorSet) {
        ...
        RotateDegreeSensor rotateSensor = obj instanceof RotateDegreeSensor ? (RotateDegreeSensor) obj : null;
        if (rotateSensor != null) {
            rotateSensor.addListener(new RotateDegreeSensor.RotateListener() { // from class: tv.danmaku.bili.splash.ad.utils.sensor.SplashSensorDebugKt$$ExternalSyntheticLambda2
                public final void onDegreeChanged(float[] fArr) {
        ...
        rootView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: tv.danmaku.bili.splash.ad.utils.sensor.SplashSensorDebugKt$addRunningBallDebugView$$inlined$doOnAttach$1
            @Override // android.view.View.OnAttachStateChangeListener
            public void onViewAttachedToWindow(View view) {
                rootView.removeOnAttachStateChangeListener(this);
                ViewParent parent2 = view.getParent();
    ...
    public static final void addRunningBallDebugView$lambda$1(TextView $title1, float[] degreesDelta) {
        ...
        $title1.setText(roundStr((float) Math.toDegrees(SplashRunningBallViewV2.Companion.adjustRadian(degreesDelta))) + "°");
    }
    ...
    private static final boolean isDebugSensorEnable(Context context) {
        return BuildConfig.DEBUG && BiliGlobalPreferenceHelper.getBLKVSharedPreference(context).getBoolean("splash_is_sensor_debug_enable", true);
    }

    public static final boolean disableSplashSensor(Context context) {
        Intrinsics.checkNotNullParameter(context, "context");
        return BuildConfig.DEBUG && BiliGlobalPreferenceHelper.getBLKVSharedPreference(context).getBoolean("disable_splash_debug_sensor", false);
    }
}