...
public final class SplashImageView extends AppCompatImageView {
    ...
    private final void onSetRadius() {
        boolean needClip = this.mRadius > 0.0f;
    ...
    private final ViewOutlineProvider newViewOutlineProvider() {
        return new ViewOutlineProvider() { // from class: tv.danmaku.bili.splash.ad.widget.SplashImageView$newViewOutlineProvider$1
