...
public final class CircleImageView extends ImageView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.mWidth = RangesKt.coerceAtMost(View.MeasureSpec.getSize(widthMeasureSpec), View.MeasureSpec.getSize(heightMeasureSpec));
    ...
    private final void setUpShader() {
        ...
        int bSize = RangesKt.coerceAtMost(bmp.getWidth(), bmp.getHeight());
    ...
    private final Bitmap drawableToBitamp(Drawable drawable) {
        ...
        Bitmap bitmap = Bitmap.createBitmap(w, h, config$iv);
