...
public final class SamplerKt {
    ...
    private static final Lazy defaultSamplerValue$delegate = LazyKt.lazy(new Function0() { // from class: tv.danmaku.bili.splash.ad.reporter.tech.SamplerKt$$ExternalSyntheticLambda1
        public final Object invoke() {
    ...
    private static final Lazy mSamplerCache$delegate = LazyKt.lazy(new Function0() { // from class: tv.danmaku.bili.splash.ad.reporter.tech.SamplerKt$$ExternalSyntheticLambda2
        public final Object invoke() {
    ...
    private static final Lazy mSamplerSalt$delegate = LazyKt.lazy(new Function0() { // from class: tv.danmaku.bili.splash.ad.reporter.tech.SamplerKt$$ExternalSyntheticLambda3
        public final Object invoke() {
    ...
    private static final Lazy mRandomValue$delegate = LazyKt.lazy(new Function0() { // from class: tv.danmaku.bili.splash.ad.reporter.tech.SamplerKt$$ExternalSyntheticLambda4
        public final Object invoke() {
    ...
    private static final Lazy mConfigSamplerMap$delegate = LazyKt.lazy(new Function0() { // from class: tv.danmaku.bili.splash.ad.reporter.tech.SamplerKt$$ExternalSyntheticLambda5
        public final Object invoke() {
    ...
    public static final int defaultSamplerValue_delegate$lambda$0() {
        Integer intOrNull;
        String str = (String) ConfigManager.Companion.config().get("splash.custom_reporter_default_sampler", "10");
    ...
    public static final String mSamplerSalt_delegate$lambda$0() {
        String str = (String) ConfigManager.Companion.config().get("splash.custom_reporter_sampler_salt", "10");
