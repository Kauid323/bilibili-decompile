...
@Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0004\"\u001b\u0010\u0000\u001a\u00020\u00018@X\u0080\u0084\u0002¢\u0006\f\n\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0000\u0010\u0002¨\u0006\u0005"}, d2 = {"isInLowerPerformancePhoneList", "", "()Z", "isInLowerPerformancePhoneList$delegate", "Lkotlin/Lazy;", "adsplash_debug"}, k = 2, mv = {2, 0, 0}, xi = BR.badgeVisibility)
public final class LowerPhoneConfigKt {
    private static final Lazy isInLowerPerformancePhoneList$delegate = LazyKt.lazy(new Function0() { // from class: tv.danmaku.bili.splash.ad.config.LowerPhoneConfigKt$$ExternalSyntheticLambda1
    ...
    public static final boolean isInLowerPerformancePhoneList_delegate$lambda$0() {
        List<String> modelList = ((LowerPerformancePhoneConfig) BLRemoteConfigUtilKt.getFawkesConfigObjectByGson("splash.splash_lower_performance_config", LowerPerformancePhoneConfig.class, new Function0() { // from class: tv.danmaku.bili.splash.ad.config.LowerPhoneConfigKt$$ExternalSyntheticLambda0
            public final Object invoke() {
