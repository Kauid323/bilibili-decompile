...
import tv.danmaku.bili.splash.ad.utils.CountdownUtilKt;

/* compiled from: SplashButtonHelper.kt */
@Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 0, 0}, xi = BR.badgeVisibility)
@DebugMetadata(c = "tv.danmaku.bili.splash.ad.button.SplashButtonHelper$genCountdownView$2", f = "SplashButtonHelper.kt", i = {}, l = {BR.tryingToPlayVideo}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class SplashButtonHelper$genCountdownView$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public SplashButtonHelper$genCountdownView$2(BaseSplash baseSplash, View view, TextView textView, Context context, SplashGuideButton splashGuideButton, Continuation<? super SplashButtonHelper$genCountdownView$2> continuation) {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        while (ListExtentionsKt.isViewAlive(splashButtonHelper$genCountdownView$2.$baseSplash)) {
            ...
            if ($this$isVisible$iv2 != null) {
                ...
                long timeDiff = (System.currentTimeMillis() / 1000) - splashButtonHelper$genCountdownView$2.$buttonData.getActivityTime();
                if (timeDiff >= 0) {
