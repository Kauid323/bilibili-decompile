...
@DebugMetadata(c = "tv.danmaku.bili.splash.ad.page.component.StateObserverComponentKt$observerOnViewCreated$1", f = "StateObserverComponent.kt", i = {}, l = {12}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class StateObserverComponentKt$observerOnViewCreated$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "tv.danmaku.bili.splash.ad.page.component.StateObserverComponentKt$observerOnViewCreated$1$1", f = "StateObserverComponent.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    /* renamed from: tv.danmaku.bili.splash.ad.page.component.StateObserverComponentKt$observerOnViewCreated$1$1  reason: invalid class name */
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (FlowKt.first(this.$this_observerOnViewCreated.getViewModel$adsplash_debug().getState(), new AnonymousClass1(null), (Continuation) this) == coroutine_suspended) {
        ...
        AlphaEggLayerComponentKt.initEggLayer(this.$this_observerOnViewCreated);
        SecondPageComponentKt.preloadSecondPageEggVideo(this.$this_observerOnViewCreated);
