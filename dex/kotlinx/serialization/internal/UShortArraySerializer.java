...
public final class UShortArraySerializer extends PrimitiveArraySerializer<UShort, UShortArray, UShortArrayBuilder> implements KSerializer<UShortArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object $this$collectionSize) {
        return m1558collectionSizerL5Bavg(((UShortArray) $this$collectionSize).unbox-impl());
    }

    @Override // kotlinx.serialization.internal.PrimitiveArraySerializer
    public /* bridge */ /* synthetic */ UShortArray empty() {
        return UShortArray.box-impl(m1559emptyamswpOA());
    }

    @Override // kotlinx.serialization.internal.AbstractCollectionSerializer
    public /* bridge */ /* synthetic */ Object toBuilder(Object $this$toBuilder) {
        return m1560toBuilderrL5Bavg(((UShortArray) $this$toBuilder).unbox-impl());
    }

    @Override // kotlinx.serialization.internal.PrimitiveArraySerializer
    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder encoder, UShortArray uShortArray, int size) {
        m1561writeContenteny0XGE(encoder, uShortArray.unbox-impl(), size);
    }
    ...
    protected int m1558collectionSizerL5Bavg(short[] collectionSize) {
        Intrinsics.checkNotNullParameter(collectionSize, "$this$collectionSize");
        return UShortArray.getSize-impl(collectionSize);
    }

    /* renamed from: toBuilder-rL5Bavg  reason: not valid java name */
    protected UShortArrayBuilder m1560toBuilderrL5Bavg(short[] toBuilder) {
        Intrinsics.checkNotNullParameter(toBuilder, "$this$toBuilder");
        return new UShortArrayBuilder(toBuilder, null);
    }

    /* renamed from: empty-amswpOA  reason: not valid java name */
    protected short[] m1559emptyamswpOA() {
    ...
    public void readElement(CompositeDecoder decoder, int index, UShortArrayBuilder builder, boolean checkIndex) {
        ...
        builder.m1556appendxj2QHRw$kotlinx_serialization_core(UShort.constructor-impl(decoder.decodeInlineElement(getDescriptor(), index).decodeShort()));
    }

    /* renamed from: writeContent-eny0XGE  reason: not valid java name */
    protected void m1561writeContenteny0XGE(CompositeEncoder encoder, short[] content, int size) {
