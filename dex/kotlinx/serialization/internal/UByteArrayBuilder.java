...
public final class UByteArrayBuilder extends PrimitiveArrayBuilder<UByteArray> {
    ...
    public /* bridge */ /* synthetic */ UByteArray build$kotlinx_serialization_core() {
        return UByteArray.box-impl(m1533buildTcUX1vc$kotlinx_serialization_core());
    }
    ...
    public void ensureCapacity$kotlinx_serialization_core(int requiredCapacity) {
        if (UByteArray.getSize-impl(this.buffer) < requiredCapacity) {
            byte[] copyOf = Arrays.copyOf(this.buffer, RangesKt.coerceAtLeast(requiredCapacity, UByteArray.getSize-impl(this.buffer) * 2));
    ...
    public final void m1532append7apg3OU$kotlinx_serialization_core(byte c) {
        PrimitiveArrayBuilder.ensureCapacity$kotlinx_serialization_core$default(this, 0, 1, null);
        byte[] bArr = this.buffer;
        int position$kotlinx_serialization_core = getPosition$kotlinx_serialization_core();
        this.position = position$kotlinx_serialization_core + 1;
        UByteArray.set-VurrAj0(bArr, position$kotlinx_serialization_core, c);
    }

    /* renamed from: build-TcUX1vc$kotlinx_serialization_core  reason: not valid java name */
    public byte[] m1533buildTcUX1vc$kotlinx_serialization_core() {
