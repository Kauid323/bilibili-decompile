...
public final class ULongArrayBuilder extends PrimitiveArrayBuilder<ULongArray> {
    ...
    public /* bridge */ /* synthetic */ ULongArray build$kotlinx_serialization_core() {
        return ULongArray.box-impl(m1549buildY2RjT0g$kotlinx_serialization_core());
    }
    ...
    public void ensureCapacity$kotlinx_serialization_core(int requiredCapacity) {
        if (ULongArray.getSize-impl(this.buffer) < requiredCapacity) {
            long[] copyOf = Arrays.copyOf(this.buffer, RangesKt.coerceAtLeast(requiredCapacity, ULongArray.getSize-impl(this.buffer) * 2));
    ...
    public final void m1548appendVKZWuLQ$kotlinx_serialization_core(long c) {
        PrimitiveArrayBuilder.ensureCapacity$kotlinx_serialization_core$default(this, 0, 1, null);
        long[] jArr = this.buffer;
        int position$kotlinx_serialization_core = getPosition$kotlinx_serialization_core();
        this.position = position$kotlinx_serialization_core + 1;
        ULongArray.set-k8EXiF4(jArr, position$kotlinx_serialization_core, c);
    }

    /* renamed from: build-Y2RjT0g$kotlinx_serialization_core  reason: not valid java name */
    public long[] m1549buildY2RjT0g$kotlinx_serialization_core() {
