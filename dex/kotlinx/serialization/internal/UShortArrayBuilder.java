...
public final class UShortArrayBuilder extends PrimitiveArrayBuilder<UShortArray> {
    ...
    public /* bridge */ /* synthetic */ UShortArray build$kotlinx_serialization_core() {
        return UShortArray.box-impl(m1557buildamswpOA$kotlinx_serialization_core());
    }
    ...
    public void ensureCapacity$kotlinx_serialization_core(int requiredCapacity) {
        if (UShortArray.getSize-impl(this.buffer) < requiredCapacity) {
            short[] copyOf = Arrays.copyOf(this.buffer, RangesKt.coerceAtLeast(requiredCapacity, UShortArray.getSize-impl(this.buffer) * 2));
    ...
    public final void m1556appendxj2QHRw$kotlinx_serialization_core(short c) {
        PrimitiveArrayBuilder.ensureCapacity$kotlinx_serialization_core$default(this, 0, 1, null);
        short[] sArr = this.buffer;
        int position$kotlinx_serialization_core = getPosition$kotlinx_serialization_core();
        this.position = position$kotlinx_serialization_core + 1;
        UShortArray.set-01HTLdE(sArr, position$kotlinx_serialization_core, c);
    }

    /* renamed from: build-amswpOA$kotlinx_serialization_core  reason: not valid java name */
    public short[] m1557buildamswpOA$kotlinx_serialization_core() {
