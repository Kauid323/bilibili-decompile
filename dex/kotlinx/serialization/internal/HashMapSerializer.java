...
public final class HashMapSerializer<K, V> extends MapLikeSerializer<K, V, Map<K, ? extends V>, HashMap<K, V>> {
    ...
    public /* bridge */ /* synthetic */ int builderSize(Object $this$builderSize) {
        return builderSize((HashMap) ((HashMap) $this$builderSize));
    }

    @Override // kotlinx.serialization.internal.AbstractCollectionSerializer
    public /* bridge */ /* synthetic */ void checkCapacity(Object $this$checkCapacity, int size) {
        checkCapacity((HashMap) ((HashMap) $this$checkCapacity), size);
    }
    ...
    public /* bridge */ /* synthetic */ void insertKeyValuePair(Map $this$insertKeyValuePair, int index, Object key, Object value) {
        insertKeyValuePair((HashMap<int, Object>) $this$insertKeyValuePair, index, (int) key, value);
    }
    ...
    public /* bridge */ /* synthetic */ Object toResult(Object $this$toResult) {
        return toResult((HashMap) ((HashMap) $this$toResult));
    }
    ...
    protected void checkCapacity(HashMap<K, V> hashMap, int size) {
        Intrinsics.checkNotNullParameter(hashMap, "<this>");
    }
