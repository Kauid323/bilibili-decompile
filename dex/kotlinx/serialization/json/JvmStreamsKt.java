...
public final class JvmStreamsKt {
    ...
    @ExperimentalSerializationApi
    public static final <T> T decodeFromStream(Json $this$decodeFromStream, DeserializationStrategy<? extends T> deserializer, InputStream stream) {
        ...
        try {
            return (T) JsonStreamsKt.decodeByReader($this$decodeFromStream, deserializer, reader);
        } finally {
            reader.release();
        }
    }
    ...
    public static final /* synthetic */ <T> T decodeFromStream(Json $this$decodeFromStream, InputStream stream) {
        Intrinsics.checkNotNullParameter($this$decodeFromStream, "<this>");
        Intrinsics.checkNotNullParameter(stream, "stream");
        SerializersModule serializersModule = $this$decodeFromStream.getSerializersModule();
        Intrinsics.reifiedOperationMarker(6, "T");
        MagicApiIntrinsics.voidMagicApiCall("kotlinx.serialization.serializer.withModule");
        return (T) decodeFromStream($this$decodeFromStream, SerializersKt.serializer(serializersModule, (KType) null), stream);
    }
