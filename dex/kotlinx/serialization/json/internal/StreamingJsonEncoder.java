...
public final class StreamingJsonEncoder extends AbstractEncoder implements JsonEncoder {
    ...
    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.CompositeEncoder
    public <T> void encodeNullableSerializableElement(SerialDescriptor descriptor, int index, SerializationStrategy<? super T> serializer, T t) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        Intrinsics.checkNotNullParameter(serializer, "serializer");
        if (t != null || this.configuration.getExplicitNulls()) {
            super.encodeNullableSerializableElement(descriptor, index, serializer, t);
        }
    }
    ...
    public Encoder encodeInline(SerialDescriptor descriptor) {
        ...
        if (!StreamingJsonEncoderKt.isUnsignedNumber(descriptor)) {
            ...
            if (this.composer instanceof ComposerForUnquotedLiterals) {
                ...
                JsonWriter p0 = this.composer.writer;
        ...
        if (this.composer instanceof ComposerForUnsignedNumbers) {
            ...
            JsonWriter p02 = this.composer.writer;
