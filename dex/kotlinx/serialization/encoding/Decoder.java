...
public interface Decoder {
    ...
    public static final class DefaultImpls {
        ...
        @ExperimentalSerializationApi
        public static <T> T decodeNullableSerializableValue(Decoder $this, DeserializationStrategy<? extends T> deserializer) {
            Intrinsics.checkNotNullParameter(deserializer, "deserializer");
            boolean isNullabilitySupported = deserializer.getDescriptor().isNullable();
            return (isNullabilitySupported || $this.decodeNotNullMark()) ? (T) $this.decodeSerializableValue(deserializer) : (T) $this.decodeNull();
        }
    }
}