...
public interface SerializersModuleCollector {
    ...
    public static final class DefaultImpls {
        public static <T> void contextual(SerializersModuleCollector $this, KClass<T> kClass, final KSerializer<T> serializer) {
            ...
            $this.contextual(kClass, new Function1<List<? extends KSerializer<?>>, KSerializer<?>>() { // from class: kotlinx.serialization.modules.SerializersModuleCollector$contextual$1
