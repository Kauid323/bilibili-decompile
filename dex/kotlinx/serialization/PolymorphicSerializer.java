...
public final class PolymorphicSerializer<T> extends AbstractPolymorphicSerializer<T> {
    ...
    public PolymorphicSerializer(KClass<T> baseClass) {
        ...
        this.descriptor$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0<SerialDescriptor>(this) { // from class: kotlinx.serialization.PolymorphicSerializer$descriptor$2
