...
public final class CompletionStateKt {
    ...
    public static final <T> Object toState(Object $this$toState, Function1<? super Throwable, Unit> function1) {
        Throwable it = Result.exceptionOrNull-impl($this$toState);
        if (it == null) {
    ...
    public static final <T> Object toState(Object $this$toState, CancellableContinuation<?> cancellableContinuation) {
        ...
        if (!DebugKt.getRECOVER_STACK_TRACES() || !(cancellableContinuation instanceof CoroutineStackFrame)) {
            ...
            th = StackTraceRecoveryKt.access$recoverFromStackFrame(it, (CoroutineStackFrame) cancellableContinuation);
        }
    ...
    public static final <T> Object recoverResult(Object state, Continuation<? super T> continuation) {
        if (state instanceof CompletedExceptionally) {
            ...
            if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                exception$iv = StackTraceRecoveryKt.access$recoverFromStackFrame(exception$iv, (CoroutineStackFrame) continuation);
            }
            return Result.constructor-impl(ResultKt.createFailure(exception$iv));
        }
        Result.Companion companion2 = Result.Companion;
        return Result.constructor-impl(state);
    }
}