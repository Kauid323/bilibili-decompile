...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        Object $this$onSuccess_u2dWpGqRn0$iv = sendChannel.mo1399trySendJP2dKIU(e);
        if ($this$onSuccess_u2dWpGqRn0$iv instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlocking$default).m1422unboximpl();
        }
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel $this$sendBlocking, Object element) {
        if (!ChannelResult.m1420isSuccessimpl($this$sendBlocking.mo1399trySendJP2dKIU(element))) {
