    ...
    public static final Object awaitClose(ProducerScope<?> producerScope, Function0<Unit> function0, Continuation<? super Unit> continuation) {
        ...
        try {
            if (continuation instanceof ProduceKt$awaitClose$1) {
                ...
                if ((produceKt$awaitClose$1.label & IntCompanionObject.MIN_VALUE) != 0) {
                    produceKt$awaitClose$1.label -= IntCompanionObject.MIN_VALUE;
                    ...
                    switch (produceKt$awaitClose$12.label) {
                        case 0:
                            ...
                            if (produceKt$awaitClose$12.getContext().get(Job.Key) == producerScope) {
                                ...
                                producerScope.mo1469invokeOnClose(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.channels.ProduceKt$awaitClose$4$1
