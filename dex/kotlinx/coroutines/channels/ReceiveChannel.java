...
public interface ReceiveChannel<E> {
    ...
    Object mo1403receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1404tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object result = receiveChannel.mo1404tryReceivePtdJZtk();
            if (ChannelResult.m1420isSuccessimpl(result)) {
                return (E) ChannelResult.m1416getOrThrowimpl(result);
            }
            Throwable m1414exceptionOrNullimpl = ChannelResult.m1414exceptionOrNullimpl(result);
            if (m1414exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1414exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            Object mo1403receiveCatchingJP2dKIU;
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & IntCompanionObject.MIN_VALUE) != 0) {
                    receiveChannel$receiveOrNull$1.label -= IntCompanionObject.MIN_VALUE;
                    ...
                    switch (receiveChannel$receiveOrNull$12.label) {
                        case 0:
                            ...
                            mo1403receiveCatchingJP2dKIU = receiveChannel.mo1403receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$12);
                            if (mo1403receiveCatchingJP2dKIU == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            break;
                        case 1:
                            ResultKt.throwOnFailure($result);
                            mo1403receiveCatchingJP2dKIU = ((ChannelResult) $result).m1422unboximpl();
                            break;
                        default:
                            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    }
                    return ChannelResult.m1415getOrNullimpl(mo1403receiveCatchingJP2dKIU);
                }
            }
