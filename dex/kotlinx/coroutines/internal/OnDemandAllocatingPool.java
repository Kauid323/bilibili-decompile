...
public final class OnDemandAllocatingPool<T> {
    ...
    private final int tryForbidNewElements() {
        ...
        do {
            ...
            if ((it & IntCompanionObject.MIN_VALUE) != 0) {
                return 0;
            }
        } while (!controlState$volatile$FU.compareAndSet(this, it, it | IntCompanionObject.MIN_VALUE));
        return it;
    }
    ...
    public final List<T> close() {
        ...
        while (true) {
            ...
            if (!((it$iv & IntCompanionObject.MIN_VALUE) != 0)) {
                if (controlState$volatile$FU.compareAndSet(this, it$iv, it$iv | IntCompanionObject.MIN_VALUE)) {
                    break;
                }
            } else {
                it$iv = 0;
