...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    private static final CoroutineDispatcher f6default;
    ...
    static {
        ...
        f6default = unlimitedIoScheduler.limitedParallelism(systemProp$default);
    }
    ...
    public void execute(Runnable command) {
        mo1456dispatch(EmptyCoroutineContext.INSTANCE, command);
    }
    ...
    public void mo1456dispatch(CoroutineContext context, Runnable block) {
        f6default.mo1456dispatch(context, block);
    }

    @Override // kotlinx.coroutines.CoroutineDispatcher
    public void dispatchYield(CoroutineContext context, Runnable block) {
        f6default.dispatchYield(context, block);
    }
