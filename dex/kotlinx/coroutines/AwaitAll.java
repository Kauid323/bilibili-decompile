...
public final class AwaitAll<T> {
    ...
    public final Object await(Continuation<? super List<? extends T>> continuation) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            invokeOnCompletion$default = JobKt__JobKt.invokeOnCompletion$default(deferred, false, false, $this$await_u24lambda_u242_u24lambda_u240, 3, null);
    ...
    public final class AwaitAllNode extends JobNode {
        ...
        public void invoke(Throwable cause) {
            if (cause != null) {
                ...
                cancellableContinuation.resumeWith(Result.constructor-impl((List) destination$iv$iv));
            }
        }
    }
}