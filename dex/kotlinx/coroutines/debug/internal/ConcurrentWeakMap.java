...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    public final class Core {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:34:0x0086, code lost:
            if (com.google.common.util.concurrent.Striped$SmallLazyStriped$.ExternalSyntheticBackportWithForwarding0.m(getValues(), r0, r1, r13) == false) goto L19;
         */
        ...
        public final Object putImpl(K k, V v, HashedWeakRef<K> hashedWeakRef) {
            ...
            while (true) {
                ...
                if (w != null) {
                    ...
                    if (Striped$SmallLazyStriped$.ExternalSyntheticBackportWithForwarding0.m(getKeys(), index, (Object) null, hashedWeakRef2)) {
                        break;
                    }
                }
            }
            ...
            while (true) {
                ...
                for (int index = 0; index < i; index++) {
                    ...
                    while (true) {
                        ...
                        if (Striped$SmallLazyStriped$.ExternalSyntheticBackportWithForwarding0.m(values, index, value, mark)) {
                            break;
                        }
                    }
