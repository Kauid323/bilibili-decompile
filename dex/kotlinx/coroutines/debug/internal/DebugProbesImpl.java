...
public final class DebugProbesImpl {
    ...
    public final boolean isInstalled$kotlinx_coroutines_debug() {
        return DebugProbesImpl$DebugProbesImpl$VolatileWrapper$atomicfu$private.access$getInstallations$volatile$FU().get(debugProbesImpl$VolatileWrapper$atomicfu$private) > 0;
    }
    ...
    public final void install$kotlinx_coroutines_core() {
        ...
        if (DebugProbesImpl$DebugProbesImpl$VolatileWrapper$atomicfu$private.access$getInstallations$volatile$FU().incrementAndGet(debugProbesImpl$VolatileWrapper$atomicfu$private) > 1) {
            return;
        }
    ...
    public final void uninstall$kotlinx_coroutines_core() {
        ...
        if (DebugProbesImpl$DebugProbesImpl$VolatileWrapper$atomicfu$private.access$getInstallations$volatile$FU().decrementAndGet(debugProbesImpl$VolatileWrapper$atomicfu$private) != 0) {
            return;
        }
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> list) {
        ...
        int continuationStartFrame = ((Number) findContinuationStartIndex.component1()).intValue();
        int delta = ((Number) findContinuationStartIndex.component2()).intValue();
    ...
    private final <T> Continuation<T> createOwner(Continuation<? super T> continuation, StackTraceFrame frame) {
        if (isInstalled$kotlinx_coroutines_debug()) {
            DebugCoroutineInfoImpl info = new DebugCoroutineInfoImpl(continuation.getContext(), frame, DebugProbesImpl$DebugProbesImpl$VolatileWrapper$atomicfu$private.access$getSequenceNumber$volatile$FU().incrementAndGet(debugProbesImpl$VolatileWrapper$atomicfu$private));
