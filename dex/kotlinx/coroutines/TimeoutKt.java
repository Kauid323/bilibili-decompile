...
public final class TimeoutKt {
    ...
    public static final <T> Object m1396withTimeoutKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m1388toDelayMillisLRDsOJo(timeout), function2, continuation);
    }
    ...
    */
    public static final <T> Object withTimeoutOrNull(long timeMillis, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        ...
        if (continuation instanceof TimeoutKt$withTimeoutOrNull$1) {
            ...
            if ((timeoutKt$withTimeoutOrNull$1.label & IntCompanionObject.MIN_VALUE) != 0) {
                timeoutKt$withTimeoutOrNull$1.label -= IntCompanionObject.MIN_VALUE;
    ...
    public static final <T> Object m1397withTimeoutOrNullKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m1388toDelayMillisLRDsOJo(timeout), function2, continuation);
    }
    ...
    */
    public static final TimeoutCancellationException TimeoutCancellationException(long time, Delay delay, Job coroutine) {
        ...
        if (delayWithTimeoutDiagnostics != null) {
            ...
            message = delayWithTimeoutDiagnostics.m1389timeoutMessageLRDsOJo(DurationKt.toDuration(time, DurationUnit.MILLISECONDS));
        }
