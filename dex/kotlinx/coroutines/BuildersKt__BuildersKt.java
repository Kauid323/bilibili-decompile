    ...
    */
    public static final <T> T runBlocking(CoroutineContext context, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) throws InterruptedException {
        ...
        if (contextInterceptor == null) {
            ...
            EventLoop eventLoop2 = contextInterceptor instanceof EventLoop ? (EventLoop) contextInterceptor : null;
            if (eventLoop2 != null) {
                EventLoop it = eventLoop2;
                currentOrNull$kotlinx_coroutines_core = it.shouldBeProcessedFromContext() ? eventLoop2 : null;
            }
