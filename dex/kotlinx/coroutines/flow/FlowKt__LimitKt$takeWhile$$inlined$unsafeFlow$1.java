...
public final class FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1", f = "Limit.kt", i = {0}, l = {H265Utils.kLevel4_1}, m = "collect", n = {"collector$iv"}, s = {"L$0"})
                ...
                switch (anonymousClass12.label) {
                    case 0:
                        ...
                        try {
                            ...
                            if ($this$collectWhile$iv.collect(collector$iv2, anonymousClass12) == coroutine_suspended) {
                    ...
                    case 1:
                        collector$iv = (FlowKt__LimitKt$takeWhile$lambda$6$$inlined$collectWhile$1) anonymousClass12.L$0;
                        try {
                            ResultKt.throwOnFailure($result);
