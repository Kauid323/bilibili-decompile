...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4<T> implements Flow<T> {
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        FlowCollector $this$asFlow_u24lambda_u245;
        Iterator it;
            ...
            if ((anonymousClass1.label & IntCompanionObject.MIN_VALUE) != 0) {
                ...
                switch (anonymousClass12.label) {
                    case 0:
                        ...
                        $this$asFlow_u24lambda_u245 = flowCollector;
                        it = $this$forEach$iv;
                        break;
                    case 1:
                        it = (Iterator) anonymousClass12.L$1;
                        $this$asFlow_u24lambda_u245 = (FlowCollector) anonymousClass12.L$0;
                        ResultKt.throwOnFailure($result);
                        break;
                    default:
                ...
                while (it.hasNext()) {
                    ...
                    anonymousClass12.L$0 = $this$asFlow_u24lambda_u245;
                    anonymousClass12.L$1 = it;
                    anonymousClass12.label = 1;
                    if ($this$asFlow_u24lambda_u245.emit(value, anonymousClass12) == coroutine_suspended) {
