    ...
    public static final class AnonymousClass2<T> implements FlowCollector {
        ...
        */
        public final Object emit(T t, Continuation<? super Unit> continuation) {
            ...
            boolean z;
            Object transformed;
            FlowCollector $this$mapNotNull_u24lambda_u246;
                ...
                if ((anonymousClass1.label & IntCompanionObject.MIN_VALUE) != 0) {
                    ...
                    switch (anonymousClass12.label) {
                        case 0:
                            ...
                            FlowCollector $this$mapNotNull_u24lambda_u2462 = this.$this_unsafeFlow;
                            z = false;
                            Function2 function2 = this.$transform$inlined;
                            anonymousClass12.L$0 = $this$mapNotNull_u24lambda_u2462;
                            anonymousClass12.label = 1;
                            transformed = function2.invoke(t, anonymousClass12);
                            if (transformed == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            $this$mapNotNull_u24lambda_u246 = $this$mapNotNull_u24lambda_u2462;
                            if (transformed != null) {
                                anonymousClass12.L$0 = null;
                                anonymousClass12.label = 2;
                                if ($this$mapNotNull_u24lambda_u246.emit(transformed, anonymousClass12) == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                            }
                            return Unit.INSTANCE;
                        case 1:
                            $this$mapNotNull_u24lambda_u246 = (FlowCollector) anonymousClass12.L$0;
                            ResultKt.throwOnFailure($result);
                            z = false;
                            transformed = $result;
                            if (transformed != null) {
