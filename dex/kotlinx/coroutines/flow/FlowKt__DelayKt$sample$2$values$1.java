        ...
        */
        public final Object emit(T t, Continuation<? super Unit> continuation) {
            ...
            if (continuation instanceof FlowKt__DelayKt$sample$2$values$1$1$emit$1) {
                ...
                if ((flowKt__DelayKt$sample$2$values$1$1$emit$1.label & IntCompanionObject.MIN_VALUE) != 0) {
                    flowKt__DelayKt$sample$2$values$1$1$emit$1.label -= IntCompanionObject.MIN_VALUE;
