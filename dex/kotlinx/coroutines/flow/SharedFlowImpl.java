...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:35:0x00bd -> B:30:0x00a2). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:41:0x00d5 -> B:29:0x009e). Please submit an issue!!! */
    /*
    ...
    */
    public static /* synthetic */ <T> Object collect$suspendImpl(SharedFlowImpl<T> sharedFlowImpl, FlowCollector<? super T> flowCollector, Continuation<?> continuation) {
        ...
        SharedFlowImpl $this2;
        FlowCollector<? super T> flowCollector5;
        Object newValue;
        FlowCollector<? super T> flowCollector6;
        SharedFlowImpl $this3;
        try {
            if (continuation instanceof SharedFlowImpl$collect$1) {
                sharedFlowImpl$collect$1 = (SharedFlowImpl$collect$1) continuation;
                if ((sharedFlowImpl$collect$1.label & IntCompanionObject.MIN_VALUE) != 0) {
                    sharedFlowImpl$collect$1.label -= IntCompanionObject.MIN_VALUE;
                    ...
                    switch (sharedFlowImpl$collect$12.label) {
                        case 0:
                            ...
                            SharedFlowImpl $this4 = sharedFlowImpl;
                            flowCollector2 = flowCollector;
                            SharedFlowSlot allocateSlot = $this4.allocateSlot();
                            $this = $this4;
                            flowCollector3 = allocateSlot;
                            if (flowCollector2 instanceof SubscribedFlowCollector) {
                                sharedFlowImpl$collect$12.L$0 = $this4;
                            ...
                            Job job = collectorJob;
                            flowCollector4 = flowCollector2;
                            collectorJob2 = job;
                            $this2 = $this3;
                            flowCollector = flowCollector6;
                            SharedFlowSlot slot = (SharedFlowSlot) flowCollector;
                            newValue = $this2.tryTakeValue(slot);
                            if (newValue == SharedFlowKt.NO_VALUE) {
                                if (collectorJob2 != null) {
                                    JobKt.ensureActive(collectorJob2);
                                }
                                sharedFlowImpl$collect$12.L$0 = $this2;
                                sharedFlowImpl$collect$12.L$1 = flowCollector4;
                                sharedFlowImpl$collect$12.L$2 = flowCollector;
                                sharedFlowImpl$collect$12.L$3 = collectorJob2;
                                sharedFlowImpl$collect$12.label = 3;
                                if (flowCollector4.emit(newValue, sharedFlowImpl$collect$12) == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                                FlowCollector<? super T> flowCollector7 = flowCollector4;
                                collectorJob = collectorJob2;
                                flowCollector2 = flowCollector7;
                                $this3 = $this2;
                                flowCollector6 = flowCollector;
                                Job job2 = collectorJob;
                                flowCollector4 = flowCollector2;
                                collectorJob2 = job2;
                                $this2 = $this3;
                                flowCollector = flowCollector6;
                                SharedFlowSlot slot2 = (SharedFlowSlot) flowCollector;
                                newValue = $this2.tryTakeValue(slot2);
                                if (newValue == SharedFlowKt.NO_VALUE) {
                                    sharedFlowImpl$collect$12.L$0 = $this2;
                                    sharedFlowImpl$collect$12.L$1 = flowCollector4;
                                    sharedFlowImpl$collect$12.L$2 = flowCollector;
                                    ...
                                    SharedFlowSlot slot3 = (SharedFlowSlot) flowCollector;
                                    Object awaitValue = $this2.awaitValue(slot3, sharedFlowImpl$collect$12);
                                    flowCollector5 = flowCollector;
                                    if (awaitValue == coroutine_suspended) {
                                        return coroutine_suspended;
                                    }
                                    $this2 = $this2;
                                    flowCollector = flowCollector5;
                                    SharedFlowSlot slot22 = (SharedFlowSlot) flowCollector;
                                    newValue = $this2.tryTakeValue(slot22);
                                    if (newValue == SharedFlowKt.NO_VALUE) {
                                    }
                                }
                            }
                        case 1:
                            ?? r8 = (SharedFlowSlot) sharedFlowImpl$collect$12.L$2;
                            flowCollector2 = (FlowCollector) sharedFlowImpl$collect$12.L$1;
                            SharedFlowImpl sharedFlowImpl2 = (SharedFlowImpl) sharedFlowImpl$collect$12.L$0;
                            ResultKt.throwOnFailure($result);
                            $this = sharedFlowImpl2;
                            flowCollector3 = r8;
                            collectorJob = (Job) sharedFlowImpl$collect$12.getContext().get(Job.Key);
                            $this3 = $this;
                            flowCollector6 = flowCollector3;
                            Job job22 = collectorJob;
                            flowCollector4 = flowCollector2;
                            collectorJob2 = job22;
                            $this2 = $this3;
                            flowCollector = flowCollector6;
                            SharedFlowSlot slot222 = (SharedFlowSlot) flowCollector;
                            newValue = $this2.tryTakeValue(slot222);
                            if (newValue == SharedFlowKt.NO_VALUE) {
                            }
                            break;
                        case 2:
                            collectorJob2 = (Job) sharedFlowImpl$collect$12.L$3;
                            ?? r82 = (SharedFlowSlot) sharedFlowImpl$collect$12.L$2;
                            flowCollector4 = (FlowCollector) sharedFlowImpl$collect$12.L$1;
                            $this2 = (SharedFlowImpl) sharedFlowImpl$collect$12.L$0;
                            ResultKt.throwOnFailure($result);
                            flowCollector5 = r82;
                            $this2 = $this2;
                            flowCollector = flowCollector5;
                            SharedFlowSlot slot2222 = (SharedFlowSlot) flowCollector;
                            newValue = $this2.tryTakeValue(slot2222);
                            if (newValue == SharedFlowKt.NO_VALUE) {
                            }
                            break;
                        case 3:
                            Job collectorJob3 = (Job) sharedFlowImpl$collect$12.L$3;
                            FlowCollector<? super T> flowCollector8 = (FlowCollector<? super T>) ((SharedFlowSlot) sharedFlowImpl$collect$12.L$2);
                            FlowCollector<? super T> flowCollector9 = (FlowCollector) sharedFlowImpl$collect$12.L$1;
                            SharedFlowImpl sharedFlowImpl3 = (SharedFlowImpl) sharedFlowImpl$collect$12.L$0;
                            ResultKt.throwOnFailure($result);
                            collectorJob = collectorJob3;
                            flowCollector2 = flowCollector9;
                            $this3 = sharedFlowImpl3;
                            flowCollector6 = flowCollector8;
                            Job job222 = collectorJob;
                            flowCollector4 = flowCollector2;
                            collectorJob2 = job222;
                            $this2 = $this3;
                            flowCollector = flowCollector6;
                            SharedFlowSlot slot22222 = (SharedFlowSlot) flowCollector;
                            newValue = $this2.tryTakeValue(slot22222);
                            if (newValue == SharedFlowKt.NO_VALUE) {
                            }
                            break;
                        default:
            ...
            $this2.freeSlot((AbstractSharedFlowSlot) flowCollector);
            throw th;
        }
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        for (Continuation r : continuationArr) {
            if (r != null) {
                ...
                r.resumeWith(Result.constructor-impl(Unit.INSTANCE));
            }
        }
    ...
    */
    ...
    private final Object tryTakeValue(SharedFlowSlot slot) {
        ...
        for (Continuation resume : continuationArr) {
            if (resume != null) {
                Result.Companion companion = Result.Companion;
                resume.resumeWith(Result.constructor-impl(Unit.INSTANCE));
            }
        }
        return value;
    }
