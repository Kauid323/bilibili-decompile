...
public final class FixedOffsetTimeZoneSerializer implements KSerializer<FixedOffsetTimeZone> {
    ...
    public FixedOffsetTimeZone deserialize(Decoder decoder) {
        ...
        TimeZone zone = TimeZone.Companion.of(decoder.decodeString());
        if (zone instanceof FixedOffsetTimeZone) {
            return (FixedOffsetTimeZone) zone;
        }
        throw new SerializationException("Timezone identifier '" + zone + "' does not correspond to a fixed-offset timezone");
    }
