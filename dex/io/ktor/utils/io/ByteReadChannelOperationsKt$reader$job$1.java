...
@DebugMetadata(c = "io.ktor.utils.io.ByteReadChannelOperationsKt$reader$job$1", f = "ByteReadChannelOperations.kt", i = {0, 0, 1, 3, 5}, l = {291, 301, 302, 301, 302, 301, 302}, m = "invokeSuspend", n = {"$this$launch", "nested", "$this$launch", "$this$launch", "$this$launch"}, s = {"L$0", "L$1", "L$0", "L$0", "L$0"})
final class ByteReadChannelOperationsKt$reader$job$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> byteReadChannelOperationsKt$reader$job$1 = new ByteReadChannelOperationsKt$reader$job$1(this.$block, this.$channel, continuation);
    ...
    */
    public final Object invokeSuspend(Object $result) {
        ...
        Function2<ReaderScope, Continuation<? super Unit>, Object> function2;
        ...
        switch (i) {
            case 0:
                ...
                try {
                    ...
                    readerScope = new ReaderScope(this.$channel, $this$launch2.getCoroutineContext().plus((CoroutineContext) Job));
                    ...
                    nested = Job;
                    try {
                        JobKt.cancel(nested, "Exception thrown while reading from channel", cause);
                        ByteWriteChannelOperationsKt.close(this.$channel, cause);
