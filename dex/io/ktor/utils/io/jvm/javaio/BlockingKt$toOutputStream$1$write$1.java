...
@DebugMetadata(c = "io.ktor.utils.io.jvm.javaio.BlockingKt$toOutputStream$1$write$1", f = "Blocking.kt", i = {}, l = {PropertyIDConstants.AlignItems}, m = "invokeSuspend", n = {}, s = {})
final class BlockingKt$toOutputStream$1$write$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public BlockingKt$toOutputStream$1$write$1(ByteWriteChannel byteWriteChannel, int i, Continuation<? super BlockingKt$toOutputStream$1$write$1> continuation) {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (ByteWriteChannelOperationsKt.writeByte(this.$this_toOutputStream, (byte) this.$b, (Continuation) this) == coroutine_suspended) {
