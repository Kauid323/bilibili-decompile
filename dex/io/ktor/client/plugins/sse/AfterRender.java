...
public final class AfterRender implements ClientHook<Function3<? super HttpRequestBuilder, ? super OutgoingContent, ? super Continuation<? super OutgoingContent>, ? extends Object>> {
    ...
    public void install(HttpClient client, Function3<? super HttpRequestBuilder, ? super OutgoingContent, ? super Continuation<? super OutgoingContent>, ? extends Object> function3) {
        ...
        PipelinePhase phase = new PipelinePhase("AfterRender");
        client.getRequestPipeline().insertPhaseAfter(HttpRequestPipeline.Phases.getRender(), phase);
        client.getRequestPipeline().intercept(phase, new AfterRender$install$1(function3, null));
    }
}