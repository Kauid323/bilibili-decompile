...
@DebugMetadata(c = "io.ktor.client.plugins.cookies.HttpCookies$Companion$install$2", f = "HttpCookies.kt", i = {}, l = {TbsListener.ErrorCode.DOWNLOAD_HAS_LOCAL_TBS_ERROR}, m = "invokeSuspend", n = {}, s = {})
final class HttpCookies$Companion$install$2 extends SuspendLambda implements Function3<PipelineContext<Object, HttpRequestBuilder>, Object, Continuation<? super Unit>, Object> {
    ...
    public HttpCookies$Companion$install$2(HttpCookies httpCookies, Continuation<? super HttpCookies$Companion$install$2> continuation) {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (this.$plugin.sendCookiesWith$ktor_client_core((HttpRequestBuilder) $this$intercept.getContext(), (Continuation) this) == coroutine_suspended) {
