...
@DebugMetadata(c = "io.ktor.client.plugins.HttpCallValidatorKt$HttpCallValidator$2$4", f = "HttpCallValidator.kt", i = {0}, l = {TbsListener.ErrorCode.DOWNLOAD_THROWABLE}, m = "invokeSuspend", n = {"unwrappedCause"}, s = {"L$0"})
public final class HttpCallValidatorKt$HttpCallValidator$2$4 extends SuspendLambda implements Function3<HttpRequest, Throwable, Continuation<? super Throwable>, Object> {
    ...
    public HttpCallValidatorKt$HttpCallValidator$2$4(List<? extends HandlerWrapper> list, Continuation<? super HttpCallValidatorKt$HttpCallValidator$2$4> continuation) {
