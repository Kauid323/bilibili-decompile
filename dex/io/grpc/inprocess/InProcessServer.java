...
public final class InProcessServer implements InternalServer {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static InProcessServer findServer(String name) {
        return registry.get(name);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public InProcessServer(InProcessServerBuilder builder, List<? extends ServerStreamTracer.Factory> streamTracerFactories) {
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this).add(ContentDisposition.Parameters.Name, this.name).toString();
    }
