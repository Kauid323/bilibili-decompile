...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public final <R> R to(ObservableConverter<T, ? extends R> converter) {
        return (R) ((ObservableConverter) Objects.requireNonNull(converter, "converter is null")).apply(this);
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <R> Observable<R> mapOptional(io.reactivex.rxjava3.functions.Function<? super T, Optional<? extends R>> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <R> Observable<R> concatMapStream(io.reactivex.rxjava3.functions.Function<? super T, ? extends Stream<? extends R>> mapper) {
        return flatMapStream(mapper);
    }

    @CheckReturnValue
    @SchedulerSupport("none")
    public final <R> Observable<R> flatMapStream(io.reactivex.rxjava3.functions.Function<? super T, ? extends Stream<? extends R>> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
