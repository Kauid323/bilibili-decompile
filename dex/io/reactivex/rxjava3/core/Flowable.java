...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    public final <R> R to(FlowableConverter<T, ? extends R> converter) {
        return (R) ((FlowableConverter) Objects.requireNonNull(converter, "converter is null")).apply(this);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public final <R> Flowable<R> mapOptional(io.reactivex.rxjava3.functions.Function<? super T, Optional<? extends R>> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
    ...
    public final Stream<T> blockingStream(int prefetch) {
        ...
        disposable.getClass();
        return stream.onClose(new Flowable$$ExternalSyntheticLambda0(disposable));
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public final <R> Flowable<R> concatMapStream(io.reactivex.rxjava3.functions.Function<? super T, ? extends Stream<? extends R>> mapper) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public final <R> Flowable<R> concatMapStream(io.reactivex.rxjava3.functions.Function<? super T, ? extends Stream<? extends R>> mapper, int prefetch) {
        Objects.requireNonNull(mapper, "mapper is null");
        ObjectHelper.verifyPositive(prefetch, "prefetch");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public final <R> Flowable<R> flatMapStream(io.reactivex.rxjava3.functions.Function<? super T, ? extends Stream<? extends R>> mapper) {
        return flatMapStream(mapper, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public final <R> Flowable<R> flatMapStream(io.reactivex.rxjava3.functions.Function<? super T, ? extends Stream<? extends R>> mapper, int prefetch) {
        Objects.requireNonNull(mapper, "mapper is null");
        ObjectHelper.verifyPositive(prefetch, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapStream(this, mapper, prefetch));
    }
