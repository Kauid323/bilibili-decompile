...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public final <R> R to(MaybeConverter<T, ? extends R> converter) {
        return (R) ((MaybeConverter) Objects.requireNonNull(converter, "converter is null")).apply(this);
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <R> Maybe<R> mapOptional(io.reactivex.rxjava3.functions.Function<? super T, Optional<? extends R>> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public final <R> Flowable<R> flattenStreamAsFlowable(io.reactivex.rxjava3.functions.Function<? super T, ? extends Stream<? extends R>> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <R> Observable<R> flattenStreamAsObservable(io.reactivex.rxjava3.functions.Function<? super T, ? extends Stream<? extends R>> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
