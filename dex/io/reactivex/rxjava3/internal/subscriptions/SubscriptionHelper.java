...
public enum SubscriptionHelper implements Subscription {
    ...
    public static boolean set(AtomicReference<Subscription> field, Subscription s) {
        ...
        } while (!MutatorMutex$.ExternalSyntheticBackportWithForwarding0.m(field, current, s));
        if (current != null) {
            current.cancel();
            return true;
        }
    ...
    public static boolean setOnce(AtomicReference<Subscription> field, Subscription s) {
        ...
        if (!MutatorMutex$.ExternalSyntheticBackportWithForwarding0.m(field, (Object) null, s)) {
            s.cancel();
