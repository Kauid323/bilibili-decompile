...
public final class ObservableInternalHelper {
    ...
    public static final class ItemDelayFunction<T, U> implements Function<T, ObservableSource<T>> {
        ...
        public ObservableSource<T> apply(final T v) throws Throwable {
            ObservableSource<U> o = (ObservableSource) Objects.requireNonNull(this.itemDelay.apply(v), "The itemDelay returned a null ObservableSource");
    ...
    public static final class FlatMapWithCombinerOuter<T, R, U> implements Function<T, ObservableSource<R>> {
        ...
        public ObservableSource<R> apply(final T t) throws Throwable {
            ObservableSource<U> u = (ObservableSource) Objects.requireNonNull(this.mapper.apply(t), "The mapper returned a null ObservableSource");
