                ...
                if (!this.active) {
                    ...
                    try {
                        ...
                        if (d && empty) {
                            ...
                            try {
                                ObservableSource<? extends U> o = (ObservableSource) Objects.requireNonNull(this.mapper.apply(t), "The mapper returned a null ObservableSource");
                                this.active = true;
                    ...
                    if (this.cancelled) {
                        ...
                        try {
                            ...
                            if (d && empty) {
                                ...
                                try {
                                    ObservableSource<? extends R> o = (ObservableSource) Objects.requireNonNull(this.mapper.apply(v), "The mapper returned a null ObservableSource");
