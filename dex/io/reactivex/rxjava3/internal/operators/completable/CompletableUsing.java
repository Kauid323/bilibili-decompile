...
public final class CompletableUsing<R> extends Completable {
    ...
    protected void subscribeActual(CompletableObserver observer) {
        try {
            ...
            try {
                CompletableSource source = (CompletableSource) Objects.requireNonNull(this.completableFunction.apply(resource), "The completableFunction returned a null CompletableSource");
