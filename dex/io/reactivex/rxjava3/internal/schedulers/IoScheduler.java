...
public final class IoScheduler extends Scheduler {
    ...
    static {
        ...
        NONE = new CachedWorkerPool(KEEP_ALIVE_TIME, null, WORKER_THREAD_FACTORY);
        NONE.shutdown();
    }
    ...
    public static final class CachedWorkerPool implements Runnable {
        ...
        CachedWorkerPool(long keepAliveTime, TimeUnit unit, ThreadFactory threadFactory) {
            this.keepAliveTime = unit != null ? unit.toNanos(keepAliveTime) : IoScheduler.KEEP_ALIVE_TIME;
    ...
    public void shutdown() {
        CachedWorkerPool curr = this.pool.getAndSet(NONE);
        if (curr != NONE) {
            curr.shutdown();
        }
    }
    ...
    public static final class ThreadWorker extends NewThreadWorker {
        ...
        ThreadWorker(ThreadFactory threadFactory) {
            super(threadFactory);
            this.expirationTime = IoScheduler.KEEP_ALIVE_TIME;
        }
