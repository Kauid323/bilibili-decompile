...
public final class BlockingObservable<T> {
    ...
    public void forEach(final Action1<? super T> onNext) {
        ...
        Subscription subscription = this.o.subscribe(new Subscriber<T>() { // from class: rx.observables.BlockingObservable.1
    ...
    private T blockForSingle(Observable<? extends T> observable) {
        ...
        final CountDownLatch latch = new CountDownLatch(1);
        Subscription subscription = observable.subscribe(new Subscriber<T>() { // from class: rx.observables.BlockingObservable.3
            public void onCompleted() {
                latch.countDown();
            }
    ...
    public void subscribe() {
        ...
        Subscription s = this.o.subscribe(new Subscriber<T>() { // from class: rx.observables.BlockingObservable.4
    ...
    public void subscribe(Observer<? super T> observer) {
        ...
        Subscription s = this.o.subscribe(new Subscriber<T>() { // from class: rx.observables.BlockingObservable.5
            public void onNext(T t) {
