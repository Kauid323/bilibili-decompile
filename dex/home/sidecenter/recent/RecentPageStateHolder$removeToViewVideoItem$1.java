...
@DebugMetadata(c = "home.sidecenter.recent.RecentPageStateHolder$removeToViewVideoItem$1", f = "RecentPageStateHolder.kt", i = {0, 0, 0, 1, 1, 2, 2}, l = {TbsListener.ErrorCode.EXCEED_UNZIP_RETRY_NUM, TbsListener.ErrorCode.APK_VERSION_ERROR, TbsListener.ErrorCode.UNZIP_IO_ERROR}, m = "invokeSuspend", n = {"$this$RecentActionResult", "meta", "req", "$this$RecentActionResult", "meta", "$this$RecentActionResult", "e"}, s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$0", "L$1"}, v = 1)
final class RecentPageStateHolder$removeToViewVideoItem$1 extends SuspendLambda implements Function2<FlowCollector<? super IRecentAction>, Continuation<? super Unit>, Object> {
    ...
    public RecentPageStateHolder$removeToViewVideoItem$1(RecentVideoContent recentVideoContent, Continuation<? super RecentPageStateHolder$removeToViewVideoItem$1> continuation) {
        super(2, continuation);
        this.$item = recentVideoContent;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> recentPageStateHolder$removeToViewVideoItem$1 = new RecentPageStateHolder$removeToViewVideoItem$1(this.$item, continuation);
        recentPageStateHolder$removeToViewVideoItem$1.L$0 = obj;
        return recentPageStateHolder$removeToViewVideoItem$1;
    }
    ...
    */
    public final Object invokeSuspend(Object $result) {
        ...
        try {
            ...
            kLog.e("RecentPageStateHolder", "Fail to to-view video id " + boxLong + " type " + (recMeta2 != null ? recMeta2.getRecType() : null), e2);
            this.L$0 = SpillingKt.nullOutSpilledVariable($this$RecentActionResult);
            this.L$1 = SpillingKt.nullOutSpilledVariable(e2);
            this.L$2 = null;
            this.label = 3;
            if ($this$RecentActionResult.emit(new IRecentAction.DeleteToViewFailed(this.$item, e2), (Continuation) this) == coroutine_suspended) {
        ...
        switch (this.label) {
            case 0:
                ...
                kLog2.i("RecentPageStateHolder", "Start remove to-view video id " + boxLong2 + " type " + (recMeta4 != null ? recMeta4.getRecType() : null));
                ...
                if (meta == null) {
                    ...
                    this.L$2 = null;
                    this.label = 2;
                    if ($this$RecentActionResult.emit(new IRecentAction.DeleteToViewSuccess(this.$item), (Continuation) this) == coroutine_suspended) {
                    }
                    return Unit.INSTANCE;
                }
                KRemoveVideoReq req = new KRemoveVideoReq(KModuleType.MODULE_TYPE_TOVIEW.INSTANCE, meta.getId(), meta.getRecReasonEnum());
                this.L$0 = $this$RecentActionResult;
