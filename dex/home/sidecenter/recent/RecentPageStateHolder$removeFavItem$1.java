...
@DebugMetadata(c = "home.sidecenter.recent.RecentPageStateHolder$removeFavItem$1", f = "RecentPageStateHolder.kt", i = {0, 0, 0, 1, 1, 2, 2}, l = {TbsListener.ErrorCode.DECOUPLE_INSTLL_SUCCESS, TbsListener.ErrorCode.DECOUPLE_INCURUPDATE_FAIL, TbsListener.ErrorCode.TPATCH_FAIL}, m = "invokeSuspend", n = {"$this$RecentActionResult", "meta", "req", "$this$RecentActionResult", "meta", "$this$RecentActionResult", "e"}, s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$0", "L$1"}, v = 1)
final class RecentPageStateHolder$removeFavItem$1 extends SuspendLambda implements Function2<FlowCollector<? super IRecentAction>, Continuation<? super Unit>, Object> {
    final /* synthetic */ RecentFavContent $item;
    ...
    public RecentPageStateHolder$removeFavItem$1(RecentFavContent recentFavContent, Continuation<? super RecentPageStateHolder$removeFavItem$1> continuation) {
        super(2, continuation);
        this.$item = recentFavContent;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> recentPageStateHolder$removeFavItem$1 = new RecentPageStateHolder$removeFavItem$1(this.$item, continuation);
        recentPageStateHolder$removeFavItem$1.L$0 = obj;
        return recentPageStateHolder$removeFavItem$1;
    }
    ...
    */
    public final Object invokeSuspend(Object $result) {
        ...
        try {
            ...
            kLog.e("RecentPageStateHolder", "Fail to fav id " + boxLong + " type " + (recMeta2 != null ? recMeta2.getRecType() : null), e2);
            this.L$0 = SpillingKt.nullOutSpilledVariable($this$RecentActionResult);
            this.L$1 = SpillingKt.nullOutSpilledVariable(e2);
            this.L$2 = null;
            this.label = 3;
            if ($this$RecentActionResult.emit(new IRecentAction.DeleteFavFailed(this.$item, e2), (Continuation) this) == coroutine_suspended) {
        ...
        switch (this.label) {
            case 0:
                ...
                kLog2.i("RecentPageStateHolder", "Start remove fav id " + boxLong2 + " type " + (recMeta4 != null ? recMeta4.getRecType() : null));
                ...
                if (meta == null) {
                    ...
                    this.L$2 = null;
                    this.label = 2;
                    if ($this$RecentActionResult.emit(new IRecentAction.DeleteFavSuccess(this.$item), (Continuation) this) == coroutine_suspended) {
                    }
                    return Unit.INSTANCE;
                }
                KRemoveVideoReq req = new KRemoveVideoReq(KModuleType.MODULE_TYPE_RECENT_FAV.INSTANCE, meta.getId(), meta.getRecReasonEnum());
                this.L$0 = $this$RecentActionResult;
