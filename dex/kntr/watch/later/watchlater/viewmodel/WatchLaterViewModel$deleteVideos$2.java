...
@DebugMetadata(c = "kntr.watch.later.watchlater.viewmodel.WatchLaterViewModel$deleteVideos$2", f = "WatchLaterViewModel.kt", i = {0, 1}, l = {861, 861}, m = "invokeSuspend", n = {"$this$flow", "$this$flow"}, s = {"L$0", "L$0"}, v = 1)
public final class WatchLaterViewModel$deleteVideos$2 extends SuspendLambda implements Function2<FlowCollector<? super Boolean>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.L$1 = $this$flow;
                this.label = 1;
                Object deleteWatchLater = WatchLaterApiKt.deleteWatchLater(this.$resource, (Continuation) this);
                if (deleteWatchLater == coroutine_suspended) {
                    return coroutine_suspended;
                }
                obj = deleteWatchLater;
