...
@DebugMetadata(c = "kntr.common.photonic.aphro.ui.preview.ImagePageItemKt$ImagePageItem$3$1$1$2", f = "ImagePageItem.kt", i = {}, l = {157, 158, 159}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class ImagePageItemKt$ImagePageItem$3$1$1$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ImagePageItemKt$ImagePageItem$3$1$1$2(Animatable<Float, AnimationVector1D> animatable, float f, Animatable<Float, AnimationVector1D> animatable2, Pair<Offset, Boolean> pair, Animatable<Float, AnimationVector1D> animatable3, Continuation<? super ImagePageItemKt$ImagePageItem$3$1$1$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ImagePageItemKt$ImagePageItem$3$1$1$2(this.$scale, this.$newScale, this.$offsetX, this.$result, this.$offsetY, continuation);
    }
