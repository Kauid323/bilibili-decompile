...
@DebugMetadata(c = "kntr.common.photonic.aphro.ui.preview.PreviewPageContentKt$PreviewPageContent$1$9$3$1$1", f = "PreviewPageContent.kt", i = {0, 0, 0}, l = {221}, m = "invokeSuspend", n = {"asset", "it", "$i$a$-let-PreviewPageContentKt$PreviewPageContent$1$9$3$1$1$1"}, s = {"L$0", "L$1", "I$0"}, v = 1)
public final class PreviewPageContentKt$PreviewPageContent$1$9$3$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public PreviewPageContentKt$PreviewPageContent$1$9$3$1$1(AphroState.AphroContent aphroContent, ImagePreviewState imagePreviewState, AphroViewModel aphroViewModel, Continuation<? super PreviewPageContentKt$PreviewPageContent$1$9$3$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new PreviewPageContentKt$PreviewPageContent$1$9$3$1$1(this.$album, this.$imagePreviewState, this.$aphroViewModel, continuation);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Iterator<T> it = this.$album.getSelected().iterator();
                while (true) {
                    if (it.hasNext()) {
                        obj = it.next();
                        Asset it2 = (Asset) obj;
                ...
                if (asset != null) {
                    ...
                    this.I$0 = 0;
                    this.label = 1;
                    if (this.$aphroViewModel.dispatch(new AphroAction.UnSelectAsset(asset), this) != coroutine_suspended) {
                        break;
                    } else {
