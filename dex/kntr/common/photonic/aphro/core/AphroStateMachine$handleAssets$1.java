...
@DebugMetadata(c = "kntr.common.photonic.aphro.core.AphroStateMachine$handleAssets$1", f = "AphroStateMachine.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class AphroStateMachine$handleAssets$1 extends SuspendLambda implements Function3<AphroAction.SetSelectedAssets, State<AphroState.AphroContent>, Continuation<? super ChangedState<? extends AphroState>>, Object> {
    /* synthetic */ Object L$0;
    /* synthetic */ Object L$1;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    public AphroStateMachine$handleAssets$1(Continuation<? super AphroStateMachine$handleAssets$1> continuation) {
    ...
    public final Object invoke(AphroAction.SetSelectedAssets setSelectedAssets, State<AphroState.AphroContent> state, Continuation<? super ChangedState<? extends AphroState>> continuation) {
        AphroStateMachine$handleAssets$1 aphroStateMachine$handleAssets$1 = new AphroStateMachine$handleAssets$1(continuation);
        aphroStateMachine$handleAssets$1.L$0 = setSelectedAssets;
        aphroStateMachine$handleAssets$1.L$1 = state;
        return aphroStateMachine$handleAssets$1.invokeSuspend(Unit.INSTANCE);
    }
        ...
        switch (this.label) {
            case 0:
                ...
                if (action.getAssets().size() <= ((AphroState.AphroContent) state.getSnapshot()).getOption().getMaxSelectCount()) {
                    return state.mutate(new Function1() { // from class: kntr.common.photonic.aphro.core.AphroStateMachine$handleAssets$1$$ExternalSyntheticLambda0
                        public final Object invoke(Object obj) {
                            AphroState.AphroContent invokeSuspend$lambda$0;
                            invokeSuspend$lambda$0 = AphroStateMachine$handleAssets$1.invokeSuspend$lambda$0(AphroAction.SetSelectedAssets.this, (AphroState.AphroContent) obj);
