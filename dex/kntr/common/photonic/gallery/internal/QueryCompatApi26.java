...
public final class QueryCompatApi26 implements IQueryCompat {
    ...
    public Object query(ContentResolver cr, Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder, Integer page, Integer pageLimit, Continuation<? super Cursor> continuation) {
        ...
        if (page != null && pageLimit != null) {
            bundle.putInt("android:query-arg-limit", pageLimit.intValue());
            bundle.putInt("android:query-arg-offset", page.intValue() * pageLimit.intValue());
        }
        ...
        continuation2.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: kntr.common.photonic.gallery.internal.QueryCompatApi26$query$5$1
        ...
        continuation3.resumeWith(Result.m2636constructorimpl(cr != null ? cr.query(uri, projection, bundle, cancellationSignal) : null));
