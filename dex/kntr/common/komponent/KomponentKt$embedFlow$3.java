...
@DebugMetadata(c = "kntr.common.komponent.KomponentKt$embedFlow$3", f = "Komponent.kt", i = {0, 0, 1, 1}, l = {60, 63}, m = "invokeSuspend", n = {"$this$transformLatest", "it", "$this$transformLatest", "it"}, s = {"L$0", "L$1", "L$0", "L$1"}, v = 1)
final class KomponentKt$embedFlow$3<S> extends SuspendLambda implements Function3<FlowCollector<? super UiComposableLike<? extends S>>, Komponent<? extends S>, Continuation<? super Unit>, Object> {
    ...
    public KomponentKt$embedFlow$3(KomponentHostScope komponentHostScope, Continuation<? super KomponentKt$embedFlow$3> continuation) {
    ...
    public final Object invoke(FlowCollector<? super UiComposableLike<? extends S>> flowCollector, Komponent<? extends S> komponent, Continuation<? super Unit> continuation) {
        KomponentKt$embedFlow$3 komponentKt$embedFlow$3 = new KomponentKt$embedFlow$3(this.$this_embedFlow, continuation);
        komponentKt$embedFlow$3.L$0 = flowCollector;
        komponentKt$embedFlow$3.L$1 = komponent;
        return komponentKt$embedFlow$3.invokeSuspend(Unit.INSTANCE);
    }
        ...
        switch (this.label) {
            case 0:
                ...
                if (it == null) {
                    ...
                    this.label = 1;
                    if ($this$transformLatest.emit((Object) null, (Continuation) this) == coroutine_suspended) {
    ...
    @DebugMetadata(c = "kntr.common.komponent.KomponentKt$embedFlow$3$1", f = "Komponent.kt", i = {0, 1}, l = {64, 65}, m = "invokeSuspend", n = {"$this$coroutineScope", "$this$coroutineScope"}, s = {"L$0", "L$0"}, v = 1)
    /* renamed from: kntr.common.komponent.KomponentKt$embedFlow$3$1  reason: invalid class name */
