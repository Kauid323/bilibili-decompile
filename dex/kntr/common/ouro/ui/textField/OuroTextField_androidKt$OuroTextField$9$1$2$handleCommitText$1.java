...
@DebugMetadata(c = "kntr.common.ouro.ui.textField.OuroTextField_androidKt$OuroTextField$9$1$2$handleCommitText$1", f = "OuroTextField.android.kt", i = {}, l = {332}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class OuroTextField_androidKt$OuroTextField$9$1$2$handleCommitText$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super OuroState>, Object> {
    ...
    public OuroTextField_androidKt$OuroTextField$9$1$2$handleCommitText$1(OuroStore ouroStore, CharSequence charSequence, State<OuroState> state, Continuation<? super OuroTextField_androidKt$OuroTextField$9$1$2$handleCommitText$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OuroTextField_androidKt$OuroTextField$9$1$2$handleCommitText$1(this.$store, this.$text, this.$ouroState$delegate, continuation);
    }
        ...
        switch (this.label) {
            case 0:
                ...
                if (ouroTextStyleState != null) {
                    this.label = 1;
                    Object dispatchAndWait = ouroStore.dispatchAndWait(new OuroInsertAction(obj, null, null, ouroTextStyleState.getInsertTextStyle().getMarks(), null, true, null, 86, null), (Continuation) this);
