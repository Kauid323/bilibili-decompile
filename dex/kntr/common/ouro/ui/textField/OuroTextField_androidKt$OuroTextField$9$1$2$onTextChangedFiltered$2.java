...
@DebugMetadata(c = "kntr.common.ouro.ui.textField.OuroTextField_androidKt$OuroTextField$9$1$2$onTextChangedFiltered$2", f = "OuroTextField.android.kt", i = {}, l = {218}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class OuroTextField_androidKt$OuroTextField$9$1$2$onTextChangedFiltered$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super OuroState>, Object> {
    ...
    public OuroTextField_androidKt$OuroTextField$9$1$2$onTextChangedFiltered$2(OuroStore ouroStore, String str, State<OuroState> state, Continuation<? super OuroTextField_androidKt$OuroTextField$9$1$2$onTextChangedFiltered$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OuroTextField_androidKt$OuroTextField$9$1$2$onTextChangedFiltered$2(this.$store, this.$insertedText, this.$ouroState$delegate, continuation);
    }
        ...
        switch (this.label) {
            case 0:
                ...
                if (ouroTextStyleState != null) {
                    this.label = 1;
                    Object dispatchAndWait = ouroStore.dispatchAndWait(new OuroInsertAction(str, null, null, ouroTextStyleState.getInsertTextStyle().getMarks(), null, false, null, ConstantsKt.RECOMMEND_RESERVATION_CARD_HEIGHT, null), (Continuation) this);
