...
@DebugMetadata(c = "kntr.common.ouro.ui.textField.OuroTextField_androidKt$OuroTextField$9$1$2$onTextChangedFiltered$3", f = "OuroTextField.android.kt", i = {}, l = {232}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class OuroTextField_androidKt$OuroTextField$9$1$2$onTextChangedFiltered$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super OuroState>, Object> {
    final /* synthetic */ int $before;
    final /* synthetic */ String $insertedText;
    ...
    public OuroTextField_androidKt$OuroTextField$9$1$2$onTextChangedFiltered$3(OuroStore ouroStore, String str, int i, int i2, State<OuroState> state, Continuation<? super OuroTextField_androidKt$OuroTextField$9$1$2$onTextChangedFiltered$3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OuroTextField_androidKt$OuroTextField$9$1$2$onTextChangedFiltered$3(this.$store, this.$insertedText, this.$start, this.$before, this.$ouroState$delegate, continuation);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                String str = this.$insertedText;
                OuroTextRange ouroTextRange = new OuroTextRange(this.$start, this.$start + this.$before);
                ...
                if (ouroTextStyleState != null) {
                    this.label = 1;
                    Object dispatchAndWait = ouroStore.dispatchAndWait(new OuroInsertAction(str, ouroTextRange, null, ouroTextStyleState.getInsertTextStyle().getMarks(), null, false, null, 116, null), (Continuation) this);
