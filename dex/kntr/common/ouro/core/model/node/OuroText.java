...
public final class OuroText extends OuroParagraph {
    ...
    public /* synthetic */ OuroText(int seen0, OuroMarks paragraphMarks, OuroMarks marks, SerializationConstructorMarker serializationConstructorMarker) {
    ...
    public OuroText(OuroMarks<OuroParagraphMark> ouroMarks) {
        super(null);
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$core_debug(OuroText self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public /* synthetic */ OuroText(OuroMarks<OuroParagraphMark> ouroMarks, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    /* compiled from: OuroParagraph.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u000b0\nR\u0017\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b¨\u0006\f"}, d2 = {"Lkntr/common/ouro/core/model/node/OuroText$Companion;", "", "<init>", "()V", "DefaultTextMarks", "Lkntr/common/ouro/core/model/mark/OuroMarks;", "Lkntr/common/ouro/core/model/mark/OuroMark;", "getDefaultTextMarks", "()Lkntr/common/ouro/core/model/mark/OuroMarks;", "serializer", "Lkotlinx/serialization/KSerializer;", "Lkntr/common/ouro/core/model/node/OuroText;", "core_debug"}, k = 1, mv = {2, 2, 0}, xi = ConstantsKt.OGV_UPDATE_CALENDAR_CARD_COVER_WIDTH)
    ...
    public static final class Companion {
        ...
        public final KSerializer<OuroText> serializer() {
            return OuroText$$serializer.INSTANCE;
        }

        public final OuroMarks<OuroMark> getDefaultTextMarks() {
            return OuroText.DefaultTextMarks;
        }
    }

    @Override // kntr.common.ouro.core.model.node.OuroParagraph, kntr.common.ouro.core.model.node.OuroNode.Parent
    public Pair<OuroText, OuroText> tryDivide() {
        return TuplesKt.to(new OuroText(getParagraphMarks()), new OuroText(getParagraphMarks()));
    }

    @Override // kntr.common.ouro.core.model.node.OuroParagraph
    public OuroText copyWithMarks(OuroMarks<OuroParagraphMark> ouroMarks) {
        Intrinsics.checkNotNullParameter(ouroMarks, "paragraphMarks");
        return new OuroText(ouroMarks);
    }
