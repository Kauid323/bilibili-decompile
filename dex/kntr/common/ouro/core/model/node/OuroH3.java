...
public final class OuroH3 extends OuroParagraph {
    ...
    public /* synthetic */ OuroH3(int seen0, OuroMarks paragraphMarks, OuroMarks marks, SerializationConstructorMarker serializationConstructorMarker) {
    ...
    public OuroH3(OuroMarks<OuroParagraphMark> ouroMarks) {
        super(null);
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$core_debug(OuroH3 self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public /* synthetic */ OuroH3(OuroMarks<OuroParagraphMark> ouroMarks, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    /* compiled from: OuroParagraph.kt */
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\bR\u0016\u0010\u0004\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00060\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, d2 = {"Lkntr/common/ouro/core/model/node/OuroH3$Companion;", "", "<init>", "()V", "DefaultTextMarks", "Lkntr/common/ouro/core/model/mark/OuroMarks;", "Lkntr/common/ouro/core/model/mark/OuroMark;", "serializer", "Lkotlinx/serialization/KSerializer;", "Lkntr/common/ouro/core/model/node/OuroH3;", "core_debug"}, k = 1, mv = {2, 2, 0}, xi = ConstantsKt.OGV_UPDATE_CALENDAR_CARD_COVER_WIDTH)
    ...
    public static final class Companion {
        ...
        public final KSerializer<OuroH3> serializer() {
            return OuroH3$$serializer.INSTANCE;
        }
    }

    @Override // kntr.common.ouro.core.model.node.OuroParagraph, kntr.common.ouro.core.model.node.OuroNode.Parent
    public Pair<OuroH3, OuroH3> tryDivide() {
        return TuplesKt.to(new OuroH3(getParagraphMarks()), new OuroH3(getParagraphMarks()));
    }

    @Override // kntr.common.ouro.core.model.node.OuroParagraph
    public OuroH3 copyWithMarks(OuroMarks<OuroParagraphMark> ouroMarks) {
        Intrinsics.checkNotNullParameter(ouroMarks, "paragraphMarks");
        return new OuroH3(ouroMarks);
    }
