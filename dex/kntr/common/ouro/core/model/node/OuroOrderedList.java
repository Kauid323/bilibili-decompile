...
public final class OuroOrderedList implements OuroList {
    ...
    public static final class Companion {
        ...
        public final KSerializer<OuroOrderedList> serializer() {
            return OuroOrderedList$$serializer.INSTANCE;
        }
    }

    public /* synthetic */ OuroOrderedList(int seen0, int startIndex, OuroMarks marks, SerializationConstructorMarker serializationConstructorMarker) {
        if ((seen0 & 1) == 0) {
            this.startIndex = 0;
        } else {
    ...
    public OuroOrderedList(int startIndex, OuroMarks<OuroParagraphMark> ouroMarks) {
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$core_debug(OuroOrderedList self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public /* synthetic */ OuroOrderedList(int i, OuroMarks ouroMarks, int i2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    @Override // kntr.common.ouro.core.model.node.OuroList
    public OuroOrderedList copy() {
        return new OuroOrderedList(getStartIndex(), getMarks());
    }
    ...
    public OuroList getParentList(OuroNodeStorage<?> ouroNodeStorage) {
        Intrinsics.checkNotNullParameter(ouroNodeStorage, "<this>");
        OuroNode.Parent<?> firstAncestorOrNull = ouroNodeStorage.firstAncestorOrNull(this, new Function1() { // from class: kntr.common.ouro.core.model.node.OuroOrderedList$$ExternalSyntheticLambda0
            public final Object invoke(Object obj) {
                boolean _get_parentList_$lambda$0;
                _get_parentList_$lambda$0 = OuroOrderedList._get_parentList_$lambda$0((OuroNode.Parent) obj);
    ...
    public OuroUnorderedList toUnorderedList(OuroNodeMutableStorage<?> ouroNodeMutableStorage, boolean recursive) {
        Iterable listItems;
        Intrinsics.checkNotNullParameter(ouroNodeMutableStorage, "<this>");
        OuroUnorderedList unorderedList = new OuroUnorderedList(getStartIndex(), getMarks());
        if (recursive && (listItems = getListItems(ouroNodeMutableStorage)) != null) {
            Iterable $this$forEach$iv = listItems;
            for (Object element$iv : $this$forEach$iv) {
                OuroListItem item = (OuroListItem) element$iv;
        ...
        if (it2 != null) {
            ouroNodeMutableStorage.add(unorderedList, it2);
        }
        ouroNodeMutableStorage.replace(this, (OuroOrderedList) unorderedList);
    ...
    public int getPrefixStyleLevel(NodeStorage<?> nodeStorage) {
        ...
        OuroOrderedList $this$getPrefixStyleLevel_u24lambda_u240 = this;
        OuroList curr = $this$getPrefixStyleLevel_u24lambda_u240.getParentList(nodeStorage);
        while (curr instanceof OuroOrderedList) {
            realPrefixIndex++;
            OuroOrderedList $this$getPrefixStyleLevel_u24lambda_u240_u240 = (OuroOrderedList) curr;
    ...
    public Pair<OuroNode.Parent<OuroListItem>, OuroNode.Parent<OuroListItem>> tryDivide() {
        return TuplesKt.to(new OuroOrderedList(getStartIndex(), getMarks()), new OuroOrderedList(getStartIndex(), getMarks()));
    }
}