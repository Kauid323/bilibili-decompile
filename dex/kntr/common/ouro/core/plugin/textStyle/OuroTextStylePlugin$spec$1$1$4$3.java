...
@DebugMetadata(c = "kntr.common.ouro.core.plugin.textStyle.OuroTextStylePlugin$spec$1$1$4$3", f = "OuroTextStylePlugin.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class OuroTextStylePlugin$spec$1$1$4$3 extends SuspendLambda implements Function3<OuroToggleUnderlineAction, State<OuroState>, Continuation<? super ChangedState<? extends OuroState>>, Object> {
    /* synthetic */ Object L$0;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    public OuroTextStylePlugin$spec$1$1$4$3(Continuation<? super OuroTextStylePlugin$spec$1$1$4$3> continuation) {
    ...
    public final Object invoke(OuroToggleUnderlineAction ouroToggleUnderlineAction, State<OuroState> state, Continuation<? super ChangedState<OuroState>> continuation) {
        OuroTextStylePlugin$spec$1$1$4$3 ouroTextStylePlugin$spec$1$1$4$3 = new OuroTextStylePlugin$spec$1$1$4$3(continuation);
        ouroTextStylePlugin$spec$1$1$4$3.L$0 = state;
        return ouroTextStylePlugin$spec$1$1$4$3.invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                return state.mutate(new Function1() { // from class: kntr.common.ouro.core.plugin.textStyle.OuroTextStylePlugin$spec$1$1$4$3$$ExternalSyntheticLambda0
                    public final Object invoke(Object obj) {
                        OuroState invokeSuspend$lambda$0;
                        invokeSuspend$lambda$0 = OuroTextStylePlugin$spec$1$1$4$3.invokeSuspend$lambda$0((OuroState) obj);
    ...
    public static final OuroState invokeSuspend$lambda$0(OuroState $this$mutate) {
        ...
        if (ouroTextStyleState != null) {
            ...
            if (currentState.getDisplayPanelStyle().isUnderline()) {
                removeTextMarksByKeys = OuroTextStylePlugin.INSTANCE.removeTextMarksByKeys($this$mutate, CollectionsKt.listOf(OuroUnderlineMark.Key.INSTANCE));
                return removeTextMarksByKeys;
            }
            addMarks = OuroTextStylePlugin.INSTANCE.addMarks($this$mutate, CollectionsKt.listOf(OuroUnderlineMark.INSTANCE));
            return addMarks;
        }
