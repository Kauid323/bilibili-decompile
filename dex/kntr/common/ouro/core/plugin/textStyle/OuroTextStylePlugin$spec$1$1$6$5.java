...
@DebugMetadata(c = "kntr.common.ouro.core.plugin.textStyle.OuroTextStylePlugin$spec$1$1$6$5", f = "OuroTextStylePlugin.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class OuroTextStylePlugin$spec$1$1$6$5 extends SuspendLambda implements Function3<OuroChangeForegroundColor, State<OuroState>, Continuation<? super ChangedState<? extends OuroState>>, Object> {
    /* synthetic */ Object L$0;
    /* synthetic */ Object L$1;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    public OuroTextStylePlugin$spec$1$1$6$5(Continuation<? super OuroTextStylePlugin$spec$1$1$6$5> continuation) {
    ...
    public final Object invoke(OuroChangeForegroundColor ouroChangeForegroundColor, State<OuroState> state, Continuation<? super ChangedState<OuroState>> continuation) {
        OuroTextStylePlugin$spec$1$1$6$5 ouroTextStylePlugin$spec$1$1$6$5 = new OuroTextStylePlugin$spec$1$1$6$5(continuation);
        ouroTextStylePlugin$spec$1$1$6$5.L$0 = ouroChangeForegroundColor;
        ouroTextStylePlugin$spec$1$1$6$5.L$1 = state;
        return ouroTextStylePlugin$spec$1$1$6$5.invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                return state.mutate(new Function1() { // from class: kntr.common.ouro.core.plugin.textStyle.OuroTextStylePlugin$spec$1$1$6$5$$ExternalSyntheticLambda0
                    public final Object invoke(Object obj) {
                        OuroState invokeSuspend$lambda$0;
                        invokeSuspend$lambda$0 = OuroTextStylePlugin$spec$1$1$6$5.invokeSuspend$lambda$0(OuroChangeForegroundColor.this, (OuroState) obj);
    ...
    public static final OuroState invokeSuspend$lambda$0(OuroChangeForegroundColor $action, OuroState $this$mutate) {
        ...
        if (ouroTextStyleState != null) {
            ...
            OuroTextStyleState.Preview newState = new OuroTextStyleState.Preview(currentState.getDisplayPanelStyle().getMarks().plus((OuroMarks<OuroTextMark>) new OuroForegroundColorMark($action.getColor())));
