...
public final class InputDialogKt {
    ...
    public static final void InputDialog(final Function0<Unit> function0, final Function1<? super List<String>, Unit> function1, final String title, final List<String> list, String tips, Composer $composer, final int $changed, final int i) {
        ...
        Composer $composer3 = $composer.startRestartGroup(-689935836);
        ComposerKt.sourceInformation($composer3, "C(InputDialog)N(onDismiss,onConfirm,title,placeholders,tips)24@834L65,53@1928L180,61@2134L98,28@972L15,29@1004L898,26@905L1334:InputDialog.kt#9vm0wh");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (!$composer3.shouldExecute(($dirty2 & 9363) != 9362, $dirty2 & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-689935836, $dirty2, -1, "kntr.common.behavior.prediction.preview.InputDialog (InputDialog.kt:23)");
            }
            ComposerKt.sourceInformationMarkerStart($composer3, -1603368795, "CC(remember):InputDialog.kt#9igjgp");
            ...
            tips2 = tips3;
            $composer2 = $composer3;
            AndroidAlertDialog_androidKt.AlertDialog-Oix01E0(function0, ComposableLambdaKt.rememberComposableLambda(829108444, true, new Function2() { // from class: kntr.common.behavior.prediction.preview.InputDialogKt$$ExternalSyntheticLambda0
            ...
            }, $composer3, 54), (Modifier) null, ComposableLambdaKt.rememberComposableLambda(288678938, true, new Function2() { // from class: kntr.common.behavior.prediction.preview.InputDialogKt$$ExternalSyntheticLambda1
                public final Object invoke(Object obj, Object obj2) {
            ...
            }, $composer3, 54), (Function2) null, ComposableLambdaKt.rememberComposableLambda(-251750568, true, new Function2() { // from class: kntr.common.behavior.prediction.preview.InputDialogKt$$ExternalSyntheticLambda2
                public final Object invoke(Object obj, Object obj2) {
            ...
            }, $composer3, 54), ComposableLambdaKt.rememberComposableLambda(1625518327, true, new Function2() { // from class: kntr.common.behavior.prediction.preview.InputDialogKt$$ExternalSyntheticLambda3
                public final Object invoke(Object obj, Object obj2) {
        ...
        if (endRestartGroup != null) {
            ...
            endRestartGroup.updateScope(new Function2() { // from class: kntr.common.behavior.prediction.preview.InputDialogKt$$ExternalSyntheticLambda4
                public final Object invoke(Object obj, Object obj2) {
    ...
    public static final Unit InputDialog$lambda$3(String $title, Composer $composer, int $changed) {
        ComposerKt.sourceInformation($composer, "C28@974L11:InputDialog.kt#9vm0wh");
        if ($composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-251750568, $changed, -1, "kntr.common.behavior.prediction.preview.InputDialog.<anonymous> (InputDialog.kt:28)");
            }
    ...
    public static final Unit InputDialog$lambda$4(String $tips, List $placeholders, final SnapshotStateList $inputStates, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C30@1018L874:InputDialog.kt#9vm0wh");
        if (!$composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            $composer.skipToGroupEnd();
        } else {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1625518327, $changed, -1, "kntr.common.behavior.prediction.preview.InputDialog.<anonymous> (InputDialog.kt:30)");
            }
            ...
            int i = ((0 >> 6) & 112) | 6;
            ComposerKt.sourceInformationMarkerStart($composer, -605869441, "C:InputDialog.kt#9vm0wh");
            String str = $tips;
            if (!(str == null || StringsKt.isBlank(str))) {
                $composer.startReplaceGroup(-605838690);
                ComposerKt.sourceInformation($composer, "34@1177L9,35@1242L6,32@1092L259");
                ...
                $composer.startReplaceGroup(-606930975);
            }
            $composer.endReplaceGroup();
            $composer.startReplaceGroup(-435175105);
            ComposerKt.sourceInformation($composer, "*43@1570L27,44@1637L21,41@1459L401");
            ...
            for (Object item$iv : $this$forEachIndexed$iv) {
                ...
                ComposerKt.sourceInformationMarkerStart($composer, -231142826, "CC(remember):InputDialog.kt#9igjgp");
                boolean invalid$iv = $composer.changed(index);
                Object it$iv = $composer.rememberedValue();
                if (!invalid$iv && it$iv != Composer.Companion.getEmpty()) {
                    ComposerKt.sourceInformationMarkerEnd($composer);
                    OutlinedTextFieldKt.OutlinedTextField(str2, (Function1) it$iv, modifier, false, false, (TextStyle) null, (Function2) null, ComposableLambdaKt.rememberComposableLambda(1091302402, true, new Function2() { // from class: kntr.common.behavior.prediction.preview.InputDialogKt$$ExternalSyntheticLambda6
                        public final Object invoke(Object obj, Object obj2) {
                ...
                Object value$iv = new Function1() { // from class: kntr.common.behavior.prediction.preview.InputDialogKt$$ExternalSyntheticLambda5
    ...
    public static final Unit InputDialog$lambda$4$0$0$1(String $placeholder, Composer $composer, int $changed) {
        ComposerKt.sourceInformation($composer, "C44@1639L17:InputDialog.kt#9vm0wh");
        if ($composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1091302402, $changed, -1, "kntr.common.behavior.prediction.preview.InputDialog.<anonymous>.<anonymous>.<anonymous>.<anonymous> (InputDialog.kt:44)");
            }
    ...
    public static final Unit InputDialog$lambda$1(final Function1 $onConfirm, final Function0 $onDismiss, final SnapshotStateList $inputStates, Composer $composer, int $changed) {
        ComposerKt.sourceInformation($composer, "C54@1963L91,54@1942L156:InputDialog.kt#9vm0wh");
        if (!$composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            $composer.skipToGroupEnd();
        } else {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(829108444, $changed, -1, "kntr.common.behavior.prediction.preview.InputDialog.<anonymous> (InputDialog.kt:54)");
            }
            ComposerKt.sourceInformationMarkerStart($composer, -2090701161, "CC(remember):InputDialog.kt#9igjgp");
            boolean invalid$iv = $composer.changed($onConfirm) | $composer.changed($onDismiss);
            Object it$iv = $composer.rememberedValue();
            if (invalid$iv || it$iv == Composer.Companion.getEmpty()) {
                Object value$iv = new Function0() { // from class: kntr.common.behavior.prediction.preview.InputDialogKt$$ExternalSyntheticLambda7
            ...
            ComposerKt.sourceInformationMarkerEnd($composer);
            ButtonKt.TextButton((Function0) it$iv, (Modifier) null, false, (Shape) null, (ButtonColors) null, (ButtonElevation) null, (BorderStroke) null, (PaddingValues) null, (MutableInteractionSource) null, ComposableSingletons$InputDialogKt.INSTANCE.m1823getLambda$76038017$preview_debug(), $composer, 805306368, 510);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final Unit InputDialog$lambda$2(Function0 $onDismiss, Composer $composer, int $changed) {
        ComposerKt.sourceInformation($composer, "C62@2148L74:InputDialog.kt#9vm0wh");
        if (!$composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            $composer.skipToGroupEnd();
        } else {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(288678938, $changed, -1, "kntr.common.behavior.prediction.preview.InputDialog.<anonymous> (InputDialog.kt:62)");
            }
            ButtonKt.TextButton($onDismiss, (Modifier) null, false, (Shape) null, (ButtonColors) null, (ButtonElevation) null, (BorderStroke) null, (PaddingValues) null, (MutableInteractionSource) null, ComposableSingletons$InputDialogKt.INSTANCE.m1822getLambda$616467523$preview_debug(), $composer, 805306368, 510);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
