...
@Metadata(d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0016¨\u0006\u0006"}, d2 = {"kntr/common/compose/launcher/ComposeContainer_androidKt$launchKomponentForResult$2$response$1", "Lkntr/base/router/Interceptor;", "intercept", "Lkntr/base/router/Response;", "chain", "Lkntr/base/router/Interceptor$Chain;", "compose-launcher_debug"}, k = 1, mv = {2, 2, 0}, xi = ConstantsKt.OGV_UPDATE_CALENDAR_CARD_COVER_WIDTH)
public final class ComposeContainer_androidKt$launchKomponentForResult$2$response$1 implements Interceptor {
    ...
    public ComposeContainer_androidKt$launchKomponentForResult$2$response$1(CancellableContinuation<? super Result<? extends R>> cancellableContinuation, KSerializer<R> kSerializer) {
    ...
    public Response intercept(final Interceptor.Chain chain) {
        ...
        contextAware.addOnContextAvailableListener(new OnContextAvailableListener() { // from class: kntr.common.compose.launcher.ComposeContainer_androidKt$launchKomponentForResult$2$response$1$intercept$1
            public void onContextAvailable(Context context) {
                Intrinsics.checkNotNullParameter(context, "context");
                ComposeContainer_androidKt$launchKomponentForResult$2$response$1.intercept$startActivity(context, cancellableContinuation, chain, kSerializer);
    ...
    public static final <R> void intercept$startActivity(final Context $this$intercept_u24startActivity, final CancellableContinuation<? super Result<? extends R>> cancellableContinuation, Interceptor.Chain $chain, final KSerializer<R> kSerializer) {
        ...
        Iterator it = SequencesKt.generateSequence($this$intercept_u24startActivity, new Function1<Context, Context>() { // from class: kntr.common.compose.launcher.ComposeContainer_androidKt$launchKomponentForResult$2$response$1$intercept$startActivity$activityResultRegistryOwner$1
        ...
        if (activityResultRegistryOwner2 == null) {
            ...
            Result m2635boximpl = Result.m2635boximpl(Result.m2636constructorimpl(ResultKt.createFailure(new IllegalStateException("No ActivityResultRegistryOwner found."))));
            Result.Companion companion2 = Result.Companion;
            ((Continuation) cancellableContinuation).resumeWith(Result.m2636constructorimpl(m2635boximpl));
            return;
        }
        ...
        final ActivityResultLauncher launcher = activityResultRegistryOwner2.getActivityResultRegistry().register(key, new ActivityResultContract(), new ActivityResultCallback() { // from class: kntr.common.compose.launcher.ComposeContainer_androidKt$launchKomponentForResult$2$response$1$intercept$startActivity$launcher$1
            public final void onActivityResult(ActivityResult it3) {
                ...
                if (string == null) {
                    ...
                    Result m2635boximpl2 = Result.m2635boximpl(Result.m2636constructorimpl(null));
                    Result.Companion companion4 = Result.Companion;
                    cancellableContinuation.resumeWith(Result.m2636constructorimpl(m2635boximpl2));
                    return;
                }
                Context context = $this$intercept_u24startActivity;
                ...
                try {
                    ...
                    result = Result.m2636constructorimpl(Json.Default.decodeFromString(deserializationStrategy, string));
                } catch (Throwable th) {
                    Result.Companion companion6 = Result.Companion;
                    result = Result.m2636constructorimpl(ResultKt.createFailure(th));
                }
                Result.Companion companion7 = Result.Companion;
                cancellableContinuation.resumeWith(Result.m2636constructorimpl(Result.m2635boximpl(result)));
            }
        });
        launcher.launch(intent);
        cancellableContinuation.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: kntr.common.compose.launcher.ComposeContainer_androidKt$launchKomponentForResult$2$response$1$intercept$startActivity$1
