...
public final class ThaiNumberFormat extends NumberFormat {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ThaiNumberFormat) {
            ThaiNumberFormat thaiNumberFormat = (ThaiNumberFormat) obj;
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "ThaiNumberFormat";
    }

    private ThaiNumberFormat() {
        super(null);
    }
    ...
    static {
        ...
        thresholds = CollectionsKt.listOf(new Pair[]{threshold, LegacyNumberFormatKt.toThreshold$default(Units.Millions.INSTANCE, 0L, 1, null)});
        rounding = new Function1() { // from class: kntr.base.localization.preview.ThaiNumberFormat$$ExternalSyntheticLambda4
            public final Object invoke(Object obj) {
                Function1 rounding$lambda$0;
                rounding$lambda$0 = ThaiNumberFormat.rounding$lambda$0(((Long) obj).longValue());
                return rounding$lambda$0;
            }
        };
        suffix = new Function1() { // from class: kntr.base.localization.preview.ThaiNumberFormat$$ExternalSyntheticLambda5
            public final Object invoke(Object obj) {
                Function0 suffix$lambda$0;
                suffix$lambda$0 = ThaiNumberFormat.suffix$lambda$0((Units) obj);
                return suffix$lambda$0;
            }
        };
        carry = new Function1() { // from class: kntr.base.localization.preview.ThaiNumberFormat$$ExternalSyntheticLambda6
            public final Object invoke(Object obj) {
                Function3 carry$lambda$0;
                carry$lambda$0 = ThaiNumberFormat.carry$lambda$0((Units) obj);
    ...
    public static final Function1 rounding$lambda$0(long it) {
        return it < 1000000 ? ThaiNumberFormat$rounding$1$1.INSTANCE : ThaiNumberFormat$rounding$1$2.INSTANCE;
    }
    ...
    public static final Function0 suffix$lambda$0(Units it) {
        ...
        return Intrinsics.areEqual(it, Units.Thousands.INSTANCE) ? new Function0() { // from class: kntr.base.localization.preview.ThaiNumberFormat$$ExternalSyntheticLambda1
            public final Object invoke() {
                String suffix$lambda$0$0;
                suffix$lambda$0$0 = ThaiNumberFormat.suffix$lambda$0$0();
                return suffix$lambda$0$0;
            }
        } : Intrinsics.areEqual(it, Units.Millions.INSTANCE) ? new Function0() { // from class: kntr.base.localization.preview.ThaiNumberFormat$$ExternalSyntheticLambda2
            public final Object invoke() {
                String suffix$lambda$0$1;
                suffix$lambda$0$1 = ThaiNumberFormat.suffix$lambda$0$1();
                return suffix$lambda$0$1;
            }
        } : new Function0() { // from class: kntr.base.localization.preview.ThaiNumberFormat$$ExternalSyntheticLambda3
            public final Object invoke() {
                String suffix$lambda$0$2;
                suffix$lambda$0$2 = ThaiNumberFormat.suffix$lambda$0$2();
    ...
    public static final Function3 carry$lambda$0(Units it) {
        ...
        if ((it instanceof Units.Thousands ? it : null) != null) {
            return new Function3() { // from class: kntr.base.localization.preview.ThaiNumberFormat$$ExternalSyntheticLambda0
                public final Object invoke(Object obj, Object obj2, Object obj3) {
                    String carry$lambda$0$1$0;
                    carry$lambda$0$1$0 = ThaiNumberFormat.carry$lambda$0$1$0(((Long) obj).longValue(), ((Integer) obj2).intValue(), ((Boolean) obj3).booleanValue());
