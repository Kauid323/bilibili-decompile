...
public final class ArabicNumberFormat extends NumberFormat {
    public static final ArabicNumberFormat INSTANCE = new ArabicNumberFormat();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ArabicNumberFormat) {
            ArabicNumberFormat arabicNumberFormat = (ArabicNumberFormat) obj;
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "ArabicNumberFormat";
    }

    private ArabicNumberFormat() {
        super(null);
    }
    ...
    static {
        ...
        rounding = new Function1() { // from class: kntr.base.localization.preview.ArabicNumberFormat$$ExternalSyntheticLambda4
            public final Object invoke(Object obj) {
                Function1 rounding$lambda$0;
                rounding$lambda$0 = ArabicNumberFormat.rounding$lambda$0(((Long) obj).longValue());
                return rounding$lambda$0;
            }
        };
        suffix = new Function1() { // from class: kntr.base.localization.preview.ArabicNumberFormat$$ExternalSyntheticLambda5
            public final Object invoke(Object obj) {
                Function0 suffix$lambda$0;
                suffix$lambda$0 = ArabicNumberFormat.suffix$lambda$0((Units) obj);
                return suffix$lambda$0;
            }
        };
        carry = new Function1() { // from class: kntr.base.localization.preview.ArabicNumberFormat$$ExternalSyntheticLambda6
            public final Object invoke(Object obj) {
                Function3 carry$lambda$0;
                carry$lambda$0 = ArabicNumberFormat.carry$lambda$0((Units) obj);
    ...
    public static final Function1 rounding$lambda$0(long it) {
        return it < 1000000 ? ArabicNumberFormat$rounding$1$1.INSTANCE : ArabicNumberFormat$rounding$1$2.INSTANCE;
    }
    ...
    public static final Function0 suffix$lambda$0(Units it) {
        ...
        return Intrinsics.areEqual(it, Units.Thousands.INSTANCE) ? new Function0() { // from class: kntr.base.localization.preview.ArabicNumberFormat$$ExternalSyntheticLambda0
            public final Object invoke() {
                String suffix$lambda$0$0;
                suffix$lambda$0$0 = ArabicNumberFormat.suffix$lambda$0$0();
                return suffix$lambda$0$0;
            }
        } : Intrinsics.areEqual(it, Units.Millions.INSTANCE) ? new Function0() { // from class: kntr.base.localization.preview.ArabicNumberFormat$$ExternalSyntheticLambda1
            public final Object invoke() {
                String suffix$lambda$0$1;
                suffix$lambda$0$1 = ArabicNumberFormat.suffix$lambda$0$1();
                return suffix$lambda$0$1;
            }
        } : Intrinsics.areEqual(it, Units.Billions.INSTANCE) ? new Function0() { // from class: kntr.base.localization.preview.ArabicNumberFormat$$ExternalSyntheticLambda2
            public final Object invoke() {
                String suffix$lambda$0$2;
                suffix$lambda$0$2 = ArabicNumberFormat.suffix$lambda$0$2();
                return suffix$lambda$0$2;
            }
        } : new Function0() { // from class: kntr.base.localization.preview.ArabicNumberFormat$$ExternalSyntheticLambda3
            public final Object invoke() {
                String suffix$lambda$0$3;
                suffix$lambda$0$3 = ArabicNumberFormat.suffix$lambda$0$3();
    ...
    public static final Function3 carry$lambda$0(Units it) {
        ...
        if ((it instanceof Units.Thousands ? it : null) != null) {
            return new Function3() { // from class: kntr.base.localization.preview.ArabicNumberFormat$$ExternalSyntheticLambda7
                public final Object invoke(Object obj, Object obj2, Object obj3) {
                    String carry$lambda$0$1$0;
                    carry$lambda$0$1$0 = ArabicNumberFormat.carry$lambda$0$1$0(((Long) obj).longValue(), ((Integer) obj2).intValue(), ((Boolean) obj3).booleanValue());
