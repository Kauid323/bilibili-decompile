...
@DebugMetadata(c = "kntr.app.tribee.publish.draft.TribeeDraftServiceImpl$saveDraft$2", f = "TribeeDraftServiceImpl.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
            ...
            case 0:
                ...
                try {
                    ...
                    if (this.$content == null) {
                        ...
                        stringFormat = this.this$0.json;
                        StringFormat $this$encodeToString$iv = stringFormat;
                        Object value$iv = this.$content;
                        $this$encodeToString$iv.getSerializersModule();
                        String draftContent = $this$encodeToString$iv.encodeToString(TribeeDraftContent.Companion.serializer(), value$iv);
                        Sink sink = (AutoCloseable) CoreKt.buffered(FileSystemJvmKt.SystemFileSystem.sink(path, false));
                        Sink sink2 = sink;
                        Utf8Kt.writeString$default(sink2, draftContent, 0, 0, 6, (Object) null);
