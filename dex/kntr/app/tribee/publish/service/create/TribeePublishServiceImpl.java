...
import kntr.app.tribee.publish.di.create.TribeePublishResultKey;
...
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B/\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\b\u0001\u0010\u0004\u001a\u00020\u0005\u0012\b\b\u0001\u0010\u0006\u001a\u00020\u0005\u0012\b\b\u0001\u0010\u0007\u001a\u00020\u0005¢\u0006\u0004\b\b\u0010\tJ\u001e\u0010\n\u001a\b\u0012\u0004\u0012\u00020\f0\u000b2\u0006\u0010\r\u001a\u00020\u000eH\u0096@¢\u0006\u0004\b\u000f\u0010\u0010R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0011"}, d2 = {"Lkntr/app/tribee/publish/service/create/TribeePublishServiceImpl;", "Lkntr/app/tribee/publish/service/TribeePublishService;", "converter", "Lkntr/app/tribee/publish/service/TribeeContentConverter;", "resultKey", "", "fromSpmid", "from", "<init>", "(Lkntr/app/tribee/publish/service/TribeeContentConverter;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "publish", "Lkotlin/Result;", "Lkntr/app/tribee/publish/service/PublishResult;", "content", "Lkntr/app/tribee/publish/TribeePublishContent;", "publish-gIAlu-s", "(Lkntr/app/tribee/publish/TribeePublishContent;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "core_debug"}, k = 1, mv = {2, 2, 0}, xi = ConstantsKt.OGV_UPDATE_CALENDAR_CARD_COVER_WIDTH)
@TribeePublishScope
public final class TribeePublishServiceImpl implements TribeePublishService {
    ...
    @Inject
    public TribeePublishServiceImpl(TribeeContentConverter converter, @TribeePublishResultKey String resultKey, @TribeePublishFromSpmid String fromSpmid, @TribeePublishCreateFrom String from) {
    ...
    @Override // kntr.app.tribee.publish.service.TribeePublishService
    /* renamed from: publish-gIAlu-s */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public Object mo927publishgIAlus(TribeePublishContent content, Continuation<? super Result<PublishResult>> continuation) {
        TribeePublishServiceImpl$publish$1 tribeePublishServiceImpl$publish$1;
        String str;
        String str2;
        ...
        KCreateOpusReq req;
        TribeePublishServiceImpl $this$publish_gIAlu_s_u24lambda_u240;
        Object createOpus;
        TribeePublishContent content4;
        int i;
        TribeePublishServiceImpl $this$publish_gIAlu_s_u24lambda_u2402;
        KCreateResp result;
        KTribeeDyn it2;
        Object suspendGetString;
        KCreateResp result2;
        if (continuation instanceof TribeePublishServiceImpl$publish$1) {
            tribeePublishServiceImpl$publish$1 = (TribeePublishServiceImpl$publish$1) continuation;
            if ((tribeePublishServiceImpl$publish$1.label & Integer.MIN_VALUE) != 0) {
                tribeePublishServiceImpl$publish$1.label -= Integer.MIN_VALUE;
                Object $result = tribeePublishServiceImpl$publish$1.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                switch (tribeePublishServiceImpl$publish$1.label) {
                    case 0:
                        ...
                        TribeeContentConverter tribeeContentConverter = this.converter;
                        tribeePublishServiceImpl$publish$1.L$0 = content;
                        tribeePublishServiceImpl$publish$1.L$1 = moss2;
                        tribeePublishServiceImpl$publish$1.L$2 = kCreateScene;
                        tribeePublishServiceImpl$publish$1.label = 1;
                        convert = tribeeContentConverter.convert(content, false, tribeePublishServiceImpl$publish$1);
                        ...
                        try {
                            ...
                            tribeePublishServiceImpl$publish$1.L$0 = content3;
                            tribeePublishServiceImpl$publish$1.L$1 = SpillingKt.nullOutSpilledVariable(moss);
                            tribeePublishServiceImpl$publish$1.L$2 = SpillingKt.nullOutSpilledVariable(req);
                            tribeePublishServiceImpl$publish$1.L$3 = $this$publish_gIAlu_s_u24lambda_u240;
                            tribeePublishServiceImpl$publish$1.I$0 = 0;
                            tribeePublishServiceImpl$publish$1.label = 2;
                            createOpus = moss.createOpus(req, tribeePublishServiceImpl$publish$1);
                        } catch (Throwable th) {
                            th = th;
                            str = " to ";
                        ...
                        try {
                            ...
                            tribeePublishServiceImpl$publish$1.L$0 = content4;
                            tribeePublishServiceImpl$publish$1.L$1 = SpillingKt.nullOutSpilledVariable(moss);
                            tribeePublishServiceImpl$publish$1.L$2 = SpillingKt.nullOutSpilledVariable(req);
                            tribeePublishServiceImpl$publish$1.L$3 = SpillingKt.nullOutSpilledVariable($this$publish_gIAlu_s_u24lambda_u2402);
                            tribeePublishServiceImpl$publish$1.L$4 = result;
                            tribeePublishServiceImpl$publish$1.I$0 = i;
                            tribeePublishServiceImpl$publish$1.label = 3;
                            suspendGetString = followingRes.suspendGetString(following_global_string_365, tribeePublishServiceImpl$publish$1);
                        } catch (Throwable th3) {
                            th = th3;
                            str = " to ";
                            str2 = "TribeePublishServiceImpl";
                        ...
                        it = Result.m2639exceptionOrNullimpl(m2636constructorimpl);
                        if (it != null) {
                            JobKt.ensureActive(tribeePublishServiceImpl$publish$1.getContext());
                            KLog_androidKt.getKLog().e(str4, "Publish failed, title " + content2.getTitle() + str3 + content2.getTribeeInfo(), it);
                        }
                        return m2636constructorimpl;
                    case 1:
                        TribeePublishContent content5 = (TribeePublishContent) tribeePublishServiceImpl$publish$1.L$0;
                        ResultKt.throwOnFailure($result);
                        convert = $result;
                        moss = (KFeedMoss) tribeePublishServiceImpl$publish$1.L$1;
                        kCreateScene = (KCreateScene.CREATE_SCENE_CREATE_TRIBEE) tribeePublishServiceImpl$publish$1.L$2;
                        content3 = content5;
                        req = new KCreateOpusReq(new KUserCreateMeta(new KMetaDataCtrl((String) null, (String) null, (String) null, (String) null, (String) null, this.fromSpmid, this.from, (String) null, 0, 0, (String) null, 0, (String) null, 8095, (DefaultConstructorMarker) null), (KLbsLoc) null, 0, 6, (DefaultConstructorMarker) null), (KOpus) convert, kCreateScene, new KCreateOption(0, 0, 0, 0, 0, (KVideoShareInfo) null, (KCreateActivity) null, 0, 0L, 0, 0, 0L, 0L, 0L, 0, (KLiveWaterMark) null, content3.getSendToFollowing(), content3.getAigc(), 65535, (DefaultConstructorMarker) null), (KCreateTopic) null, (KCreateBaseDraft) null, (String) null, (KDynIdentity) null, content3.getTribeeArg(), 240, (DefaultConstructorMarker) null);
                        ...
                        break;
                    case 2:
                        i = tribeePublishServiceImpl$publish$1.I$0;
                        $this$publish_gIAlu_s_u24lambda_u2402 = (TribeePublishServiceImpl) tribeePublishServiceImpl$publish$1.L$3;
                        req = (KCreateOpusReq) tribeePublishServiceImpl$publish$1.L$2;
                        moss = (KFeedMoss) tribeePublishServiceImpl$publish$1.L$1;
                        TribeePublishContent content6 = (TribeePublishContent) tribeePublishServiceImpl$publish$1.L$0;
                        ResultKt.throwOnFailure($result);
                        content4 = content6;
                        createOpus = $result;
                        result = (KCreateResp) createOpus;
                        ...
                        tribeePublishServiceImpl$publish$1.I$0 = i;
                        tribeePublishServiceImpl$publish$1.label = 3;
                        suspendGetString = followingRes2.suspendGetString(following_global_string_3652, tribeePublishServiceImpl$publish$1);
                        if (suspendGetString != coroutine_suspended) {
                        }
                        break;
                    case 3:
                        int i2 = tribeePublishServiceImpl$publish$1.I$0;
                        result2 = (KCreateResp) tribeePublishServiceImpl$publish$1.L$4;
                        TribeePublishServiceImpl tribeePublishServiceImpl = (TribeePublishServiceImpl) tribeePublishServiceImpl$publish$1.L$3;
                        KCreateOpusReq kCreateOpusReq = (KCreateOpusReq) tribeePublishServiceImpl$publish$1.L$2;
                        KFeedMoss kFeedMoss = (KFeedMoss) tribeePublishServiceImpl$publish$1.L$1;
                        content2 = (TribeePublishContent) tribeePublishServiceImpl$publish$1.L$0;
                        ResultKt.throwOnFailure($result);
        ...
        tribeePublishServiceImpl$publish$1 = new TribeePublishServiceImpl$publish$1(this, continuation);
        Object $result2 = tribeePublishServiceImpl$publish$1.result;
