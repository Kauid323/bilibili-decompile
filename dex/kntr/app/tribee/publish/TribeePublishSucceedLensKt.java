...
import kntr.app.tribee.publish.TribeePublishSucceed;
...
public final class TribeePublishSucceedLensKt {
    ...
    public static final BSimpleLens<TribeePublishSucceed, TribeePublishSucceed> getLens(TribeePublishSucceed.Companion $this$lens) {
        ...
        return new BSimpleLens<TribeePublishSucceed, TribeePublishSucceed>() { // from class: kntr.app.tribee.publish.TribeePublishSucceedLensKt$special$$inlined$invoke$1
    ...
    public static final BSimpleLens<TribeePublishSucceed, TribeePublishContent> getContent(TribeePublishSucceed.Companion $this$content) {
        ...
        BSimpleLens.Companion companion = BSimpleLens.Companion;
        return new BSimpleLens<TribeePublishSucceed, TribeePublishContent>() { // from class: kntr.app.tribee.publish.TribeePublishSucceedLensKt$special$$inlined$invoke$2
