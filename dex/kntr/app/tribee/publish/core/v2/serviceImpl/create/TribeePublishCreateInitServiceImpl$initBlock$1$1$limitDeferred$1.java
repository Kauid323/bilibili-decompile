...
@DebugMetadata(c = "kntr.app.tribee.publish.core.v2.serviceImpl.create.TribeePublishCreateInitServiceImpl$initBlock$1$1$limitDeferred$1", f = "TribeePublishCreateInitServiceImpl.kt", i = {0, 0, 0}, l = {53}, m = "invokeSuspend", n = {"$this$async", "$this$invokeSuspend_u24lambda_u240", "$i$a$-runCatching-TribeePublishCreateInitServiceImpl$initBlock$1$1$limitDeferred$1$1"}, s = {"L$0", "L$1", "I$0"}, v = 1)
final class TribeePublishCreateInitServiceImpl$initBlock$1$1$limitDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends KCreateCheckTribeeResp>>, Object> {
    int I$0;
    ...
    public TribeePublishCreateInitServiceImpl$initBlock$1$1$limitDeferred$1(TribeePublishCreateInitServiceImpl tribeePublishCreateInitServiceImpl, Continuation<? super TribeePublishCreateInitServiceImpl$initBlock$1$1$limitDeferred$1> continuation) {
        super(2, continuation);
        this.this$0 = tribeePublishCreateInitServiceImpl;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> tribeePublishCreateInitServiceImpl$initBlock$1$1$limitDeferred$1 = new TribeePublishCreateInitServiceImpl$initBlock$1$1$limitDeferred$1(this.this$0, continuation);
        tribeePublishCreateInitServiceImpl$initBlock$1$1$limitDeferred$1.L$0 = obj;
        return tribeePublishCreateInitServiceImpl$initBlock$1$1$limitDeferred$1;
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        try {
            switch (this.label) {
                case 0:
                    ...
                    TribeePublishCreateInitServiceImpl tribeePublishCreateInitServiceImpl = this.this$0;
                    Result.Companion companion = Result.Companion;
                    ILogger kLog = KLog_androidKt.getKLog();
                    tribeeInfo3 = tribeePublishCreateInitServiceImpl.tribeeInfo;
                    ...
                    tribeeInfo4 = tribeePublishCreateInitServiceImpl.tribeeInfo;
        ...
        TribeePublishCreateInitServiceImpl tribeePublishCreateInitServiceImpl2 = this.this$0;
        ...
        if (it != null) {
            ...
            tribeeInfo2 = tribeePublishCreateInitServiceImpl2.tribeeInfo;
            kLog2.e("TribeeInitCreateServiceImpl", "Failed to load initCheck for " + tribeeInfo2, it);
        }
        TribeePublishCreateInitServiceImpl tribeePublishCreateInitServiceImpl3 = this.this$0;
        if (Result.m2643isSuccessimpl(m2636constructorimpl)) {
            ILogger kLog3 = KLog_androidKt.getKLog();
            tribeeInfo = tribeePublishCreateInitServiceImpl3.tribeeInfo;
