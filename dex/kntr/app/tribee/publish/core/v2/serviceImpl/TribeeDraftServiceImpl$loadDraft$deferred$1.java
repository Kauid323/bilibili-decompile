...
@Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u0004\u0018\u00010\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "Lkntr/app/tribee/publish/core/v2/service/TribeeDraftContent;", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 2, 0}, xi = ConstantsKt.OGV_UPDATE_CALENDAR_CARD_COVER_WIDTH)
@DebugMetadata(c = "kntr.app.tribee.publish.core.v2.serviceImpl.TribeeDraftServiceImpl$loadDraft$deferred$1", f = "TribeeDraftServiceImpl.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
        ...
        switch (this.label) {
            case 0:
                ...
                try {
                    ...
                    byte[] content = SourcesKt.readByteArray(source2);
                    ...
                    Object decodeFromByteArray = $this$decodeFromByteArray$iv.decodeFromByteArray(TribeeDraftContent.Companion.serializer(), content);
                    TribeeDraftContent tribeeDraftContent = (TribeeDraftContent) decodeFromByteArray;
                    KLog_androidKt.getKLog().i("TribeeDraft", "Load draft in " + tribeeInfo + " with string count " + content.length);
                    TribeeDraftContent it = (TribeeDraftContent) decodeFromByteArray;
                    TribeeDraftContent tribeeDraftContent2 = new TribeeDraftContent(it.getTribeeInfo(), it.getOpusContent(), it.getDocument(), it.getSendToFollowing(), it.getSelectedCategoryId());
