...
public final class TribeeInfoLensKt {
    ...
    public static final BSimpleLens<TribeeInfo, TribeeInfo> getLens(TribeeInfo.Companion $this$lens) {
        ...
        return new BSimpleLens<TribeeInfo, TribeeInfo>() { // from class: kntr.app.tribee.publish.core.v2.model.TribeeInfoLensKt$special$$inlined$invoke$1
    ...
    public static final BSimpleLens<TribeeInfo, Long> getTribeeId(TribeeInfo.Companion $this$tribeeId) {
        ...
        BSimpleLens.Companion companion = BSimpleLens.Companion;
        return new BSimpleLens<TribeeInfo, Long>() { // from class: kntr.app.tribee.publish.core.v2.model.TribeeInfoLensKt$special$$inlined$invoke$2
    ...
    public static final BSimpleLens<TribeeInfo, String> getTitle(TribeeInfo.Companion $this$title) {
        ...
        BSimpleLens.Companion companion = BSimpleLens.Companion;
        return new BSimpleLens<TribeeInfo, String>() { // from class: kntr.app.tribee.publish.core.v2.model.TribeeInfoLensKt$special$$inlined$invoke$3
