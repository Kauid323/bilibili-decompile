...
public final class TribeePublishEditContentLensKt {
    ...
    public static final BSimpleLens<TribeePublishEditContent, TribeePublishEditContent> getLens(TribeePublishEditContent.Companion $this$lens) {
        ...
        return new BSimpleLens<TribeePublishEditContent, TribeePublishEditContent>() { // from class: kntr.app.tribee.publish.core.v2.model.TribeePublishEditContentLensKt$special$$inlined$invoke$1
    ...
    public static final BSimpleLens<TribeePublishEditContent, TribeeInfo> getTribeeInfo(TribeePublishEditContent.Companion $this$tribeeInfo) {
        ...
        BSimpleLens.Companion companion = BSimpleLens.Companion;
        return new BSimpleLens<TribeePublishEditContent, TribeeInfo>() { // from class: kntr.app.tribee.publish.core.v2.model.TribeePublishEditContentLensKt$special$$inlined$invoke$2
    ...
    public static final BSimpleLens<TribeePublishEditContent, String> getContentId(TribeePublishEditContent.Companion $this$contentId) {
        ...
        BSimpleLens.Companion companion = BSimpleLens.Companion;
        return new BSimpleLens<TribeePublishEditContent, String>() { // from class: kntr.app.tribee.publish.core.v2.model.TribeePublishEditContentLensKt$special$$inlined$invoke$3
