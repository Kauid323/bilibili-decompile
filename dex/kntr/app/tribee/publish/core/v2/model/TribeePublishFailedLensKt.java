...
public final class TribeePublishFailedLensKt {
    ...
    public static final BSimpleLens<TribeePublishFailed, TribeePublishFailed> getLens(TribeePublishFailed.Companion $this$lens) {
        ...
        return new BSimpleLens<TribeePublishFailed, TribeePublishFailed>() { // from class: kntr.app.tribee.publish.core.v2.model.TribeePublishFailedLensKt$special$$inlined$invoke$1
    ...
    public static final BSimpleLens<TribeePublishFailed, TribeePublishContent> getContent(TribeePublishFailed.Companion $this$content) {
        ...
        BSimpleLens.Companion companion = BSimpleLens.Companion;
        return new BSimpleLens<TribeePublishFailed, TribeePublishContent>() { // from class: kntr.app.tribee.publish.core.v2.model.TribeePublishFailedLensKt$special$$inlined$invoke$2
    ...
    public static final BSimpleLens<TribeePublishFailed, Throwable> getError(TribeePublishFailed.Companion $this$error) {
        ...
        BSimpleLens.Companion companion = BSimpleLens.Companion;
        return new BSimpleLens<TribeePublishFailed, Throwable>() { // from class: kntr.app.tribee.publish.core.v2.model.TribeePublishFailedLensKt$special$$inlined$invoke$3
