...
@Metadata(d1 = {"\u00006\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001aU\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u00052&\u0010\u0007\u001a\"\b\u0001\u0012\u0004\u0012\u00020\t\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00010\n\u0012\u0006\u0012\u0004\u0018\u00010\u000b0\bj\u0002`\f2\b\b\u0002\u0010\r\u001a\u00020\u000eH\u0001¢\u0006\u0002\u0010\u000f¨\u0006\u0010"}, d2 = {"TribeeCategories", "", "tribeeInfo", "Lkntr/app/tribee/publish/core/v2/model/TribeeInfo;", "categories", "", "Lcom/bapis/bilibili/dynamic/common/KTribeeCategory;", "onAction", "Lkotlin/Function2;", "Lkntr/app/tribee/publish/core/v2/TribeePublishAction;", "Lkotlin/coroutines/Continuation;", "", "Lkntr/app/tribee/publish/ui/v2/TribeeActionHandler;", "modifier", "Landroidx/compose/ui/Modifier;", "(Lkntr/app/tribee/publish/core/v2/model/TribeeInfo;Ljava/util/List;Lkotlin/jvm/functions/Function2;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V", "ui_debug"}, k = 2, mv = {2, 2, 0}, xi = ConstantsKt.OGV_UPDATE_CALENDAR_CARD_COVER_WIDTH)
public final class TribeeCategoriesKt {
    ...
    */
    public static final void TribeeCategories(final TribeeInfo tribeeInfo, final List<KTribeeCategory> list, final Function2<? super TribeePublishAction, ? super Continuation<? super Unit>, ? extends Object> function2, Modifier modifier, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        Modifier modifier3;
        ...
        Composer $composer2 = $composer.startRestartGroup(-1652772554);
        ComposerKt.sourceInformation($composer2, "C(TribeeCategories)N(tribeeInfo,categories,onAction,modifier)39@1628L3915:TribeeCategories.kt#vjrpu9");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if ($composer2.shouldExecute(($dirty2 & 1171) != 1170, $dirty2 & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1652772554, $dirty2, -1, "kntr.app.tribee.publish.ui.v2.internal.TribeeCategories (TribeeCategories.kt:38)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1827668747, "C45@1820L56,46@1908L9,47@1953L6,44@1795L181,50@1998L24,52@2032L3505:TribeeCategories.kt#vjrpu9");
            TextKt.Text-Nvy7gAk(StringResourcesKt.stringResource(String0_commonMainKt.getTribee_global_string_45(TribeeRes.INSTANCE.getString()), $composer2, 0), (Modifier) null, BiliTheme.INSTANCE.getColors($composer2, BiliTheme.$stable).getText2-0d7_KjU(), (TextAutoSize) null, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1) null, BiliTheme.INSTANCE.getTextStyle($composer2, BiliTheme.$stable).getT12(), $composer2, 0, 0, 131066);
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1618244879, "C64@2430L2294,58@2179L2545,125@5220L6,126@5311L6,127@5391L6,114@4737L790:TribeeCategories.kt#vjrpu9");
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 467850422, "CC(remember):TribeeCategories.kt#9igjgp");
            ...
            Object value$iv = new Function1() { // from class: kntr.app.tribee.publish.ui.v2.internal.TribeeCategoriesKt$$ExternalSyntheticLambda0
                public final Object invoke(Object obj) {
                    Unit TribeeCategories$lambda$0$0$0$0;
                    TribeeCategories$lambda$0$0$0$0 = TribeeCategoriesKt.TribeeCategories$lambda$0$0$0$0(list, scope, function2, tribeeInfo, (LazyListScope) obj);
        ...
        if (endRestartGroup != null) {
            ...
            endRestartGroup.updateScope(new Function2() { // from class: kntr.app.tribee.publish.ui.v2.internal.TribeeCategoriesKt$$ExternalSyntheticLambda1
                public final Object invoke(Object obj, Object obj2) {
                    Unit TribeeCategories$lambda$1;
                    TribeeCategories$lambda$1 = TribeeCategoriesKt.TribeeCategories$lambda$1(TribeeInfo.this, list, function2, modifier5, $changed, i, (Composer) obj, ((Integer) obj2).intValue());
    ...
    public static final Unit TribeeCategories$lambda$0$0$0$0(final List $categories, final CoroutineScope $scope, final Function2 $onAction, final TribeeInfo $tribeeInfo, LazyListScope $this$LazyRow) {
        ...
        LazyListScope.-CC.items$default($this$LazyRow, $categories.size(), (Function1) null, (Function1) null, ComposableLambdaKt.composableLambdaInstance(1249491572, true, new Function4() { // from class: kntr.app.tribee.publish.ui.v2.internal.TribeeCategoriesKt$$ExternalSyntheticLambda3
            public final Object invoke(Object obj, Object obj2, Object obj3, Object obj4) {
                Unit TribeeCategories$lambda$0$0$0$0$0;
                TribeeCategories$lambda$0$0$0$0$0 = TribeeCategoriesKt.TribeeCategories$lambda$0$0$0$0$0($categories, $scope, $onAction, $tribeeInfo, (LazyItemScope) obj, ((Integer) obj2).intValue(), (Composer) obj3, ((Integer) obj4).intValue());
    ...
    */
    public static final Unit TribeeCategories$lambda$0$0$0$0$0(List $categories, final CoroutineScope $scope, final Function2 $onAction, final TribeeInfo $tribeeInfo, LazyItemScope $this$items, int index, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "CN(index)68@2577L411,68@2556L432,85@3287L6,79@3010L1682:TribeeCategories.kt#vjrpu9");
        int $dirty = $changed;
        if (($changed & 48) == 0) {
        ...
        if ($composer.shouldExecute(($dirty2 & 145) != 144, $dirty2 & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1249491572, $dirty2, -1, "kntr.app.tribee.publish.ui.v2.internal.TribeeCategories.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous> (TribeeCategories.kt:66)");
            }
            KTribeeCategory category2 = (KTribeeCategory) $categories.get(index);
            Unit unit2 = Unit.INSTANCE;
            ComposerKt.sourceInformationMarkerStart($composer, -1829438385, "CC(remember):TribeeCategories.kt#9igjgp");
            ...
            if (invalid$iv || value$iv == Composer.Companion.getEmpty()) {
                str = "CC(remember):TribeeCategories.kt#9igjgp";
                unit = unit2;
                category = category2;
                value$iv = new TribeeCategoriesKt$TribeeCategories$1$1$1$1$1$1$1($scope, $onAction, $tribeeInfo, category2, null);
            ...
            int i2 = ((384 >> 6) & 112) | 6;
            ComposerKt.sourceInformationMarkerStart($composer, -638907438, "C92@3619L9,93@3680L6,97@3886L757,90@3517L1153:TribeeCategories.kt#vjrpu9");
            ...
            ComposerKt.sourceInformationMarkerStart($composer, -1683166491, str);
            ...
            Object value$iv2 = new Function0() { // from class: kntr.app.tribee.publish.ui.v2.internal.TribeeCategoriesKt$$ExternalSyntheticLambda2
                public final Object invoke() {
                    Unit TribeeCategories$lambda$0$0$0$0$0$1$0$0;
                    TribeeCategories$lambda$0$0$0$0$0$1$0$0 = TribeeCategoriesKt.TribeeCategories$lambda$0$0$0$0$0$1$0$0($scope, $onAction, category3, $tribeeInfo);
    ...
    public static final Unit TribeeCategories$lambda$0$0$0$0$0$1$0$0(CoroutineScope $scope, Function2 $onAction, KTribeeCategory $category, TribeeInfo $tribeeInfo) {
        BuildersKt.launch$default($scope, (CoroutineContext) null, (CoroutineStart) null, new TribeeCategoriesKt$TribeeCategories$1$1$1$1$1$2$1$1$1($onAction, $category, $tribeeInfo, null), 3, (Object) null);
        return Unit.INSTANCE;
    }
}