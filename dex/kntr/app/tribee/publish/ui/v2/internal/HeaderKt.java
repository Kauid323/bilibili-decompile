...
@Metadata(d1 = {"\u00002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001aU\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00010\u00052&\u0010\u0006\u001a\"\b\u0001\u0012\u0004\u0012\u00020\b\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00010\t\u0012\u0006\u0012\u0004\u0018\u00010\n0\u0007j\u0002`\u000b2\b\b\u0002\u0010\f\u001a\u00020\rH\u0001¢\u0006\u0002\u0010\u000e¨\u0006\u000f"}, d2 = {"Header", "", "contentValid", "", "onClose", "Lkotlin/Function0;", "onAction", "Lkotlin/Function2;", "Lkntr/app/tribee/publish/core/v2/TribeePublishAction;", "Lkotlin/coroutines/Continuation;", "", "Lkntr/app/tribee/publish/ui/v2/TribeeActionHandler;", "modifier", "Landroidx/compose/ui/Modifier;", "(ZLkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function2;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V", "ui_debug"}, k = 2, mv = {2, 2, 0}, xi = ConstantsKt.OGV_UPDATE_CALENDAR_CARD_COVER_WIDTH)
public final class HeaderKt {
    ...
    */
    public static final void Header(final boolean contentValid, final Function0<Unit> function0, final Function2<? super TribeePublishAction, ? super Continuation<? super Unit>, ? extends Object> function2, Modifier modifier, Composer $composer, final int $changed, final int i) {
        ...
        Composer $composer4 = $composer.startRestartGroup(1620817843);
        ComposerKt.sourceInformation($composer4, "C(Header)N(contentValid,onClose,onAction,modifier)35@1490L2160:Header.kt#vjrpu9");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if ($composer4.shouldExecute(($dirty2 & 1171) != 1170, $dirty2 & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1620817843, $dirty2, -1, "kntr.app.tribee.publish.ui.v2.internal.Header (Header.kt:34)");
            }
            ...
            int i4 = ((432 >> 6) & 112) | 6;
            ComposerKt.sourceInformationMarkerStart($composer4, 860176813, "C41@1766L20,42@1852L13,43@1896L6,40@1725L240,47@1987L24,48@2043L54,49@2131L56,51@2221L48,55@2404L6,57@2545L583,70@3205L9,72@3266L6,50@2196L1448:Header.kt#vjrpu9");
            ...
            ComposerKt.sourceInformationMarkerStart($composer4, -1080628860, "CC(remember):Header.kt#9igjgp");
            boolean invalid$iv = ($dirty2 & 112) == 32;
            Object it$iv = $composer4.rememberedValue();
            if (invalid$iv) {
            }
            Object value$iv = new Function0() { // from class: kntr.app.tribee.publish.ui.v2.internal.HeaderKt$$ExternalSyntheticLambda0
            ...
            ComposerKt.sourceInformationMarkerStart($composer4, -1080606114, "CC(remember):Header.kt#9igjgp");
            $composer2 = $composer4;
            ...
            if (invalid$iv2 || value$iv2 == Composer.Companion.getEmpty()) {
                ...
                z = false;
                value$iv2 = new Function0() { // from class: kntr.app.tribee.publish.ui.v2.internal.HeaderKt$$ExternalSyntheticLambda1
                    public final Object invoke() {
            ...
            if (contentValid) {
                $composer5.startReplaceGroup(861755724);
                $composer5.endReplaceGroup();
                z = true;
            } else {
                $composer5.startReplaceGroup(-1080578685);
                ComposerKt.sourceInformation($composer5, "76@3429L13");
        ...
        if (endRestartGroup != null) {
            ...
            endRestartGroup.updateScope(new Function2() { // from class: kntr.app.tribee.publish.ui.v2.internal.HeaderKt$$ExternalSyntheticLambda2
