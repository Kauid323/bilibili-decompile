...
@DebugMetadata(c = "kntr.app.tribee.publish.ui.v2.TribeePublishEditPageKt$PreviewTribeePublishEdit$1$1", f = "TribeePublishEditPage.kt", i = {0, 0, 0}, l = {130}, m = "invokeSuspend", n = {"$this$LaunchedEffect", "$this$invokeSuspend_u24lambda_u240", "$i$a$-runCatching-TribeePublishEditPageKt$PreviewTribeePublishEdit$1$1$1"}, s = {"L$0", "L$3", "I$0"}, v = 1)
public final class TribeePublishEditPageKt$PreviewTribeePublishEdit$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public TribeePublishEditPageKt$PreviewTribeePublishEdit$1$1(String str, MutableState<TribeeEditContent> mutableState, OnBackPressedDispatcher onBackPressedDispatcher, Continuation<? super TribeePublishEditPageKt$PreviewTribeePublishEdit$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> tribeePublishEditPageKt$PreviewTribeePublishEdit$1$1 = new TribeePublishEditPageKt$PreviewTribeePublishEdit$1$1(this.$id, this.$initState$delegate, this.$backHandler, continuation);
        tribeePublishEditPageKt$PreviewTribeePublishEdit$1$1.L$0 = obj;
        return tribeePublishEditPageKt$PreviewTribeePublishEdit$1$1;
    }
