...
@DebugMetadata(c = "kntr.app.tribee.publish.internal.HeaderKt$Header$1$2$1$1", f = "Header.kt", i = {}, l = {61, 63}, m = "invokeSuspend", n = {}, s = {}, v = 1)
        ...
        switch (this.label) {
            case 0:
                ...
                if (this.$contentValid) {
                    ...
                    TribeePublishAction.TrackerAction.PublishButtonClick publishButtonClick = new TribeePublishAction.TrackerAction.PublishButtonClick("tribee");
                    this.label = 1;
