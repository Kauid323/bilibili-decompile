...
public final class TribeePublishClosingLensKt {
    ...
    public static final BSimpleLens<TribeePublishClosing, TribeePublishClosing> getLens(TribeePublishClosing.Companion $this$lens) {
        ...
        return new BSimpleLens<TribeePublishClosing, TribeePublishClosing>() { // from class: kntr.app.tribee.publish.TribeePublishClosingLensKt$special$$inlined$invoke$1
    ...
    public static final BSimpleLens<TribeePublishClosing, String> getToast(TribeePublishClosing.Companion $this$toast) {
        ...
        BSimpleLens.Companion companion = BSimpleLens.Companion;
        return new BSimpleLens<TribeePublishClosing, String>() { // from class: kntr.app.tribee.publish.TribeePublishClosingLensKt$special$$inlined$invoke$2
