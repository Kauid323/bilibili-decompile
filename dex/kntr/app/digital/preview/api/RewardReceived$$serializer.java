...
public final /* synthetic */ class RewardReceived$$serializer implements GeneratedSerializer<RewardReceived> {
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("reward_received", INSTANCE, 2);
    ...
    private RewardReceived$$serializer() {
    }
    ...
    public final RewardReceived deserialize(Decoder decoder) {
        String str;
        ...
        return new RewardReceived(i, str, rewardData, null);
    }

    public final void serialize(Encoder encoder, RewardReceived value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        RewardReceived.write$Self$preview_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
