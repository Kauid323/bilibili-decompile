...
@Serializable
public final class RewardEnd implements ActionItem {
    public static final int $stable = 0;
    public static final Companion Companion = new Companion(null);
    private final RewardData data;
    private final String title;

    public static /* synthetic */ RewardEnd copy$default(RewardEnd rewardEnd, String str, RewardData rewardData, int i, Object obj) {
        if ((i & 1) != 0) {
            str = rewardEnd.title;
        }
        if ((i & 2) != 0) {
            rewardData = rewardEnd.data;
        }
        return rewardEnd.copy(str, rewardData);
    }
    ...
    public final RewardEnd copy(String str, RewardData rewardData) {
        Intrinsics.checkNotNullParameter(str, "title");
        Intrinsics.checkNotNullParameter(rewardData, "data");
        return new RewardEnd(str, rewardData);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RewardEnd) {
            RewardEnd rewardEnd = (RewardEnd) obj;
            return Intrinsics.areEqual(this.title, rewardEnd.title) && Intrinsics.areEqual(this.data, rewardEnd.data);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "RewardEnd(title=" + str + ", data=" + this.data + ")";
    }

    /* compiled from: CardPreviewModel.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lkntr/app/digital/preview/api/RewardEnd$Companion;", RoomRecommendViewModel.EMPTY_CURSOR, "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lkntr/app/digital/preview/api/RewardEnd;", "preview_debug"}, k = 1, mv = {2, 2, 0}, xi = 48)
    ...
    public static final class Companion {
        ...
        public final KSerializer<RewardEnd> serializer() {
            return RewardEnd$$serializer.INSTANCE;
        }
    }

    public /* synthetic */ RewardEnd(int seen0, String title, RewardData data, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (seen0 & 3)) {
            PluginExceptionsKt.throwMissingFieldException(seen0, 3, RewardEnd$$serializer.INSTANCE.getDescriptor());
        }
        this.title = title;
        this.data = data;
    }

    public RewardEnd(String title, RewardData data) {
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$preview_debug(RewardEnd self, CompositeEncoder output, SerialDescriptor serialDesc) {
