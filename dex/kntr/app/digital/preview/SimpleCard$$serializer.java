...
public final /* synthetic */ class SimpleCard$$serializer implements GeneratedSerializer<SimpleCard> {
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.digital.preview.SimpleCard", INSTANCE, 5);
        pluginGeneratedSerialDescriptor.addElement("image", false);
        pluginGeneratedSerialDescriptor.addElement("name", false);
        pluginGeneratedSerialDescriptor.addElement("badge", false);
        pluginGeneratedSerialDescriptor.addElement("frameUrl", false);
        pluginGeneratedSerialDescriptor.addElement("hasMask", false);
        descriptor = pluginGeneratedSerialDescriptor;
        $stable = 8;
    }

    private SimpleCard$$serializer() {
    }

    public final KSerializer<?>[] childSerializers() {
        return new KSerializer[]{StringSerializer.INSTANCE, StringSerializer.INSTANCE, StringSerializer.INSTANCE, StringSerializer.INSTANCE, BooleanSerializer.INSTANCE};
    }

    public final SimpleCard deserialize(Decoder decoder) {
        String str;
        String str2;
        boolean z;
        String str3;
        ...
        return new SimpleCard(i, str, str4, str3, str2, z, null);
    }

    public final void serialize(Encoder encoder, SimpleCard value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        SimpleCard.write$Self$preview_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
