...
@DebugMetadata(c = "kntr.app.digital.preview.wallpaper.SetHomeWallpaper$invoke$2", f = "SetHomeWallpaper.kt", i = {1, 1, 1}, l = {37, 62}, m = "invokeSuspend", n = {"imageSource", "bitmap", "result"}, s = {"L$0", "L$1", "L$2"}, v = 1)
public final class SetHomeWallpaper$invoke$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public SetHomeWallpaper$invoke$2(String str, Job job, SetHomeWallpaper setHomeWallpaper, Continuation<? super SetHomeWallpaper$invoke$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SetHomeWallpaper$invoke$2(this.$wallpaperUrl, this.$loadingDialogJob, this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Object result = WallpaperSetting_androidKt.getSetWallpaper().m1056invokegIAlus(bitmap, false);
