...
public final class SetHomeWallpaper {
    ...
    @Inject
    public SetHomeWallpaper(Toaster toaster, DismissRequest dismissRequest, WallpaperDownloadingDialogService wallpaperDownloadingDialogService, WallpaperUnavailableDialogService wallpaperUnavailableDialogService, @BusinessCoroutineScope CoroutineScope coroutineScope) {
    ...
    public final void invoke(String wallpaperUrl) {
        ...
        if (!WallpaperSettingsABSwitch.INSTANCE.wallpaperEnabledSwitch()) {
            BuildersKt.launch$default(this.coroutineScope, (CoroutineContext) null, (CoroutineStart) null, new SetHomeWallpaper$invoke$1(this, null), 3, (Object) null);
            return;
        }
        Job loadingDialogJob = BuildersKt.launch$default(this.coroutineScope, (CoroutineContext) null, (CoroutineStart) null, new SetHomeWallpaper$invoke$loadingDialogJob$1(this, null), 3, (Object) null);
        BuildersKt.launch$default(this.coroutineScope, (CoroutineContext) null, (CoroutineStart) null, new SetHomeWallpaper$invoke$2(wallpaperUrl, loadingDialogJob, this, null), 3, (Object) null);
    }
}