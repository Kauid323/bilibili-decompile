...
@DebugMetadata(c = "kntr.app.game.steam.SteamGamePageKt$SteamGamePageContent$2$1", f = "SteamGamePage.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class SteamGamePageKt$SteamGamePageContent$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public SteamGamePageKt$SteamGamePageContent$2$1(PvEventTrigger pvEventTrigger, String str, String str2, String str3, String str4, Continuation<? super SteamGamePageKt$SteamGamePageContent$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SteamGamePageKt$SteamGamePageContent$2$1(this.$pvTrigger, this.$spmid, this.$sourceFrom, this.$spmidFrom, this.$appId, continuation);
    }
