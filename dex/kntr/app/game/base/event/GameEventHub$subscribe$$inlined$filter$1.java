...
public final class GameEventHub$subscribe$$inlined$filter$1 implements Flow<Event> {
    ...
    public static final class AnonymousClass2<T> implements FlowCollector {
        ...
        @DebugMetadata(c = "kntr.app.game.base.event.GameEventHub$subscribe$$inlined$filter$1$2", f = "GameEventHub.kt", i = {0, 0, 0, 0, 0}, l = {219}, m = "emit", n = {"value", "$completion", "value", "$this$filter_u24lambda_u240", "$i$a$-unsafeTransform-FlowKt__TransformKt$filter$1"}, s = {"L$0", "L$1", "L$2", "L$3", "I$0"}, v = 1)
        /* renamed from: kntr.app.game.base.event.GameEventHub$subscribe$$inlined$filter$1$2$1  reason: invalid class name */
        /* loaded from: /data/np/file-convert/202602280713022b24dde5-650f-44d6-87eb-e24b0df191b5/202602280713022b24dde5-650f-44d6-87eb-e24b0df191b5.dex */
    ...
    public GameEventHub$subscribe$$inlined$filter$1(Flow flow) {
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        InlineMarker.mark(4);
        new ContinuationImpl($completion) { // from class: kntr.app.game.base.event.GameEventHub$subscribe$$inlined$filter$1.1
            int label;
            /* synthetic */ Object result;
            ...
            public final Object invokeSuspend(Object obj) {
                this.result = obj;
                this.label |= Integer.MIN_VALUE;
                return GameEventHub$subscribe$$inlined$filter$1.this.collect(null, (Continuation) this);
            }
        };
        InlineMarker.mark(5);
        Flow flow = this.$this_unsafeTransform$inlined;
