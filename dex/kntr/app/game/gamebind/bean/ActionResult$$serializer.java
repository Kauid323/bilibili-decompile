...
public final /* synthetic */ class ActionResult$$serializer implements GeneratedSerializer<ActionResult> {
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.game.gamebind.bean.ActionResult", INSTANCE, 1);
