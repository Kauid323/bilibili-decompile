...
public final class DlcOwnership {
    ...
    public static /* synthetic */ DlcOwnership copy$default(DlcOwnership dlcOwnership, int i, int i2, String str, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = dlcOwnership.ownedCount;
        }
        if ((i3 & 2) != 0) {
            i2 = dlcOwnership.totalCount;
        }
        if ((i3 & 4) != 0) {
            str = dlcOwnership.totalValueYuan;
        }
        return dlcOwnership.copy(i, i2, str);
    }
    ...
    public final DlcOwnership copy(int i, int i2, String str) {
        Intrinsics.checkNotNullParameter(str, "totalValueYuan");
        return new DlcOwnership(i, i2, str);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DlcOwnership) {
            DlcOwnership dlcOwnership = (DlcOwnership) obj;
            return this.ownedCount == dlcOwnership.ownedCount && this.totalCount == dlcOwnership.totalCount && Intrinsics.areEqual(this.totalValueYuan, dlcOwnership.totalValueYuan);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "DlcOwnership(ownedCount=" + i + ", totalCount=" + i2 + ", totalValueYuan=" + this.totalValueYuan + ")";
    }

    /* compiled from: SteamGameBean.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lkntr/app/game/bean/DlcOwnership$Companion;", RoomRecommendViewModel.EMPTY_CURSOR, "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lkntr/app/game/bean/DlcOwnership;", "gamebiz_debug"}, k = 1, mv = {2, 2, 0}, xi = 48)
    ...
    public static final class Companion {
        ...
        public final KSerializer<DlcOwnership> serializer() {
            return DlcOwnership$$serializer.INSTANCE;
        }
    }

    public /* synthetic */ DlcOwnership(int seen0, int ownedCount, int totalCount, String totalValueYuan, SerializationConstructorMarker serializationConstructorMarker) {
        if ((seen0 & 1) == 0) {
            this.ownedCount = 0;
        } else {
    ...
    public DlcOwnership(int ownedCount, int totalCount, String totalValueYuan) {
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$gamebiz_debug(DlcOwnership self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public /* synthetic */ DlcOwnership(int i, int i2, String str, int i3, DefaultConstructorMarker defaultConstructorMarker) {
