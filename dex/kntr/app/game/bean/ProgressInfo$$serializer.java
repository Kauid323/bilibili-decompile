...
public final /* synthetic */ class ProgressInfo$$serializer implements GeneratedSerializer<ProgressInfo> {
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.game.bean.ProgressInfo", INSTANCE, 3);
        pluginGeneratedSerialDescriptor.addElement("completed_count", true);
    ...
    private ProgressInfo$$serializer() {
    }
    ...
    public final ProgressInfo deserialize(Decoder decoder) {
        int i;
        String str;
        int i2;
        int i3;
        ...
        return new ProgressInfo(i3, i, i2, str, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, ProgressInfo value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        ProgressInfo.write$Self$gamebiz_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
