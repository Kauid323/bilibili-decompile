...
@DebugMetadata(c = "kntr.app.deepsearch.stub.PageStub_androidKt$PushHistoryPageStub$1$1", f = "PageStub.android.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class PageStub_androidKt$PushHistoryPageStub$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Activity $current;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PageStub_androidKt$PushHistoryPageStub$1$1(Activity activity, Continuation<? super PageStub_androidKt$PushHistoryPageStub$1$1> continuation) {
        super(2, continuation);
        this.$current = activity;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new PageStub_androidKt$PushHistoryPageStub$1$1(this.$current, continuation);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                $this$getAndUpdate$iv = PageStub_androidKt.historyPageStub;
                Activity activity = this.$current;
                do {
                    prevValue$iv = $this$getAndUpdate$iv.getValue();
                    PageStub pageStub = (PageStub) prevValue$iv;
                    nextValue$iv = new PageStub(new WeakReference(activity), RoomRecommendViewModel.EMPTY_CURSOR);
