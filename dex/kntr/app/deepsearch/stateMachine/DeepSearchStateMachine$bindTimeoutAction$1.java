...
@DebugMetadata(c = "kntr.app.deepsearch.stateMachine.DeepSearchStateMachine$bindTimeoutAction$1", f = "DeepSearchStateMachine.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class DeepSearchStateMachine$bindTimeoutAction$1 extends SuspendLambda implements Function3<DeepSearchTimeout, State<DeepSearchPageData>, Continuation<? super ChangedState<? extends DeepSearchPageData>>, Object> {
    ...
    public DeepSearchStateMachine$bindTimeoutAction$1(DeepSearchStateMachine deepSearchStateMachine, Continuation<? super DeepSearchStateMachine$bindTimeoutAction$1> continuation) {
    ...
    public final Object invoke(DeepSearchTimeout deepSearchTimeout, State<DeepSearchPageData> state, Continuation<? super ChangedState<DeepSearchPageData>> continuation) {
        DeepSearchStateMachine$bindTimeoutAction$1 deepSearchStateMachine$bindTimeoutAction$1 = new DeepSearchStateMachine$bindTimeoutAction$1(this.this$0, continuation);
        deepSearchStateMachine$bindTimeoutAction$1.L$0 = state;
        return deepSearchStateMachine$bindTimeoutAction$1.invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                deepSearchTimeoutService.cancelTimeout();
                final DeepSearchStateMachine deepSearchStateMachine = this.this$0;
                return state.mutate(new Function1() { // from class: kntr.app.deepsearch.stateMachine.DeepSearchStateMachine$bindTimeoutAction$1$$ExternalSyntheticLambda0
                    public final Object invoke(Object obj) {
                        DeepSearchPageData invokeSuspend$lambda$0;
                        invokeSuspend$lambda$0 = DeepSearchStateMachine$bindTimeoutAction$1.invokeSuspend$lambda$0(DeepSearchStateMachine.this, (DeepSearchPageData) obj);
    ...
    public static final DeepSearchPageData invokeSuspend$lambda$0(DeepSearchStateMachine this$0, DeepSearchPageData $this$mutate) {
        ...
        final List tempList = DeepSearchBroadcastHandlerKt.handleBroadcastFail($this$mutate, deepSearchDataProcessService);
        if (tempList.isEmpty()) {
            return $this$mutate;
        }
        return (DeepSearchPageData) CopyScopeKt.copy($this$mutate, new Function1() { // from class: kntr.app.deepsearch.stateMachine.DeepSearchStateMachine$bindTimeoutAction$1$$ExternalSyntheticLambda1
            public final Object invoke(Object obj) {
                Unit invokeSuspend$lambda$0$0;
                invokeSuspend$lambda$0$0 = DeepSearchStateMachine$bindTimeoutAction$1.invokeSuspend$lambda$0$0(tempList, (CopyScope) obj);
