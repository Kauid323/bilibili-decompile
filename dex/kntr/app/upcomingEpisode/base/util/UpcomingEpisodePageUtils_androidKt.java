...
/* compiled from: UpcomingEpisodePageUtils.android.kt */
@Metadata(d1 = {"\u0000 \n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\u001a$\u0010\u0000\u001a\u00020\u00012\u0011\u0010\u0002\u001a\r\u0012\u0004\u0012\u00020\u00010\u0003¢\u0006\u0002\b\u0004H\u0087\bø\u0001\u0000¢\u0006\u0002\u0010\u0005\u001a\u0016\u0010\u0006\u001a\u00020\u00012\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n\u0082\u0002\u0007\n\u0005\b\u009920\u0001¨\u0006\u000b"}, d2 = {"ConfigWindow", "", "block", "Lkotlin/Function0;", "Landroidx/compose/runtime/Composable;", "(Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;I)V", "setSupportImmersiveStatusBar", "window", "Landroid/view/Window;", "isNight", "", "main_debug"}, k = 2, mv = {2, 2, 0}, xi = ConstantsKt.OGV_UPDATE_CALENDAR_CARD_COVER_WIDTH)
public final class UpcomingEpisodePageUtils_androidKt {
    public static final void ConfigWindow(Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformationMarkerStart($composer, 2136225621, "CC(ConfigWindow)N(block)20@732L7:UpcomingEpisodePageUtils.android.kt#59pppy");
        ...
        if (Build.VERSION.SDK_INT < 30 && activity != null) {
            $composer.startReplaceGroup(1767232165);
            ComposerKt.sourceInformation($composer, "22@856L13,23@925L251,23@901L275");
            ...
            ComposerKt.sourceInformationMarkerStart($composer, -81536656, "CC(remember):UpcomingEpisodePageUtils.android.kt#9igjgp");
            boolean invalid$iv = $composer.changedInstance(activity) | $composer.changed(isNight);
            Object it$iv = $composer.rememberedValue();
            if (invalid$iv || it$iv == Composer.Companion.getEmpty()) {
                Object value$iv = (Function2) new UpcomingEpisodePageUtils_androidKt$ConfigWindow$1$1(activity, isNight, null);
            ...
            $composer.startReplaceGroup(1767584790);
            ComposerKt.sourceInformation($composer, "29@1198L7");
