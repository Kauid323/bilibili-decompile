...
public final class MonthCalendarLayoutInfo implements LazyListLayoutInfo {
    ...
    public long m1223getViewportSizeYbymL2g() {
    ...
    public MonthCalendarLayoutInfo(LazyListLayoutInfo info, Function1<? super Integer, Month> function1) {
        Intrinsics.checkNotNullParameter(info, "info");
        Intrinsics.checkNotNullParameter(function1, "month");
        this.$$delegate_0 = info;
        this.month = function1;
    }

    public final List<CalendarItemInfo> getVisibleMonthsInfo() {
        Iterable $this$map$iv = getVisibleItemsInfo();
        Collection destination$iv$iv = new ArrayList(CollectionsKt.collectionSizeOrDefault($this$map$iv, 10));
        for (Object item$iv$iv : $this$map$iv) {
            LazyListItemInfo it = (LazyListItemInfo) item$iv$iv;
            destination$iv$iv.add(new CalendarItemInfo(it, (Month) this.month.invoke(Integer.valueOf(it.getIndex()))));
        }
