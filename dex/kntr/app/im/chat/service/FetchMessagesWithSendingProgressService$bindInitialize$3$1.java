...
@DebugMetadata(c = "kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindInitialize$3$1", f = "FetchMessagesWithSendingProgressService.kt", i = {0, 1, 1, 1}, l = {154, 158}, m = "invokeSuspend", n = {"state", "state", "it", "$i$a$-fold-FetchMessagesWithSendingProgressService$bindInitialize$3$1$1"}, s = {"L$0", "L$0", "L$1", "I$0"}, v = 1)
public final class FetchMessagesWithSendingProgressService$bindInitialize$3$1 extends SuspendLambda implements Function2<State<FetchMessagesData>, Continuation<? super ChangedState<? extends FetchMessagesData>>, Object> {
    int I$0;
    ...
    public FetchMessagesWithSendingProgressService$bindInitialize$3$1(FetchMessagesWithSendingProgressService fetchMessagesWithSendingProgressService, Continuation<? super FetchMessagesWithSendingProgressService$bindInitialize$3$1> continuation) {
        super(2, continuation);
        this.this$0 = fetchMessagesWithSendingProgressService;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> fetchMessagesWithSendingProgressService$bindInitialize$3$1 = new FetchMessagesWithSendingProgressService$bindInitialize$3$1(this.this$0, continuation);
        fetchMessagesWithSendingProgressService$bindInitialize$3$1.L$0 = obj;
        return fetchMessagesWithSendingProgressService$bindInitialize$3$1;
    }
        ...
        switch (this.label) {
            case 0:
                ...
                if (it != null) {
                    ...
                    this.I$0 = 0;
                    this.label = 2;
                    Object handleFetchMessagesResult$default = FetchMessagesWithSendingProgressService.handleFetchMessagesResult$default(fetchMessagesWithSendingProgressService, state, it2, true, null, this, 8, null);
                ...
                return state.mutate(new Function1() { // from class: kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindInitialize$3$1$$ExternalSyntheticLambda0
                    public final Object invoke(Object obj2) {
                        FetchMessagesData invokeSuspend$lambda$1$0;
                        invokeSuspend$lambda$1$0 = FetchMessagesWithSendingProgressService$bindInitialize$3$1.invokeSuspend$lambda$1$0(it, (FetchMessagesData) obj2);
