...
@DebugMetadata(c = "kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindPagination$1", f = "FetchMessagesWithSendingProgressService.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class FetchMessagesWithSendingProgressService$bindPagination$1 extends SuspendLambda implements Function3<FetchMessagesAction.LoadLater, State<FetchMessagesData>, Continuation<? super ChangedState<? extends FetchMessagesData>>, Object> {
    /* synthetic */ Object L$0;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    public FetchMessagesWithSendingProgressService$bindPagination$1(Continuation<? super FetchMessagesWithSendingProgressService$bindPagination$1> continuation) {
    ...
    public final Object invoke(FetchMessagesAction.LoadLater loadLater, State<FetchMessagesData> state, Continuation<? super ChangedState<FetchMessagesData>> continuation) {
        FetchMessagesWithSendingProgressService$bindPagination$1 fetchMessagesWithSendingProgressService$bindPagination$1 = new FetchMessagesWithSendingProgressService$bindPagination$1(continuation);
        fetchMessagesWithSendingProgressService$bindPagination$1.L$0 = state;
        return fetchMessagesWithSendingProgressService$bindPagination$1.invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                return state.mutate(new Function1() { // from class: kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindPagination$1$$ExternalSyntheticLambda0
                    public final Object invoke(Object obj) {
                        FetchMessagesData invokeSuspend$lambda$0;
                        invokeSuspend$lambda$0 = FetchMessagesWithSendingProgressService$bindPagination$1.invokeSuspend$lambda$0((FetchMessagesData) obj);
