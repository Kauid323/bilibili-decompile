...
@DebugMetadata(c = "kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindUpdate$3$1", f = "FetchMessagesWithSendingProgressService.kt", i = {0, 0, 1, 1, 1, 1}, l = {360, 363}, m = "invokeSuspend", n = {"state", "consumed", "state", "consumed", "result", "$i$a$-fold-FetchMessagesWithSendingProgressService$bindUpdate$3$1$1"}, s = {"L$0", "L$1", "L$0", "L$1", "L$2", "I$0"}, v = 1)
public final class FetchMessagesWithSendingProgressService$bindUpdate$3$1 extends SuspendLambda implements Function2<State<FetchMessagesData>, Continuation<? super ChangedState<? extends FetchMessagesData>>, Object> {
    int I$0;
    ...
    public FetchMessagesWithSendingProgressService$bindUpdate$3$1(FetchMessagesWithSendingProgressService fetchMessagesWithSendingProgressService, Continuation<? super FetchMessagesWithSendingProgressService$bindUpdate$3$1> continuation) {
        super(2, continuation);
        this.this$0 = fetchMessagesWithSendingProgressService;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> fetchMessagesWithSendingProgressService$bindUpdate$3$1 = new FetchMessagesWithSendingProgressService$bindUpdate$3$1(this.this$0, continuation);
        fetchMessagesWithSendingProgressService$bindUpdate$3$1.L$0 = obj;
        return fetchMessagesWithSendingProgressService$bindUpdate$3$1;
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                return state.mutate(new Function1() { // from class: kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindUpdate$3$1$$ExternalSyntheticLambda0
                    public final Object invoke(Object obj) {
                        FetchMessagesData invokeSuspend$lambda$2;
                        invokeSuspend$lambda$2 = FetchMessagesWithSendingProgressService$bindUpdate$3$1.invokeSuspend$lambda$2(consumed, (FetchMessagesData) obj);
