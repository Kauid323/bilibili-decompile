...
@DebugMetadata(c = "kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindInitialize$1", f = "FetchMessagesWithSendingProgressService.kt", i = {0, 1, 1}, l = {128, 132}, m = "invokeSuspend", n = {"state", "state", "previousRange"}, s = {"L$0", "L$0", "L$1"}, v = 1)
public final class FetchMessagesWithSendingProgressService$bindInitialize$1 extends SuspendLambda implements Function2<State<FetchMessagesData>, Continuation<? super ChangedState<? extends FetchMessagesData>>, Object> {
    ...
    public FetchMessagesWithSendingProgressService$bindInitialize$1(FetchMessagesWithSendingProgressService fetchMessagesWithSendingProgressService, Continuation<? super FetchMessagesWithSendingProgressService$bindInitialize$1> continuation) {
        super(2, continuation);
        this.this$0 = fetchMessagesWithSendingProgressService;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> fetchMessagesWithSendingProgressService$bindInitialize$1 = new FetchMessagesWithSendingProgressService$bindInitialize$1(this.this$0, continuation);
        fetchMessagesWithSendingProgressService$bindInitialize$1.L$0 = obj;
        return fetchMessagesWithSendingProgressService$bindInitialize$1;
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            ...
            case 2:
                ...
                return state.mutate(new Function1() { // from class: kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindInitialize$1$$ExternalSyntheticLambda0
                    public final Object invoke(Object obj) {
                        FetchMessagesData invokeSuspend$lambda$0;
                        invokeSuspend$lambda$0 = FetchMessagesWithSendingProgressService$bindInitialize$1.invokeSuspend$lambda$0(currentRange, (FetchMessagesData) obj);
        ...
        if (previousRange2 == null) {
            ...
            return state.mutate(new Function1() { // from class: kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindInitialize$1$$ExternalSyntheticLambda0
                public final Object invoke(Object obj) {
                    FetchMessagesData invokeSuspend$lambda$0;
                    invokeSuspend$lambda$0 = FetchMessagesWithSendingProgressService$bindInitialize$1.invokeSuspend$lambda$0(currentRange2, (FetchMessagesData) obj);
                    return invokeSuspend$lambda$0;
                }
            });
        }
        ...
        return state.mutate(new Function1() { // from class: kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindInitialize$1$$ExternalSyntheticLambda0
            public final Object invoke(Object obj) {
                FetchMessagesData invokeSuspend$lambda$0;
                invokeSuspend$lambda$0 = FetchMessagesWithSendingProgressService$bindInitialize$1.invokeSuspend$lambda$0(currentRange22, (FetchMessagesData) obj);
                return invokeSuspend$lambda$0;
            }
        });
    }
