...
@DebugMetadata(c = "kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindDatabase$4$2", f = "FetchMessagesWithSendingProgressService.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class FetchMessagesWithSendingProgressService$bindDatabase$4$2 extends SuspendLambda implements Function3<List<? extends EntityMessage>, State<FetchMessagesData>, Continuation<? super ChangedState<? extends FetchMessagesData>>, Object> {
    ...
    public FetchMessagesWithSendingProgressService$bindDatabase$4$2(FetchMessagesWithSendingProgressService fetchMessagesWithSendingProgressService, Continuation<? super FetchMessagesWithSendingProgressService$bindDatabase$4$2> continuation) {
    ...
    public final Object invoke(List<EntityMessage> list, State<FetchMessagesData> state, Continuation<? super ChangedState<FetchMessagesData>> continuation) {
        FetchMessagesWithSendingProgressService$bindDatabase$4$2 fetchMessagesWithSendingProgressService$bindDatabase$4$2 = new FetchMessagesWithSendingProgressService$bindDatabase$4$2(this.this$0, continuation);
        fetchMessagesWithSendingProgressService$bindDatabase$4$2.L$0 = list;
        fetchMessagesWithSendingProgressService$bindDatabase$4$2.L$1 = state;
        return fetchMessagesWithSendingProgressService$bindDatabase$4$2.invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                IMLog.Companion.d("ChatFetchService", new Function0() { // from class: kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindDatabase$4$2$$ExternalSyntheticLambda0
                    public final Object invoke() {
                        String invokeSuspend$lambda$0;
                        invokeSuspend$lambda$0 = FetchMessagesWithSendingProgressService$bindDatabase$4$2.invokeSuspend$lambda$0(state, messages);
                ...
                for (Object element$iv$iv2 : $this$filter$iv2) {
                    ...
                    instant = fetchMessagesWithSendingProgressService.updateBaseTime;
                ...
                IMLog.Companion.d("ChatFetchService", new Function0() { // from class: kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindDatabase$4$2$$ExternalSyntheticLambda1
                    public final Object invoke() {
                        String invokeSuspend$lambda$4;
                        invokeSuspend$lambda$4 = FetchMessagesWithSendingProgressService$bindDatabase$4$2.invokeSuspend$lambda$4(msgListForUpdate);
                        return invokeSuspend$lambda$4;
                    }
                });
                final FetchMessagesWithSendingProgressService fetchMessagesWithSendingProgressService2 = this.this$0;
                return state.mutate(new Function1() { // from class: kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindDatabase$4$2$$ExternalSyntheticLambda2
                    public final Object invoke(Object obj) {
                        FetchMessagesData invokeSuspend$lambda$5;
                        invokeSuspend$lambda$5 = FetchMessagesWithSendingProgressService$bindDatabase$4$2.invokeSuspend$lambda$5(displayMessages, fetchMessagesWithSendingProgressService2, msgListForUpdate, (FetchMessagesData) obj);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final FetchMessagesData invokeSuspend$lambda$5(final List $displayMessages, final FetchMessagesWithSendingProgressService this$0, final List $msgListForUpdate, FetchMessagesData $this$mutate) {
        return (FetchMessagesData) CopyScopeKt.copy($this$mutate, new Function1() { // from class: kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindDatabase$4$2$$ExternalSyntheticLambda3
            public final Object invoke(Object obj) {
                Unit invokeSuspend$lambda$5$0;
                invokeSuspend$lambda$5$0 = FetchMessagesWithSendingProgressService$bindDatabase$4$2.invokeSuspend$lambda$5$0($displayMessages, this$0, $msgListForUpdate, (CopyScope) obj);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit invokeSuspend$lambda$5$0(List $displayMessages, FetchMessagesWithSendingProgressService this$0, List $msgListForUpdate, CopyScope $this$copy) {
        ...
        Iterable $this$filter$iv = CollectionsKt.sortedWith($this$sortedBy$iv, new Comparator() { // from class: kntr.app.im.chat.service.FetchMessagesWithSendingProgressService$bindDatabase$4$2$invokeSuspend$lambda$5$0$$inlined$sortedBy$1
