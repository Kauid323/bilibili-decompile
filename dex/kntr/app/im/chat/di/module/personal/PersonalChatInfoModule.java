...
import kntr.app.im.chat.service.DefaultChatInfoBuilder;
...
public final class PersonalChatInfoModule {
    ...
    public final FusionChatInfoService fusionChatInfoService(SessionId sessionId, NetworkChatInfoService networkService, ChatInfoDatabaseService databaseService) {
        ...
        return new FusionChatInfoServiceImpl(sessionId, networkService, databaseService, new DefaultChatInfoBuilder() { // from class: kntr.app.im.chat.di.module.personal.PersonalChatInfoModule$$ExternalSyntheticLambda0
            @Override // kntr.app.im.chat.service.DefaultChatInfoBuilder
            public final ChatInfo getDefaultChatInfo() {
                ChatInfo fusionChatInfoService$lambda$0;
                fusionChatInfoService$lambda$0 = PersonalChatInfoModule.fusionChatInfoService$lambda$0();
                return fusionChatInfoService$lambda$0;
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final ChatInfo fusionChatInfoService$lambda$0() {
        return new ChatInfo(null, null, InputBoxConfig.Companion.getDEFAULT(), null, null, null, 59, null);
    }
}