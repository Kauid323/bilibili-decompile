...
@DebugMetadata(c = "kntr.app.im.chat.db.combinedDao.DeletingDao_Impl$upsertWithToken$4", f = "DeletingDao_Impl.kt", i = {}, l = {261}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class DeletingDao_Impl$upsertWithToken$4 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public DeletingDao_Impl$upsertWithToken$4(DeletingDao_Impl deletingDao_Impl, List<MessageEntity> list, Continuation<? super DeletingDao_Impl$upsertWithToken$4> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new DeletingDao_Impl$upsertWithToken$4(this.this$0, this.$messages, continuation);
    }
