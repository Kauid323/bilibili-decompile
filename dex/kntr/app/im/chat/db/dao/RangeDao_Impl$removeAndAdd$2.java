...
@DebugMetadata(c = "kntr.app.im.chat.db.dao.RangeDao_Impl$removeAndAdd$2", f = "RangeDao_Impl.kt", i = {}, l = {59}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class RangeDao_Impl$removeAndAdd$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    int label;
    final /* synthetic */ RangeDao_Impl this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RangeDao_Impl$removeAndAdd$2(RangeDao_Impl rangeDao_Impl, SessionIdEntity sessionIdEntity, Collection<LongRange> collection, Collection<LongRange> collection2, Continuation<? super RangeDao_Impl$removeAndAdd$2> continuation) {
        super(1, continuation);
        this.this$0 = rangeDao_Impl;
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new RangeDao_Impl$removeAndAdd$2(this.this$0, this.$sessionId, this.$toDelete, this.$toInsert, continuation);
    }
