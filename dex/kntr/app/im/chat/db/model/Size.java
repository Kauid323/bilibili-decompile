...
public final class Size {
    ...
    public /* synthetic */ Size(int seen0, float width, float height, SerializationConstructorMarker serializationConstructorMarker) {
        if ((seen0 & 1) == 0) {
            this.width = 0.0f;
        } else {
            this.width = width;
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$db_debug(Size self, CompositeEncoder output, SerialDescriptor serialDesc) {
        if (output.shouldEncodeElementDefault(serialDesc, 0) || Float.compare(self.width, 0.0f) != 0) {
            output.encodeFloatElement(serialDesc, 0, self.width);
        }
        if (output.shouldEncodeElementDefault(serialDesc, 1) || Float.compare(self.height, 0.0f) != 0) {
    ...
    /* compiled from: InputBoxContent.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lkntr/app/im/chat/db/model/Size$Companion;", RoomRecommendViewModel.EMPTY_CURSOR, "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lkntr/app/im/chat/db/model/Size;", "db_debug"}, k = 1, mv = {2, 2, 0}, xi = 48)
