...
@DebugMetadata(c = "kntr.app.im.chat.sticker.manage.StickerManagerPageKt$StickerManagerPage$5$1$4$1$1", f = "StickerManagerPage.kt", i = {}, l = {222}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class StickerManagerPageKt$StickerManagerPage$5$1$4$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public StickerManagerPageKt$StickerManagerPage$5$1$4$1$1(MutableState<PermissionStatus> mutableState, Router router, MutableState<Boolean> mutableState2, BPermissionState bPermissionState, Continuation<? super StickerManagerPageKt$StickerManagerPage$5$1$4$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new StickerManagerPageKt$StickerManagerPage$5$1$4$1$1(this.$savedPermissionStatus, this.$route, this.$showPermissionDialog, this.$galleryPermission, continuation);
    }
