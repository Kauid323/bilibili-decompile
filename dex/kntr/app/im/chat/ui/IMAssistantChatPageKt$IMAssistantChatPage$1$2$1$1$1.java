...
@DebugMetadata(c = "kntr.app.im.chat.ui.IMAssistantChatPageKt$IMAssistantChatPage$1$2$1$1$1", f = "IMAssistantChatPage.kt", i = {}, l = {109}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class IMAssistantChatPageKt$IMAssistantChatPage$1$2$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public IMAssistantChatPageKt$IMAssistantChatPage$1$2$1$1$1(State<ChatPageData> state, ChatReporter chatReporter, PvEventTrigger pvEventTrigger, Continuation<? super IMAssistantChatPageKt$IMAssistantChatPage$1$2$1$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new IMAssistantChatPageKt$IMAssistantChatPage$1$2$1$1$1(this.$pageState, this.$reporter, this.$pvTrigger, continuation);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                final Flow $this$mapNotNull$iv = SnapshotStateKt.snapshotFlow(new Function0<ChatPageData>() { // from class: kntr.app.im.chat.ui.IMAssistantChatPageKt$IMAssistantChatPage$1$2$1$1$1.1
                    public final ChatPageData invoke() {
                        return (ChatPageData) state.getValue();
                    }
                });
                Flow $this$mapNotNull$iv2 = FlowKt.distinctUntilChanged(new Flow<Map<String, ? extends String>>() { // from class: kntr.app.im.chat.ui.IMAssistantChatPageKt$IMAssistantChatPage$1$2$1$1$1$invokeSuspend$$inlined$mapNotNull$1
                    ...
                    /* renamed from: kntr.app.im.chat.ui.IMAssistantChatPageKt$IMAssistantChatPage$1$2$1$1$1$invokeSuspend$$inlined$mapNotNull$1$2  reason: invalid class name */
                    ...
                    public static final class AnonymousClass2<T> implements FlowCollector {
                        ...
                        @DebugMetadata(c = "kntr.app.im.chat.ui.IMAssistantChatPageKt$IMAssistantChatPage$1$2$1$1$1$invokeSuspend$$inlined$mapNotNull$1$2", f = "IMAssistantChatPage.kt", i = {0, 0, 0, 0, 0, 0}, l = {221}, m = "emit", n = {"value", "$completion", "value", "$this$mapNotNull_u24lambda_u246", "transformed", "$i$a$-unsafeTransform-FlowKt__TransformKt$mapNotNull$1"}, s = {"L$0", "L$1", "L$2", "L$3", "L$4", "I$0"}, v = 1)
                        /* renamed from: kntr.app.im.chat.ui.IMAssistantChatPageKt$IMAssistantChatPage$1$2$1$1$1$invokeSuspend$$inlined$mapNotNull$1$2$1  reason: invalid class name */
                        /* loaded from: /data/np/file-convert/202602280713022b24dde5-650f-44d6-87eb-e24b0df191b5/202602280713022b24dde5-650f-44d6-87eb-e24b0df191b5.dex */
                ...
                this.label = 1;
                if ($this$mapNotNull$iv2.collect(new FlowCollector() { // from class: kntr.app.im.chat.ui.IMAssistantChatPageKt$IMAssistantChatPage$1$2$1$1$1.3
