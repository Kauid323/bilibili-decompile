...
public final class PushEmptyFrameBuilder implements ChatMsgFrameBuilder<PushEmptyFrame> {
    ...
    @Inject
    public PushEmptyFrameBuilder(ChatMsgModuleBuilderProvider chatMsgModuleBuilderProvider, ChatActionHandler actionHandler, ChatReporter reporter) {
        ...
        this.acceptClass = Reflection.getOrCreateKotlinClass(PushEmptyFrame.class);
    }

    @Override // kntr.app.im.chat.ui.builder.ChatMsgFrameBuilder
    public KClass<PushEmptyFrame> getAcceptClass() {
        return this.acceptClass;
    }

    @Override // kntr.app.im.chat.ui.builder.ChatMsgFrameBuilder
    public void Content(PushEmptyFrame msgFrame, final EntityMessage msgContent, Modifier modifier, Composer $composer, int $changed) {
        Intrinsics.checkNotNullParameter(msgFrame, "msgFrame");
        Intrinsics.checkNotNullParameter(msgContent, "msgContent");
        Intrinsics.checkNotNullParameter(modifier, "modifier");
        $composer.startReplaceGroup(2032422972);
        ComposerKt.sourceInformation($composer, "C(Content)N(msgFrame,msgContent,modifier)85@3647L293,91@3972L142,77@3275L961:PushEmptyFrame.kt#wmjton");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2032422972, $changed, -1, "kntr.app.im.chat.ui.frame.PushEmptyFrameBuilder.Content (PushEmptyFrame.kt:76)");
        }
        ChatMsgModuleBuilderProvider chatMsgModuleBuilderProvider = this.chatMsgModuleBuilderProvider;
        ComposerKt.sourceInformationMarkerStart($composer, -1051626719, "CC(remember):PushEmptyFrame.kt#9igjgp");
        Object it$iv = $composer.rememberedValue();
        if (it$iv == Composer.Companion.getEmpty()) {
            Object value$iv = new Function1() { // from class: kntr.app.im.chat.ui.frame.PushEmptyFrameBuilder$$ExternalSyntheticLambda0
                public final Object invoke(Object obj) {
                    Flow Content$lambda$0$0;
                    Content$lambda$0$0 = PushEmptyFrameBuilder.Content$lambda$0$0((Flow) obj);
        ...
        ComposerKt.sourceInformationMarkerStart($composer, -1051616470, "CC(remember):PushEmptyFrame.kt#9igjgp");
        ...
        if (invalid$iv || it$iv2 == Composer.Companion.getEmpty()) {
            Object value$iv2 = new Function0() { // from class: kntr.app.im.chat.ui.frame.PushEmptyFrameBuilder$$ExternalSyntheticLambda1
                public final Object invoke() {
                    Unit Content$lambda$1$0;
                    Content$lambda$1$0 = PushEmptyFrameBuilder.Content$lambda$1$0(PushEmptyFrameBuilder.this, msgContent);
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        PushEmptyFrameKt.PushEmptyFrame(msgFrame, msgContent, chatMsgModuleBuilderProvider, this.actionHandler, ComposeExposureLayoutInfoCollectorKt.collectExposureLayoutInfo(modifier, new ExposureEntry(function1, (Function0) it$iv2)), this.reporter, $composer, ($changed & 14) | ($changed & 112), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit Content$lambda$1$0(PushEmptyFrameBuilder this$0, EntityMessage $msgContent) {
