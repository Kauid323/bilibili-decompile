...
@Metadata(d1 = {"\u0000\u001c\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a-\u0010\u0000\u001a\u00020\u00012\b\u0010\u0002\u001a\u0004\u0018\u00010\u00032\u0006\u0010\u0004\u001a\u00020\u00052\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00010\u0007H\u0001¢\u0006\u0002\u0010\b¨\u0006\t"}, d2 = {"ConfirmDialog", RoomRecommendViewModel.EMPTY_CURSOR, "type", "Lkntr/app/im/chat/ui/widget/sticky/ConfirmDialogType;", "onAction", "Lkntr/app/im/chat/ui/widget/sticky/OnConfirmDialogAction;", "onDismiss", "Lkotlin/Function0;", "(Lkntr/app/im/chat/ui/widget/sticky/ConfirmDialogType;Lkntr/app/im/chat/ui/widget/sticky/OnConfirmDialogAction;Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;I)V", "ui_debug"}, k = 2, mv = {2, 2, 0}, xi = 48)
public final class ConfirmdialogKt {
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit ConfirmDialog$lambda$1(ConfirmDialogType confirmDialogType, OnConfirmDialogAction onConfirmDialogAction, Function0 function0, int i, Composer composer, int i2) {
        ConfirmDialog(confirmDialogType, onConfirmDialogAction, function0, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1));
        return Unit.INSTANCE;
    }

    public static final void ConfirmDialog(final ConfirmDialogType type, final OnConfirmDialogAction onAction, final Function0<Unit> function0, Composer $composer, final int $changed) {
        Intrinsics.checkNotNullParameter(onAction, "onAction");
        Intrinsics.checkNotNullParameter(function0, "onDismiss");
        Composer $composer2 = $composer.startRestartGroup(246033722);
        ComposerKt.sourceInformation($composer2, "C(ConfirmDialog)N(type,onAction,onDismiss):Confirmdialog.kt#o1wnfl");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
            $dirty |= $composer2.changed(type == null ? -1 : type.ordinal()) ? 4 : 2;
        }
        if (($changed & 48) == 0) {
            $dirty |= $composer2.changed(onAction) ? 32 : 16;
        }
        if (($changed & 384) == 0) {
        ...
        if (!$composer2.shouldExecute(($dirty2 & 147) != 146, $dirty2 & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(246033722, $dirty2, -1, "kntr.app.im.chat.ui.widget.sticky.ConfirmDialog (Confirmdialog.kt:61)");
            }
            if (type != null) {
                $composer2.startReplaceGroup(-1918402487);
                ComposerKt.sourceInformation($composer2, "65@2499L627,63@2439L687");
                AndroidDialog_androidKt.Dialog(function0, (DialogProperties) null, ComposableLambdaKt.rememberComposableLambda(86701512, true, new Function2() { // from class: kntr.app.im.chat.ui.widget.sticky.ConfirmdialogKt$$ExternalSyntheticLambda0
                    public final Object invoke(Object obj, Object obj2) {
                        Unit ConfirmDialog$lambda$0;
                        ConfirmDialog$lambda$0 = ConfirmdialogKt.ConfirmDialog$lambda$0(ConfirmDialogType.this, function0, onAction, (Composer) obj, ((Integer) obj2).intValue());
                        return ConfirmDialog$lambda$0;
                    }
                }, $composer2, 54), $composer2, (($dirty2 >> 6) & 14) | 384, 2);
            } else {
                $composer2.startReplaceGroup(-1920834840);
            }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: kntr.app.im.chat.ui.widget.sticky.ConfirmdialogKt$$ExternalSyntheticLambda1
                public final Object invoke(Object obj, Object obj2) {
                    Unit ConfirmDialog$lambda$1;
                    ConfirmDialog$lambda$1 = ConfirmdialogKt.ConfirmDialog$lambda$1(ConfirmDialogType.this, onAction, function0, $changed, (Composer) obj, ((Integer) obj2).intValue());
                    return ConfirmDialog$lambda$1;
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit ConfirmDialog$lambda$0(final ConfirmDialogType $type, final Function0 $onDismiss, final OnConfirmDialogAction $onAction, Composer $composer, int $changed) {
        ComposerKt.sourceInformation($composer, "C66@2525L24,68@2607L26,69@2667L28,70@2730L27,71@2792L28,67@2562L554:Confirmdialog.kt#o1wnfl");
        if ($composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(86701512, $changed, -1, "kntr.app.im.chat.ui.widget.sticky.ConfirmDialog.<anonymous> (Confirmdialog.kt:66)");
            }
            ...
            ComposerKt.sourceInformationMarkerEnd($composer);
            final String titleString$iv = StringResourcesKt.stringResource($type.getTitle(), $composer, 0);
            final String contentString$iv = StringResourcesKt.stringResource($type.getContent(), $composer, 0);
            final String negativeString$iv = StringResourcesKt.stringResource($type.getCancel(), $composer, 0);
            final String positiveString$iv = StringResourcesKt.stringResource($type.getConfirm(), $composer, 0);
            ...
            DialogContent_androidKt.DialogContent(ComposableLambdaKt.rememberComposableLambda(93781831, true, new Function2<Composer, Integer, Unit>() { // from class: kntr.app.im.chat.ui.widget.sticky.ConfirmdialogKt$ConfirmDialog$lambda$0$$inlined$DialogContent$1
                ...
                public final void invoke(Composer $composer2, int $changed2) {
                    ...
                    if (str4 != null) {
                        ...
                        Modifier modifier$iv3 = ClickableKt.clickable-oSLSa3U$default(weight$default, false, (String) null, (Role) null, (MutableInteractionSource) null, new Function0<Unit>() { // from class: kntr.app.im.chat.ui.widget.sticky.ConfirmdialogKt$ConfirmDialog$lambda$0$$inlined$DialogContent$1.1
                    ...
                    if (str3 != null) {
                        ...
                        final OnConfirmDialogAction onConfirmDialogAction = $onAction;
                        final ConfirmDialogType confirmDialogType = $type;
                        final Function0 function02 = $onDismiss;
                        Modifier modifier$iv4 = ClickableKt.clickable-oSLSa3U$default(weight$default2, false, (String) null, (Role) null, (MutableInteractionSource) null, new Function0<Unit>() { // from class: kntr.app.im.chat.ui.widget.sticky.ConfirmdialogKt$ConfirmDialog$lambda$0$$inlined$DialogContent$1.2
                            public /* bridge */ /* synthetic */ Object invoke() {
                                m1992invoke();
                                return Unit.INSTANCE;
                            }
                            ...
                            public final void m1992invoke() {
                                BuildersKt.launch$default(coroutineScope, (CoroutineContext) null, (CoroutineStart) null, new ConfirmdialogKt$ConfirmDialog$1$2$1(onConfirmDialogAction, confirmDialogType, function02, null), 3, (Object) null);
                            }
                        }, 15, (Object) null);
            ...
            }, $composer, 54), modifier$iv, ComposableLambdaKt.rememberComposableLambda(1990761289, true, new Function2<Composer, Integer, Unit>() { // from class: kntr.app.im.chat.ui.widget.sticky.ConfirmdialogKt$ConfirmDialog$lambda$0$$inlined$DialogContent$2
                public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                    invoke((Composer) p1, ((Number) p2).intValue());
                    return Unit.INSTANCE;
                }
