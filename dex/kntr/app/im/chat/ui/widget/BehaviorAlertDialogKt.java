...
/* compiled from: BehaviorAlertDialog.kt */
@Metadata(d1 = {"\u0000\u001c\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\u001a/\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00010\u00052\n\b\u0002\u0010\u0006\u001a\u0004\u0018\u00010\u0007H\u0001¢\u0006\u0002\u0010\b¨\u0006\t"}, d2 = {"BehaviorAlertDialog", RoomRecommendViewModel.EMPTY_CURSOR, "content", "Lcom/bapis/bilibili/app/im/v1/KBehaviorAlertToast;", "onConfirm", "Lkotlin/Function0;", "confirmString", RoomRecommendViewModel.EMPTY_CURSOR, "(Lcom/bapis/bilibili/app/im/v1/KBehaviorAlertToast;Lkotlin/jvm/functions/Function0;Ljava/lang/String;Landroidx/compose/runtime/Composer;II)V", "ui_debug"}, k = 2, mv = {2, 2, 0}, xi = 48)
public final class BehaviorAlertDialogKt {
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit BehaviorAlertDialog$lambda$1(KBehaviorAlertToast kBehaviorAlertToast, Function0 function0, String str, int i, int i2, Composer composer, int i3) {
        BehaviorAlertDialog(kBehaviorAlertToast, function0, str, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
    ...
    */
    public static final void BehaviorAlertDialog(final KBehaviorAlertToast content, final Function0<Unit> function0, String confirmString, Composer $composer, final int $changed, final int i) {
        String str;
        final String confirmString2;
        int $dirty;
        int i2;
        Intrinsics.checkNotNullParameter(content, "content");
        Intrinsics.checkNotNullParameter(function0, "onConfirm");
        Composer $composer2 = $composer.startRestartGroup(-956125521);
        ComposerKt.sourceInformation($composer2, "C(BehaviorAlertDialog)N(content,onConfirm,confirmString)20@738L287,17@616L409:BehaviorAlertDialog.kt#92mklk");
        int $dirty2 = $changed;
        if (($changed & 6) == 0) {
            $dirty2 |= $composer2.changedInstance(content) ? 4 : 2;
        }
        if (($changed & 48) == 0) {
        ...
        if ($composer2.shouldExecute(($dirty2 & 147) != 146, $dirty2 & 1)) {
            ...
            ComposerKt.sourceInformation($composer2, "15@549L57");
            if (($changed & 1) != 0 && !$composer2.getDefaultsInvalid()) {
                ...
                $dirty = $dirty2 & (-897);
                confirmString2 = StringResourcesKt.stringResource(String0_commonMainKt.getCommon_global_string_194(CommonRes.INSTANCE.getString()), $composer2, 0);
                $composer2.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-956125521, $dirty, -1, "kntr.app.im.chat.ui.widget.BehaviorAlertDialog (BehaviorAlertDialog.kt:16)");
                }
                AndroidDialog_androidKt.Dialog(function0, new DialogProperties(false, false, false, 5, (DefaultConstructorMarker) null), ComposableLambdaKt.rememberComposableLambda(-1777964744, true, new Function2() { // from class: kntr.app.im.chat.ui.widget.BehaviorAlertDialogKt$$ExternalSyntheticLambda0
                    public final Object invoke(Object obj, Object obj2) {
                        Unit BehaviorAlertDialog$lambda$0;
                        BehaviorAlertDialog$lambda$0 = BehaviorAlertDialogKt.BehaviorAlertDialog$lambda$0(content, function0, confirmString2, (Composer) obj, ((Integer) obj2).intValue());
                        return BehaviorAlertDialog$lambda$0;
                    }
        ...
        if (endRestartGroup != null) {
            final String str2 = confirmString2;
            endRestartGroup.updateScope(new Function2() { // from class: kntr.app.im.chat.ui.widget.BehaviorAlertDialogKt$$ExternalSyntheticLambda1
                public final Object invoke(Object obj, Object obj2) {
                    Unit BehaviorAlertDialog$lambda$1;
                    BehaviorAlertDialog$lambda$1 = BehaviorAlertDialogKt.BehaviorAlertDialog$lambda$1(content, function0, str2, $changed, i, (Composer) obj, ((Integer) obj2).intValue());
                    return BehaviorAlertDialog$lambda$1;
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit BehaviorAlertDialog$lambda$0(KBehaviorAlertToast $content, final Function0 $onConfirm, final String $confirmString, Composer $composer, int $changed) {
        ComposerKt.sourceInformation($composer, "C21@748L271:BehaviorAlertDialog.kt#92mklk");
        if (!$composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            $composer.skipToGroupEnd();
        } else {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1777964744, $changed, -1, "kntr.app.im.chat.ui.widget.BehaviorAlertDialog.<anonymous> (BehaviorAlertDialog.kt:21)");
            }
            final String titleString$iv = $content.getTitle();
            final String contentString$iv = $content.getContent();
            ...
            DialogContent_androidKt.DialogContent(ComposableLambdaKt.rememberComposableLambda(93781831, true, new Function2<Composer, Integer, Unit>() { // from class: kntr.app.im.chat.ui.widget.BehaviorAlertDialogKt$BehaviorAlertDialog$lambda$0$$inlined$DialogContent$1
                ...
                public final void invoke(Composer $composer2, int $changed2) {
                    ...
                    if (str3 != null) {
                        ...
                        Modifier modifier$iv4 = ClickableKt.clickable-oSLSa3U$default(RowScope.-CC.weight$default($this$invoke_u24lambda_u240, SizeKt.fillMaxHeight$default(Modifier.Companion, 0.0f, 1, (Object) null), 1.0f, false, 2, (Object) null), false, (String) null, (Role) null, (MutableInteractionSource) null, new Function0<Unit>() { // from class: kntr.app.im.chat.ui.widget.BehaviorAlertDialogKt$BehaviorAlertDialog$lambda$0$$inlined$DialogContent$1.2
                            public /* bridge */ /* synthetic */ Object invoke() {
                                m1897invoke();
                                return Unit.INSTANCE;
                            }
            ...
            }, $composer, 54), modifier$iv, ComposableLambdaKt.rememberComposableLambda(1990761289, true, new Function2<Composer, Integer, Unit>() { // from class: kntr.app.im.chat.ui.widget.BehaviorAlertDialogKt$BehaviorAlertDialog$lambda$0$$inlined$DialogContent$2
                public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                    invoke((Composer) p1, ((Number) p2).intValue());
                    return Unit.INSTANCE;
                }
            ...
            }, $composer, 54), $composer, ((196608 >> 9) & 112) | 390, 0);
