...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u001b\u0010\u0000\u001a\u00020\u00012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00010\u0003H\u0001¢\u0006\u0002\u0010\u0004¨\u0006\u0005"}, d2 = {"CameraPermissionDialog", RoomRecommendViewModel.EMPTY_CURSOR, "onDismiss", "Lkotlin/Function0;", "(Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;I)V", "ui_debug"}, k = 2, mv = {2, 2, 0}, xi = 48)
public final class CameraPermissionDialogKt {
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit CameraPermissionDialog$lambda$1(Function0 function0, int i, Composer composer, int i2) {
        CameraPermissionDialog(function0, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1));
        return Unit.INSTANCE;
    }

    public static final void CameraPermissionDialog(final Function0<Unit> function0, Composer $composer, final int $changed) {
        Intrinsics.checkNotNullParameter(function0, "onDismiss");
        Composer $composer2 = $composer.startRestartGroup(-410588764);
        ComposerKt.sourceInformation($composer2, "C(CameraPermissionDialog)N(onDismiss)16@667L20,17@729L537,17@692L574:CameraPermissionDialog.kt#92mklk");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (!$composer2.shouldExecute(($dirty2 & 3) != 2, $dirty2 & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-410588764, $dirty2, -1, "kntr.app.im.chat.ui.widget.CameraPermissionDialog (CameraPermissionDialog.kt:15)");
            }
            final Activity context = PlatformContext_androidKt.getPlatformContext($composer2, 0);
            AndroidDialog_androidKt.Dialog(function0, (DialogProperties) null, ComposableLambdaKt.rememberComposableLambda(-1552839813, true, new Function2() { // from class: kntr.app.im.chat.ui.widget.CameraPermissionDialogKt$$ExternalSyntheticLambda0
                public final Object invoke(Object obj, Object obj2) {
                    Unit CameraPermissionDialog$lambda$0;
                    CameraPermissionDialog$lambda$0 = CameraPermissionDialogKt.CameraPermissionDialog$lambda$0(function0, context, (Composer) obj, ((Integer) obj2).intValue());
                    return CameraPermissionDialog$lambda$0;
                }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: kntr.app.im.chat.ui.widget.CameraPermissionDialogKt$$ExternalSyntheticLambda1
                public final Object invoke(Object obj, Object obj2) {
                    Unit CameraPermissionDialog$lambda$1;
                    CameraPermissionDialog$lambda$1 = CameraPermissionDialogKt.CameraPermissionDialog$lambda$1(function0, $changed, (Composer) obj, ((Integer) obj2).intValue());
                    return CameraPermissionDialog$lambda$1;
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit CameraPermissionDialog$lambda$0(final Function0 $onDismiss, final Activity $context, Composer $composer, int $changed) {
        ComposerKt.sourceInformation($composer, "C19@780L57,21@900L57,22@988L57,18@739L521:CameraPermissionDialog.kt#92mklk");
        if (!$composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            $composer.skipToGroupEnd();
        } else {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1552839813, $changed, -1, "kntr.app.im.chat.ui.widget.CameraPermissionDialog.<anonymous> (CameraPermissionDialog.kt:18)");
            }
            final String titleString$iv = StringResourcesKt.stringResource(String0_commonMainKt.getOthers_global_string_110(OthersRes.INSTANCE.getString()), $composer, 0);
            final String negativeString$iv = StringResourcesKt.stringResource(bili.resource.common.String0_commonMainKt.getCommon_global_string_238(CommonRes.INSTANCE.getString()), $composer, 0);
            final String positiveString$iv = StringResourcesKt.stringResource(bili.resource.common.String0_commonMainKt.getCommon_global_string_313(CommonRes.INSTANCE.getString()), $composer, 0);
            ...
            DialogContent_androidKt.DialogContent(ComposableLambdaKt.rememberComposableLambda(93781831, true, new Function2<Composer, Integer, Unit>() { // from class: kntr.app.im.chat.ui.widget.CameraPermissionDialogKt$CameraPermissionDialog$lambda$0$$inlined$DialogContent$1
                ...
                public final void invoke(Composer $composer2, int $changed2) {
                    ...
                    if (str4 != null) {
                        ...
                        Modifier modifier$iv3 = ClickableKt.clickable-oSLSa3U$default(weight$default, false, (String) null, (Role) null, (MutableInteractionSource) null, new Function0<Unit>() { // from class: kntr.app.im.chat.ui.widget.CameraPermissionDialogKt$CameraPermissionDialog$lambda$0$$inlined$DialogContent$1.1
                    ...
                    if (str3 != null) {
                        ...
                        Modifier modifier$iv4 = ClickableKt.clickable-oSLSa3U$default(weight$default2, false, (String) null, (Role) null, (MutableInteractionSource) null, new Function0<Unit>() { // from class: kntr.app.im.chat.ui.widget.CameraPermissionDialogKt$CameraPermissionDialog$lambda$0$$inlined$DialogContent$1.2
                            public /* bridge */ /* synthetic */ Object invoke() {
                                m1899invoke();
                                return Unit.INSTANCE;
                            }
            ...
            }, $composer, 54), modifier$iv, ComposableLambdaKt.rememberComposableLambda(1990761289, true, new Function2<Composer, Integer, Unit>() { // from class: kntr.app.im.chat.ui.widget.CameraPermissionDialogKt$CameraPermissionDialog$lambda$0$$inlined$DialogContent$2
                public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                    invoke((Composer) p1, ((Number) p2).intValue());
                    return Unit.INSTANCE;
                }
