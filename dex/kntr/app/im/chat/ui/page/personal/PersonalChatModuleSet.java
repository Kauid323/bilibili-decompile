...
import kntr.app.im.chat.ui.module.aiIntroduce.AiIntroduceUIModule;
...
import kntr.app.im.chat.ui.module.notifyGame.ChatMsgNotifyGameModuleBuilderModule;
...
import kntr.app.im.chat.ui.module.pastWorks.ChatMsgPastWorksInjectModule;
...
/* compiled from: PersonalChatModuleSet.kt */
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\bÇ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lkntr/app/im/chat/ui/page/personal/PersonalChatModuleSet;", RoomRecommendViewModel.EMPTY_CURSOR, "<init>", "()V", "ui_debug"}, k = 1, mv = {2, 2, 0}, xi = 48)
@Module(includes = {CommonMsgModuleSet.class, ChatMsgTextModuleModule.class, ChatMsgPictureModuleModule.class, ChatMsgLocalPictureModuleModule.class, ChatMsgShareVideoModuleModule.class, ChatMsgShareArticleModuleModule.class, ChatMsgShareTypeModuleModule.class, ChatMsgShareDynamicModuleModule.class, ChatMsgShareDynamicForwardModuleModule.class, ChatMsgShareCommonModuleModule.class, ChatMsgShareAppletModuleModule.class, ChatMsgPushVideoModuleModule.class, ChatMsgPushArticleModuleModule.class, ChatMsgPushAdditionalMsgModuleModule.class, ChatMsgAuthorModuleModule.class, ChatMsgNotifyTitleModuleModule.class, ChatMsgNotifyDetailModuleModule.class, ChatMsgNotifyInteractiveModuleModule.class, ChatMsgNotifyGameModuleBuilderModule.class, ChatMsgBannerImgModule.class, HintTextModuleModule.class, AiIntroduceUIModule.class, AutoReplyModuleModule.class, InvalidResourceModuleContentModule.class, ChatMsgPastWorksInjectModule.class, UnknownModuleContentModule.class}, subcomponents = {})
public final class PersonalChatModuleSet {
    public static final int $stable = 0;
    public static final PersonalChatModuleSet INSTANCE = new PersonalChatModuleSet();

    private PersonalChatModuleSet() {
    }
}