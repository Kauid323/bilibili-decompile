...
public final /* synthetic */ class AdProductCarouselData$$serializer implements GeneratedSerializer<AdProductCarouselData> {
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.ad.common.model.AdProductCarouselData", INSTANCE, 4);
        pluginGeneratedSerialDescriptor.addElement("animeStartTime", true);
        pluginGeneratedSerialDescriptor.addElement("themeColor", true);
        pluginGeneratedSerialDescriptor.addElement("carouselImages", true);
        pluginGeneratedSerialDescriptor.addElement("guideImage", true);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    private AdProductCarouselData$$serializer() {
    }

    public final KSerializer<?>[] childSerializers() {
        Lazy[] lazyArr;
        lazyArr = AdProductCarouselData.$childSerializers;
        return new KSerializer[]{LongSerializer.INSTANCE, BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable((KSerializer) lazyArr[2].getValue()), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE)};
    }

    public final AdProductCarouselData deserialize(Decoder decoder) {
        Lazy[] lazyArr;
        int i;
        String str;
        List list;
        ...
        return new AdProductCarouselData(i, j2, str, list, str2, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, AdProductCarouselData value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        AdProductCarouselData.write$Self$dto_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
