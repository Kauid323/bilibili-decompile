...
public final /* synthetic */ class AdVideoEndPage$$serializer implements GeneratedSerializer<AdVideoEndPage> {
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.ad.common.model.AdVideoEndPage", INSTANCE, 2);
        pluginGeneratedSerialDescriptor.addElement("gameIcon", true);
        pluginGeneratedSerialDescriptor.addElement("gameName", true);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    private AdVideoEndPage$$serializer() {
    }
    ...
    public final AdVideoEndPage deserialize(Decoder decoder) {
        String str;
        String str2;
        int i;
        ...
        return new AdVideoEndPage(i, str, str2, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, AdVideoEndPage value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        AdVideoEndPage.write$Self$dto_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
