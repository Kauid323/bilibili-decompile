...
public final /* synthetic */ class AdGameGlanceModule$$serializer implements GeneratedSerializer<AdGameGlanceModule> {
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.ad.common.model.AdGameGlanceModule", INSTANCE, 5);
        pluginGeneratedSerialDescriptor.addElement("display", true);
        pluginGeneratedSerialDescriptor.addElement("gameName", true);
        pluginGeneratedSerialDescriptor.addElement("gameIcon", true);
        pluginGeneratedSerialDescriptor.addElement("developer_input_name", true);
        pluginGeneratedSerialDescriptor.addElement("tagList", true);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    private AdGameGlanceModule$$serializer() {
    }

    public final KSerializer<?>[] childSerializers() {
        Lazy[] lazyArr;
        lazyArr = AdGameGlanceModule.$childSerializers;
        return new KSerializer[]{BooleanSerializer.INSTANCE, BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable((KSerializer) lazyArr[4].getValue())};
    }

    public final AdGameGlanceModule deserialize(Decoder decoder) {
        Lazy[] lazyArr;
        String str;
        List list;
        String str2;
        ...
        return new AdGameGlanceModule(i, z, str2, str3, str, list, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, AdGameGlanceModule value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        AdGameGlanceModule.write$Self$dto_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
