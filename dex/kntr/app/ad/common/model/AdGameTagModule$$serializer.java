...
public final /* synthetic */ class AdGameTagModule$$serializer implements GeneratedSerializer<AdGameTagModule> {
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.ad.common.model.AdGameTagModule", INSTANCE, 2);
        pluginGeneratedSerialDescriptor.addElement("display", true);
        pluginGeneratedSerialDescriptor.addElement("tagList", true);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    private AdGameTagModule$$serializer() {
    }

    public final KSerializer<?>[] childSerializers() {
        Lazy[] lazyArr;
        lazyArr = AdGameTagModule.$childSerializers;
        return new KSerializer[]{BooleanSerializer.INSTANCE, BuiltinSerializersKt.getNullable((KSerializer) lazyArr[1].getValue())};
    }

    public final AdGameTagModule deserialize(Decoder decoder) {
        Lazy[] lazyArr;
        List list;
        boolean z;
        int i;
        ...
        return new AdGameTagModule(i, z, list, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, AdGameTagModule value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        AdGameTagModule.write$Self$dto_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
