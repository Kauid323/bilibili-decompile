...
public final /* synthetic */ class AdCoverTopLeftBadge$$serializer implements GeneratedSerializer<AdCoverTopLeftBadge> {
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.ad.common.model.AdCoverTopLeftBadge", INSTANCE, 4);
    ...
    private AdCoverTopLeftBadge$$serializer() {
    }

    public final KSerializer<?>[] childSerializers() {
        return new KSerializer[]{BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), IntSerializer.INSTANCE, IntSerializer.INSTANCE};
    }

    public final AdCoverTopLeftBadge deserialize(Decoder decoder) {
        int i;
        int i2;
        int i3;
        String str;
        ...
        return new AdCoverTopLeftBadge(i3, str, str2, i2, i, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, AdCoverTopLeftBadge value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        AdCoverTopLeftBadge.write$Self$dto_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
