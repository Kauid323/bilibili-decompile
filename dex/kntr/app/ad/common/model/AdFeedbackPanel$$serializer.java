...
public final /* synthetic */ class AdFeedbackPanel$$serializer implements GeneratedSerializer<AdFeedbackPanel> {
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.ad.common.model.AdFeedbackPanel", INSTANCE, 5);
        pluginGeneratedSerialDescriptor.addElement("panelTypeText", true);
        pluginGeneratedSerialDescriptor.addElement("toast", true);
        pluginGeneratedSerialDescriptor.addElement("closeRecTips", true);
        pluginGeneratedSerialDescriptor.addElement("openRecTips", true);
        pluginGeneratedSerialDescriptor.addElement("feedback_panel_detail", true);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    private AdFeedbackPanel$$serializer() {
    }

    public final KSerializer<?>[] childSerializers() {
        Lazy[] lazyArr;
        lazyArr = AdFeedbackPanel.$childSerializers;
        return new KSerializer[]{BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable((KSerializer) lazyArr[4].getValue())};
    }

    public final AdFeedbackPanel deserialize(Decoder decoder) {
        Lazy[] lazyArr;
        String str;
        List list;
        String str2;
        ...
        return new AdFeedbackPanel(i, str4, str2, str3, str, list, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, AdFeedbackPanel value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        AdFeedbackPanel.write$Self$dto_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
