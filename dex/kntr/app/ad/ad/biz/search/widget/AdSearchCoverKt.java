package kntr.app.ad.ad.biz.search.widget;
...
public final class AdSearchCoverKt {
    ...
    public static final Unit AdSearchCover_6a0pyJM$lambda$1(String str, Modifier modifier, float f, int i, int i2, Composer composer, int i3) {
        m117AdSearchCover6a0pyJM(str, modifier, f, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
        return Unit.INSTANCE;
    }

    /* renamed from: AdSearchCover-6a0pyJM  reason: not valid java name */
    public static final void m117AdSearchCover6a0pyJM(final String url, Modifier modifier, float f, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f2;
        float f3;
        Modifier modifier3;
        Modifier modifier4;
        final float f4;
        Composer $composer2 = $composer.startRestartGroup(-285922507);
        ComposerKt.sourceInformation($composer2, "C(AdSearchCover)N(url,modifier,failPlaceholderIconSize:c#ui.unit.Dp)36@1337L972,30@1132L1184:AdSearchCover.kt#5qr7uz");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (!$composer2.shouldExecute(($dirty & 147) != 146, $dirty & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-285922507, $dirty, -1, "kntr.app.ad.ad.biz.search.widget.AdSearchCover (AdSearchCover.kt:29)");
            }
            BiliImageKt.BiliImage(new ImageRequest(url == null ? RoomRecommendViewModel.EMPTY_CURSOR : url).contentScale(ContentScale.Companion.getFillBounds()).build(), modifier4, (String) null, (Function1) null, (Function1) null, (Function1) null, (Function1) null, (Function2) null, ComposableLambdaKt.rememberComposableLambda(2104028326, true, new Function4() { // from class: kntr.app.ad.ad.biz.search.widget.AdSearchCoverKt$$ExternalSyntheticLambda0
        ...
        if (endRestartGroup != null) {
            ...
            final float f5 = f3;
            endRestartGroup.updateScope(new Function2() { // from class: kntr.app.ad.ad.biz.search.widget.AdSearchCoverKt$$ExternalSyntheticLambda1
    ...
    public static final Unit AdSearchCover_6a0pyJM$lambda$0(float f, ImageFailScope $this$BiliImage, ImageException it, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "CN(it)41@1497L6,37@1351L948:AdSearchCover.kt#5qr7uz");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2104028326, $changed, -1, "kntr.app.ad.ad.biz.search.widget.AdSearchCover.<anonymous> (AdSearchCover.kt:37)");
        }
        ...
        int i2 = ((48 >> 6) & 112) | 6;
        ComposerKt.sourceInformationMarkerStart($composer, 1201719153, "C45@1632L47,50@1918L7,44@1595L690:AdSearchCover.kt#5qr7uz");
