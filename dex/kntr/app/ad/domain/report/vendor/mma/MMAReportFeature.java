...
/* compiled from: MMAReportFeature.kt */
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bÀ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\b\u0010\u0004\u001a\u00020\u0005H\u0016J\b\u0010\u0006\u001a\u00020\u0007H\u0016¨\u0006\b"}, d2 = {"Lkntr/app/ad/domain/report/vendor/mma/MMAReportFeature;", "Lkntr/app/ad/domain/report/internal/ReportFeature;", "<init>", "()V", "createStorageManager", "Lkntr/app/ad/domain/report/internal/cache/IReportStorageManager;", "createUploader", "Lkntr/app/ad/domain/report/internal/upload/IReportUploader;", "report_debug"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class MMAReportFeature extends ReportFeature {
    public static final MMAReportFeature INSTANCE = new MMAReportFeature();

    private MMAReportFeature() {
    }

    @Override // kntr.app.ad.domain.report.internal.ReportFeature
    public IReportStorageManager createStorageManager() {
        AdReportFileStorageCache localCache = new AdReportFileStorageCache(ReportUtil_androidKt.getFpDir("ad-report-mma-kntr"), ReportUtilKt.getReportConfig());
        MemoryCache memoryCache = new MemoryCache(50, new Function1() { // from class: kntr.app.ad.domain.report.vendor.mma.MMAReportFeature$$ExternalSyntheticLambda0
            public final Object invoke(Object obj) {
                Unit createStorageManager$lambda$0;
                createStorageManager$lambda$0 = MMAReportFeature.createStorageManager$lambda$0((Map) obj);
