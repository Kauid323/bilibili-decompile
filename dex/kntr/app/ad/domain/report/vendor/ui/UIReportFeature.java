...
@Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\bÀ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\b\u0010\u0004\u001a\u00020\u0005H\u0016J\b\u0010\u0006\u001a\u00020\u0007H\u0016J\b\u0010\b\u001a\u00020\tH\u0014¨\u0006\n"}, d2 = {"Lkntr/app/ad/domain/report/vendor/ui/UIReportFeature;", "Lkntr/app/ad/domain/report/internal/ReportFeature;", "<init>", "()V", "createStorageManager", "Lkntr/app/ad/domain/report/internal/cache/IReportStorageManager;", "createUploader", "Lkntr/app/ad/domain/report/internal/upload/IReportUploader;", "supportBatch", RoomRecommendViewModel.EMPTY_CURSOR, "report_debug"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class UIReportFeature extends ReportFeature {
    public static final UIReportFeature INSTANCE = new UIReportFeature();

    private UIReportFeature() {
    }

    @Override // kntr.app.ad.domain.report.internal.ReportFeature
    public IReportStorageManager createStorageManager() {
        AdReportFileStorageCache localCache = new AdReportFileStorageCache(ReportUtil_androidKt.getFpDir("ad-report-ui-kntr"), ReportUtilKt.getReportConfig());
        MemoryCache memoryCache = new MemoryCache(50, new Function1() { // from class: kntr.app.ad.domain.report.vendor.ui.UIReportFeature$$ExternalSyntheticLambda0
            public final Object invoke(Object obj) {
                Unit createStorageManager$lambda$0;
                createStorageManager$lambda$0 = UIReportFeature.createStorageManager$lambda$0((Map) obj);
