...
public final class UIReportUploader extends ReportUploader {
    ...
    public Object upload(final ReportRecord record, final boolean needRetry, Function1<? super String, Unit> function1, final Function0<Unit> function0, final Function2<? super Integer, ? super String, Unit> function2, Continuation<? super Boolean> continuation) {
        Function1 ktorRequest = buildRequest(ReportUtilKt.getReportConfig().getUiUrl(), CollectionsKt.listOf(record), function1);
        return commit$report_debug(ktorRequest, new Function0() { // from class: kntr.app.ad.domain.report.vendor.ui.UIReportUploader$$ExternalSyntheticLambda0
            public final Object invoke() {
                Unit upload$lambda$0;
                upload$lambda$0 = UIReportUploader.upload$lambda$0(needRetry, function0, record);
                return upload$lambda$0;
            }
        }, new Function2() { // from class: kntr.app.ad.domain.report.vendor.ui.UIReportUploader$$ExternalSyntheticLambda1
            public final Object invoke(Object obj, Object obj2) {
                Unit upload$lambda$1;
                upload$lambda$1 = UIReportUploader.upload$lambda$1(needRetry, function2, record, ((Integer) obj).intValue(), (String) obj2);
    ...
    public static final Unit upload$lambda$0(boolean $needRetry, Function0 $successAction, ReportRecord $record) {
        if ($needRetry) {
            ReportFeature.startSchedulingRetryTask$default(UIReportFeature.INSTANCE, false, 1, null);
    ...
    public Object upload(final List<ReportRecord> list, boolean needRetry, Continuation<? super Boolean> continuation) {
        Function1 ktorRequest = ReportUploader.buildRequest$default(this, ReportUtilKt.getReportConfig().getUiUrl(), list, null, 4, null);
        return commit$report_debug(ktorRequest, new Function0() { // from class: kntr.app.ad.domain.report.vendor.ui.UIReportUploader$$ExternalSyntheticLambda2
            public final Object invoke() {
                Unit upload$lambda$2;
                upload$lambda$2 = UIReportUploader.upload$lambda$2(list);
                return upload$lambda$2;
            }
        }, new Function2() { // from class: kntr.app.ad.domain.report.vendor.ui.UIReportUploader$$ExternalSyntheticLambda3
            public final Object invoke(Object obj, Object obj2) {
                Unit upload$lambda$3;
                upload$lambda$3 = UIReportUploader.upload$lambda$3(list, ((Integer) obj).intValue(), (String) obj2);
