...
@DebugMetadata(c = "kntr.app.ad.domain.click.internal.action.handlers.BiliNativeHandlerKt$biliNativeHandler$1$1", f = "BiliNativeHandler.kt", i = {0, 0, 1, 1, 1}, l = {AdditionVote2.CARD_TYPE_FIELD_NUMBER, 24}, m = "invokeSuspend", n = {"param", "next", "param", "next", "result"}, s = {"L$0", "L$1", "L$0", "L$1", "L$2"}, v = 1)
public final class BiliNativeHandlerKt$biliNativeHandler$1$1 extends SuspendLambda implements Function3<ActionParam.Url, Function1<? super Continuation<? super Boolean>, ? extends Object>, Continuation<? super Boolean>, Object> {
    ...
    public BiliNativeHandlerKt$biliNativeHandler$1$1(ClickContext clickContext, Continuation<? super BiliNativeHandlerKt$biliNativeHandler$1$1> continuation) {
    ...
    public final Object invoke(ActionParam.Url url, Function1<? super Continuation<? super Boolean>, ? extends Object> function1, Continuation<? super Boolean> continuation) {
        BiliNativeHandlerKt$biliNativeHandler$1$1 biliNativeHandlerKt$biliNativeHandler$1$1 = new BiliNativeHandlerKt$biliNativeHandler$1$1(this.$context, continuation);
        biliNativeHandlerKt$biliNativeHandler$1$1.L$0 = url;
        biliNativeHandlerKt$biliNativeHandler$1$1.L$1 = function1;
        return biliNativeHandlerKt$biliNativeHandler$1$1.invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.L$1 = next;
                this.label = 1;
                openBiliNative = BiliNativeHandlerKt.openBiliNative(this.$context, param, (Continuation) this);
        ...
        EasyResult result2 = (EasyResult) openBiliNative;
        this.$context.dispatchActionResult(this.$context, new ActionResult.BiliNative(param, result2));
