...
@DebugMetadata(c = "kntr.app.ad.domain.click.internal.action.handlers.AdWebHandlerKt$adWebHandler$1$1", f = "AdWebHandler.kt", i = {0, 0, 1, 1, 1}, l = {AdditionVote2.TIPS_FIELD_NUMBER, 25}, m = "invokeSuspend", n = {"param", "next", "param", "next", "result"}, s = {"L$0", "L$1", "L$0", "L$1", "L$2"}, v = 1)
public final class AdWebHandlerKt$adWebHandler$1$1 extends SuspendLambda implements Function3<ActionParam.Url, Function1<? super Continuation<? super Boolean>, ? extends Object>, Continuation<? super Boolean>, Object> {
    ...
    public AdWebHandlerKt$adWebHandler$1$1(ClickContext clickContext, Continuation<? super AdWebHandlerKt$adWebHandler$1$1> continuation) {
    ...
    public final Object invoke(ActionParam.Url url, Function1<? super Continuation<? super Boolean>, ? extends Object> function1, Continuation<? super Boolean> continuation) {
        AdWebHandlerKt$adWebHandler$1$1 adWebHandlerKt$adWebHandler$1$1 = new AdWebHandlerKt$adWebHandler$1$1(this.$context, continuation);
        adWebHandlerKt$adWebHandler$1$1.L$0 = url;
        adWebHandlerKt$adWebHandler$1$1.L$1 = function1;
        return adWebHandlerKt$adWebHandler$1$1.invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.L$1 = next;
                this.label = 1;
                openAdWeb = AdWebHandlerKt.openAdWeb(this.$context, param, (Continuation) this);
        ...
        EasyResult result2 = (EasyResult) openAdWeb;
        this.$context.dispatchActionResult(this.$context, new ActionResult.AdWeb(param, result2));
