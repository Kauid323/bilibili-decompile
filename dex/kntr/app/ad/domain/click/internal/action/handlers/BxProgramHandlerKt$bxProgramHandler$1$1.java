...
@DebugMetadata(c = "kntr.app.ad.domain.click.internal.action.handlers.BxProgramHandlerKt$bxProgramHandler$1$1", f = "BxProgramHandler.kt", i = {0, 0, 1, 1, 1}, l = {AdditionVote2.TIPS_FIELD_NUMBER, 25}, m = "invokeSuspend", n = {"param", "next", "param", "next", "result"}, s = {"L$0", "L$1", "L$0", "L$1", "L$2"}, v = 1)
public final class BxProgramHandlerKt$bxProgramHandler$1$1 extends SuspendLambda implements Function3<ActionParam.Url, Function1<? super Continuation<? super Boolean>, ? extends Object>, Continuation<? super Boolean>, Object> {
    ...
    public BxProgramHandlerKt$bxProgramHandler$1$1(ClickContext clickContext, Continuation<? super BxProgramHandlerKt$bxProgramHandler$1$1> continuation) {
    ...
    public final Object invoke(ActionParam.Url url, Function1<? super Continuation<? super Boolean>, ? extends Object> function1, Continuation<? super Boolean> continuation) {
        BxProgramHandlerKt$bxProgramHandler$1$1 bxProgramHandlerKt$bxProgramHandler$1$1 = new BxProgramHandlerKt$bxProgramHandler$1$1(this.$context, continuation);
        bxProgramHandlerKt$bxProgramHandler$1$1.L$0 = url;
        bxProgramHandlerKt$bxProgramHandler$1$1.L$1 = function1;
        return bxProgramHandlerKt$bxProgramHandler$1$1.invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.L$1 = next;
                this.label = 1;
                openBxProgram = BxProgramHandlerKt.openBxProgram(this.$context, param, (Continuation) this);
        ...
        EasyResult result2 = (EasyResult) openBxProgram;
        this.$context.dispatchActionResult(this.$context, new ActionResult.BxProgram(param, result2));
