...
@Metadata(d1 = {"\u00006\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u0015\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00070\u0006¢\u0006\u0002\u0010\bJ\u000e\u0010\t\u001a\u00020\u00022\u0006\u0010\n\u001a\u00020\u000bJ\u0016\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u0002R\u0011\u0010\u0011\u001a\u00020\u0012¢\u0006\b\n\u0000\u001a\u0004\b\u0013\u0010\u0014¨\u0006\u0015"}, d2 = {"kntr/app/ad/domain/adextra/handler/FollowingDetailHandler.Response.DynamicReq.$serializer", "Lkotlinx/serialization/internal/GeneratedSerializer;", "Lkntr/app/ad/domain/adextra/handler/FollowingDetailHandler$Response$DynamicReq;", "<init>", "()V", "childSerializers", RoomRecommendViewModel.EMPTY_CURSOR, "Lkotlinx/serialization/KSerializer;", "()[Lkotlinx/serialization/KSerializer;", "deserialize", "decoder", "Lkotlinx/serialization/encoding/Decoder;", "serialize", RoomRecommendViewModel.EMPTY_CURSOR, "encoder", "Lkotlinx/serialization/encoding/Encoder;", "value", "descriptor", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "adextra_debug"}, k = 1, mv = {2, 2, 0}, xi = 48)
@Deprecated(level = DeprecationLevel.HIDDEN, message = "This synthesized declaration should not be used directly")
public final /* synthetic */ class FollowingDetailHandler$Response$DynamicReq$$serializer implements GeneratedSerializer<FollowingDetailHandler.Response.DynamicReq> {
    public static final FollowingDetailHandler$Response$DynamicReq$$serializer INSTANCE = new FollowingDetailHandler$Response$DynamicReq$$serializer();
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.ad.domain.adextra.handler.FollowingDetailHandler.Response.DynamicReq", INSTANCE, 6);
    ...
    private FollowingDetailHandler$Response$DynamicReq$$serializer() {
    }
    ...
    public final FollowingDetailHandler.Response.DynamicReq deserialize(Decoder decoder) {
        String str;
        Long l;
            ...
            while (z) {
                ...
                switch (decodeElementIndex) {
                    ...
                    case 4:
                        ...
                        i3 |= 16;
                    case 5:
                        l4 = (Long) beginStructure.decodeNullableSerializableElement(serialDescriptor, i2, LongSerializer.INSTANCE, l4);
                        i3 |= 32;
                    default:
        ...
        return new FollowingDetailHandler.Response.DynamicReq(i, str2, str3, jsonElement, l2, str, l, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, FollowingDetailHandler.Response.DynamicReq value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        FollowingDetailHandler.Response.DynamicReq.write$Self$adextra_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
