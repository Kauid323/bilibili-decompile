...
@DebugMetadata(c = "kntr.app.ad.domain.inspector.AdInspectorManager$addUIReportJob$1$1", f = "AdInspectorManager.kt", i = {}, l = {132}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class AdInspectorManager$addUIReportJob$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ UIReportJob $job;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AdInspectorManager$addUIReportJob$1$1(UIReportJob uIReportJob, Continuation<? super AdInspectorManager$addUIReportJob$1$1> continuation) {
        super(2, continuation);
        this.$job = uIReportJob;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AdInspectorManager$addUIReportJob$1$1(this.$job, continuation);
    }
    ...
    @DebugMetadata(c = "kntr.app.ad.domain.inspector.AdInspectorManager$addUIReportJob$1$1$1", f = "AdInspectorManager.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    /* renamed from: kntr.app.ad.domain.inspector.AdInspectorManager$addUIReportJob$1$1$1  reason: invalid class name */
