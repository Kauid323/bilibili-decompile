...
@DebugMetadata(c = "kntr.app.ad.domain.inspector.AdInspectorManager$addFeeReportJob$1$1", f = "AdInspectorManager.kt", i = {}, l = {109}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class AdInspectorManager$addFeeReportJob$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ FeeReportJob $job;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AdInspectorManager$addFeeReportJob$1$1(FeeReportJob feeReportJob, Continuation<? super AdInspectorManager$addFeeReportJob$1$1> continuation) {
        super(2, continuation);
        this.$job = feeReportJob;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AdInspectorManager$addFeeReportJob$1$1(this.$job, continuation);
    }
    ...
    @DebugMetadata(c = "kntr.app.ad.domain.inspector.AdInspectorManager$addFeeReportJob$1$1$1", f = "AdInspectorManager.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    /* renamed from: kntr.app.ad.domain.inspector.AdInspectorManager$addFeeReportJob$1$1$1  reason: invalid class name */
