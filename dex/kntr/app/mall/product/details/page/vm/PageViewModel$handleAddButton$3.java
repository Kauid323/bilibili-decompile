...
@DebugMetadata(c = "kntr.app.mall.product.details.page.vm.PageViewModel$handleAddButton$3", f = "PageViewModel.kt", i = {}, l = {1425}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class PageViewModel$handleAddButton$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public PageViewModel$handleAddButton$3(FooterFloor.PurchaseButton purchaseButton, PageViewModel pageViewModel, Continuation<? super PageViewModel$handleAddButton$3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new PageViewModel$handleAddButton$3(this.$model, this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        if (code != null && code.longValue() == 0) {
            ...
            AddCartApiService.AddCartData data = response.getData();
            String msg = data != null ? data.getCodeMsg() : null;
            String str = msg;
            ...
            if (z) {
                ...
                pageViewModel.showToast$product_details_page_debug(msg);
            }
        }
