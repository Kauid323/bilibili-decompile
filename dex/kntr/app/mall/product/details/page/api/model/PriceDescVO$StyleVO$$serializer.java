...
public final /* synthetic */ class PriceDescVO$StyleVO$$serializer implements GeneratedSerializer<PriceDescVO.StyleVO> {
    public static final int $stable;
    public static final PriceDescVO$StyleVO$$serializer INSTANCE = new PriceDescVO$StyleVO$$serializer();
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.mall.product.details.page.api.model.PriceDescVO.StyleVO", INSTANCE, 2);
    ...
    private PriceDescVO$StyleVO$$serializer() {
    }
    ...
    public final PriceDescVO.StyleVO deserialize(Decoder decoder) {
        String str;
        String str2;
        int i;
        ...
        return new PriceDescVO.StyleVO(i, str, str2, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, PriceDescVO.StyleVO value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        PriceDescVO.StyleVO.write$Self$product_details_page_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
