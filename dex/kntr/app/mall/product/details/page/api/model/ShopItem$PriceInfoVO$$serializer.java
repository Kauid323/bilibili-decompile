...
public final /* synthetic */ class ShopItem$PriceInfoVO$$serializer implements GeneratedSerializer<ShopItem.PriceInfoVO> {
    public static final int $stable;
    public static final ShopItem$PriceInfoVO$$serializer INSTANCE = new ShopItem$PriceInfoVO$$serializer();
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.mall.product.details.page.api.model.ShopItem.PriceInfoVO", INSTANCE, 6);
    ...
    private ShopItem$PriceInfoVO$$serializer() {
    }

    public final KSerializer<?>[] childSerializers() {
        Lazy[] lazyArr;
        lazyArr = ShopItem.PriceInfoVO.$childSerializers;
        return new KSerializer[]{BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable((KSerializer) lazyArr[1].getValue()), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE)};
    }

    public final ShopItem.PriceInfoVO deserialize(Decoder decoder) {
        Lazy[] lazyArr;
        String str;
        String str2;
        String str3;
        ...
        return new ShopItem.PriceInfoVO(i, str5, list, str4, str3, str2, str, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, ShopItem.PriceInfoVO value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        ShopItem.PriceInfoVO.write$Self$product_details_page_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
