...
public final /* synthetic */ class DetailDescFloor$$serializer implements GeneratedSerializer<DetailDescFloor> {
    public static final int $stable;
    public static final DetailDescFloor$$serializer INSTANCE = new DetailDescFloor$$serializer();
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.mall.product.details.page.api.model.DetailDescFloor", INSTANCE, 5);
        ...
        pluginGeneratedSerialDescriptor.addElement("itemsAttrGroups", true);
        descriptor = pluginGeneratedSerialDescriptor;
        $stable = 8;
    }

    private DetailDescFloor$$serializer() {
    }

    public final KSerializer<?>[] childSerializers() {
        Lazy[] lazyArr;
        lazyArr = DetailDescFloor.$childSerializers;
        return new KSerializer[]{BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable((KSerializer) lazyArr[3].getValue()), BuiltinSerializersKt.getNullable((KSerializer) lazyArr[4].getValue())};
    }

    public final DetailDescFloor deserialize(Decoder decoder) {
        Lazy[] lazyArr;
        List list;
        List list2;
        String str;
        ...
        return new DetailDescFloor(i, str3, str, str2, list, list2, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, DetailDescFloor value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        DetailDescFloor.write$Self$product_details_page_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
