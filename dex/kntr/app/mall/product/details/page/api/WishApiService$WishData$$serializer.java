...
public final /* synthetic */ class WishApiService$WishData$$serializer implements GeneratedSerializer<WishApiService.WishData> {
    public static final int $stable;
    public static final WishApiService$WishData$$serializer INSTANCE = new WishApiService$WishData$$serializer();
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.mall.product.details.page.api.WishApiService.WishData", INSTANCE, 4);
        pluginGeneratedSerialDescriptor.addElement("count", true);
        pluginGeneratedSerialDescriptor.addElement("hasLiked", true);
        pluginGeneratedSerialDescriptor.addElement("userVOS", true);
        pluginGeneratedSerialDescriptor.addElement("users", true);
        descriptor = pluginGeneratedSerialDescriptor;
        $stable = 8;
    }

    private WishApiService$WishData$$serializer() {
    }

    public final KSerializer<?>[] childSerializers() {
        Lazy[] lazyArr;
        lazyArr = WishApiService.WishData.$childSerializers;
        return new KSerializer[]{BuiltinSerializersKt.getNullable(IntSerializer.INSTANCE), BuiltinSerializersKt.getNullable(BooleanSerializer.INSTANCE), BuiltinSerializersKt.getNullable((KSerializer) lazyArr[2].getValue()), BuiltinSerializersKt.getNullable((KSerializer) lazyArr[3].getValue())};
    }

    public final WishApiService.WishData deserialize(Decoder decoder) {
        Lazy[] lazyArr;
        int i;
        Integer num;
        Boolean bool;
        ...
        return new WishApiService.WishData(i, num, bool, list, list2, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, WishApiService.WishData value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        WishApiService.WishData.write$Self$product_details_page_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
