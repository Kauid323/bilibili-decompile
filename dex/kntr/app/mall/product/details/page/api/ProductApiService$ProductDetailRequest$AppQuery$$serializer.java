...
@Metadata(d1 = {"\u00006\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u0015\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00070\u0006¢\u0006\u0002\u0010\bJ\u000e\u0010\t\u001a\u00020\u00022\u0006\u0010\n\u001a\u00020\u000bJ\u0016\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u0002R\u0011\u0010\u0011\u001a\u00020\u0012¢\u0006\b\n\u0000\u001a\u0004\b\u0013\u0010\u0014¨\u0006\u0015"}, d2 = {"kntr/app/mall/product/details/page/api/ProductApiService.ProductDetailRequest.AppQuery.$serializer", "Lkotlinx/serialization/internal/GeneratedSerializer;", "Lkntr/app/mall/product/details/page/api/ProductApiService$ProductDetailRequest$AppQuery;", "<init>", "()V", "childSerializers", "", "Lkotlinx/serialization/KSerializer;", "()[Lkotlinx/serialization/KSerializer;", "deserialize", "decoder", "Lkotlinx/serialization/encoding/Decoder;", "serialize", "", "encoder", "Lkotlinx/serialization/encoding/Encoder;", "value", "descriptor", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "product-details-page_debug"}, k = 1, mv = {2, 2, 0}, xi = ConstantsKt.OGV_UPDATE_CALENDAR_CARD_COVER_WIDTH)
@Deprecated(level = DeprecationLevel.HIDDEN, message = "This synthesized declaration should not be used directly")
public final /* synthetic */ class ProductApiService$ProductDetailRequest$AppQuery$$serializer implements GeneratedSerializer<ProductApiService.ProductDetailRequest.AppQuery> {
    public static final int $stable;
    public static final ProductApiService$ProductDetailRequest$AppQuery$$serializer INSTANCE = new ProductApiService$ProductDetailRequest$AppQuery$$serializer();
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.mall.product.details.page.api.ProductApiService.ProductDetailRequest.AppQuery", INSTANCE, 6);
        pluginGeneratedSerialDescriptor.addElement("build", true);
        pluginGeneratedSerialDescriptor.addElement("isDegrate", true);
        pluginGeneratedSerialDescriptor.addElement("mobi_app", true);
        pluginGeneratedSerialDescriptor.addElement("mversion", true);
    ...
    private ProductApiService$ProductDetailRequest$AppQuery$$serializer() {
    }
    ...
    public final ProductApiService.ProductDetailRequest.AppQuery deserialize(Decoder decoder) {
        String str;
        String str2;
        String str3;
        Integer num;
        ...
        return new ProductApiService.ProductDetailRequest.AppQuery(i, str4, bool, str3, num, str, str2, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, ProductApiService.ProductDetailRequest.AppQuery value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        ProductApiService.ProductDetailRequest.AppQuery.write$Self$product_details_page_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
