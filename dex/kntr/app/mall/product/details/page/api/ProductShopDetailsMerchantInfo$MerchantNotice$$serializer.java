...
public final /* synthetic */ class ProductShopDetailsMerchantInfo$MerchantNotice$$serializer implements GeneratedSerializer<ProductShopDetailsMerchantInfo.MerchantNotice> {
    public static final int $stable;
    public static final ProductShopDetailsMerchantInfo$MerchantNotice$$serializer INSTANCE = new ProductShopDetailsMerchantInfo$MerchantNotice$$serializer();
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.mall.product.details.page.api.ProductShopDetailsMerchantInfo.MerchantNotice", INSTANCE, 3);
    ...
    private ProductShopDetailsMerchantInfo$MerchantNotice$$serializer() {
    }
    ...
    public final ProductShopDetailsMerchantInfo.MerchantNotice deserialize(Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new ProductShopDetailsMerchantInfo.MerchantNotice(i, str, str2, str3, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, ProductShopDetailsMerchantInfo.MerchantNotice value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        ProductShopDetailsMerchantInfo.MerchantNotice.write$Self$product_details_page_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
