...
public final /* synthetic */ class CrowdfundingProgressFloor$ProgressItem$UserInfo$$serializer implements GeneratedSerializer<CrowdfundingProgressFloor.ProgressItem.UserInfo> {
    public static final int $stable;
    public static final CrowdfundingProgressFloor$ProgressItem$UserInfo$$serializer INSTANCE = new CrowdfundingProgressFloor$ProgressItem$UserInfo$$serializer();
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.mall.product.details.page.api.model.CrowdfundingProgressFloor.ProgressItem.UserInfo", INSTANCE, 3);
    ...
    private CrowdfundingProgressFloor$ProgressItem$UserInfo$$serializer() {
    }
    ...
    public final CrowdfundingProgressFloor.ProgressItem.UserInfo deserialize(Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new CrowdfundingProgressFloor.ProgressItem.UserInfo(i, str, str2, str3, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, CrowdfundingProgressFloor.ProgressItem.UserInfo value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        CrowdfundingProgressFloor.ProgressItem.UserInfo.write$Self$product_details_page_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
