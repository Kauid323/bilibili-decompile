...
public final /* synthetic */ class ActivityInfoFloor$InstantDiscountActivityInfo$$serializer implements GeneratedSerializer<ActivityInfoFloor.InstantDiscountActivityInfo> {
    public static final int $stable;
    public static final ActivityInfoFloor$InstantDiscountActivityInfo$$serializer INSTANCE = new ActivityInfoFloor$InstantDiscountActivityInfo$$serializer();
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.mall.product.details.page.api.model.ActivityInfoFloor.InstantDiscountActivityInfo", INSTANCE, 8);
        pluginGeneratedSerialDescriptor.addElement("discountPrice", true);
        pluginGeneratedSerialDescriptor.addElement("endTime", true);
        pluginGeneratedSerialDescriptor.addElement("promoStatus", true);
        pluginGeneratedSerialDescriptor.addElement("promotionType", true);
    ...
    private ActivityInfoFloor$InstantDiscountActivityInfo$$serializer() {
    }
    ...
    public final ActivityInfoFloor.InstantDiscountActivityInfo deserialize(Decoder decoder) {
        Long l;
        String str;
        String str2;
        int i;
            ...
            while (z) {
                ...
                switch (decodeElementIndex) {
                    ...
                    case AdditionalButton.CLICK_TYPE_FIELD_NUMBER /* 7 */:
                        l3 = (Long) beginStructure.decodeNullableSerializableElement(serialDescriptor, i2, LongSerializer.INSTANCE, l3);
                        i3 |= 128;
                        break;
                    default:
        ...
        return new ActivityInfoFloor.InstantDiscountActivityInfo(i, num, l2, str4, str5, str3, str2, str, l, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, ActivityInfoFloor.InstantDiscountActivityInfo value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        ActivityInfoFloor.InstantDiscountActivityInfo.write$Self$product_details_page_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
