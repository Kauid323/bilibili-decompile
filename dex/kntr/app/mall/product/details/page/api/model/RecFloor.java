...
public final class RecFloor implements FloorModel {
    ...
    private static final Lazy<KSerializer<Object>>[] $childSerializers = {null, null, null, null, LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0() { // from class: kntr.app.mall.product.details.page.api.model.RecFloor$$ExternalSyntheticLambda0
        public final Object invoke() {
            KSerializer _childSerializers$_anonymous_;
            _childSerializers$_anonymous_ = RecFloor._childSerializers$_anonymous_();
    ...
    /* compiled from: RecFloor.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lkntr/app/mall/product/details/page/api/model/RecFloor$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lkntr/app/mall/product/details/page/api/model/RecFloor;", "product-details-page_debug"}, k = 1, mv = {2, 2, 0}, xi = ConstantsKt.OGV_UPDATE_CALENDAR_CARD_COVER_WIDTH)
    ...
    public static final class Companion {
        ...
        public final KSerializer<RecFloor> serializer() {
            return RecFloor$$serializer.INSTANCE;
        }
    }

    public /* synthetic */ RecFloor(int seen0, String floorKey, String floorIcon, String bgImgUrl, TextColorModel desc, List items, String jumpUrl, TextColorModel subTitle, TextColorModel title, SerializationConstructorMarker serializationConstructorMarker) {
        if ((seen0 & 1) == 0) {
            this.floorKey = null;
        } else {
    ...
    public RecFloor(String floorKey, String floorIcon, String bgImgUrl, TextColorModel desc, List<ShopItem> list, String jumpUrl, TextColorModel subTitle, TextColorModel title) {
        this.floorKey = floorKey;
        this.floorIcon = floorIcon;
        this.bgImgUrl = bgImgUrl;
        this.desc = desc;
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$product_details_page_debug(RecFloor self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public /* synthetic */ RecFloor(String str, String str2, String str3, TextColorModel textColorModel, List list, String str4, TextColorModel textColorModel2, TextColorModel textColorModel3, int i, DefaultConstructorMarker defaultConstructorMarker) {
