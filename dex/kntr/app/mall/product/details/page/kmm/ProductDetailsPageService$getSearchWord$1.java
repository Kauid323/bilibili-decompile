...
@DebugMetadata(c = "kntr.app.mall.product.details.page.kmm.ProductDetailsPageService$getSearchWord$1", f = "ProductDetailsPageService.kt", i = {}, l = {300}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class ProductDetailsPageService$getSearchWord$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ ProductDetailsPageService this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ProductDetailsPageService$getSearchWord$1(ProductDetailsPageService productDetailsPageService, Continuation<? super ProductDetailsPageService$getSearchWord$1> continuation) {
        super(2, continuation);
        this.this$0 = productDetailsPageService;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ProductDetailsPageService$getSearchWord$1(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        SearchTextApiService.SearchTextResponse response;
        ...
        try {
            ...
            response = (SearchTextApiService.SearchTextResponse) searchText$product_details_page_debug$default;
        } catch (Exception e) {
            ProductDetailsPageService productDetailsPageService = this.this$0;
            $receiver$iv = this.this$0._searchWordFlow;
            ...
            String errorMessage$iv = e.getMessage();
            if (errorMessage$iv == null) {
                errorMessage$iv = "请求异常";
            }
            do {
        ...
        if (response.getCode() == 0 && response.getData() != null) {
            ...
            $receiver$iv2 = this.this$0._searchWordFlow;
            ...
            do {
                ...
                nextValue$iv$iv2 = new ProductDetailsPageDataState(pageStatus$iv2, response, null);
