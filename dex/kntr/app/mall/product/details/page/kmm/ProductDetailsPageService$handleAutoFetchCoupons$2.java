...
@DebugMetadata(c = "kntr.app.mall.product.details.page.kmm.ProductDetailsPageService$handleAutoFetchCoupons$2", f = "ProductDetailsPageService.kt", i = {}, l = {724}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class ProductDetailsPageService$handleAutoFetchCoupons$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ProductDetailsPageService$handleAutoFetchCoupons$2(CouponPackageInfoModel couponPackageInfoModel, List<? extends Map<String, String>> list, ProductDetailsPageService productDetailsPageService, Continuation<? super ProductDetailsPageService$handleAutoFetchCoupons$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ProductDetailsPageService$handleAutoFetchCoupons$2(this.$upCouponPackageInfo, this.$sourceInfos, this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        if (code != null && code.longValue() == 0) {
            ...
            if (!(successReceivedAuthorityIds == null || successReceivedAuthorityIds.isEmpty()) && Intrinsics.areEqual(this.$upCouponPackageInfo.getPopup(), Boxing.boxBoolean(true))) {
                $this$update$iv = this.this$0._upCouponDisplayStateFlow;
