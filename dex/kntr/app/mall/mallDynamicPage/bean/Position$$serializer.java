...
public final /* synthetic */ class Position$$serializer implements GeneratedSerializer<Position> {
    ...
    static {
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("kntr.app.mall.mallDynamicPage.bean.Position", INSTANCE, 2);
    ...
    public final Position deserialize(Decoder decoder) {
        Integer num;
        Integer num2;
        int i;
        ...
        return new Position(i, num, num2, (SerializationConstructorMarker) null);
    }

    public final void serialize(Encoder encoder, Position value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        Position.write$Self$mallDynamicPage_debug(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
