...
public final class CommonRes {
    ...
    public final String getString(StringResource res) {
        ...
        return (String) CoroutineExJvmKt.variantRunBlocking$default((CoroutineContext) null, new CommonRes$getString$1(res, null), 1, (Object) null);
    }

    public final String getString(StringResource res, Object... args) {
        Intrinsics.checkNotNullParameter(res, "res");
        Intrinsics.checkNotNullParameter(args, "args");
        return (String) CoroutineExJvmKt.variantRunBlocking$default((CoroutineContext) null, new CommonRes$getString$2(res, args, null), 1, (Object) null);
    }
    ...
    public final String getPluralString(PluralStringResource res, int quantity) {
        Intrinsics.checkNotNullParameter(res, "res");
        return (String) CoroutineExJvmKt.variantRunBlocking$default((CoroutineContext) null, new CommonRes$getPluralString$1(res, quantity, null), 1, (Object) null);
    }

    public final String getPluralString(PluralStringResource res, int quantity, Object... args) {
        Intrinsics.checkNotNullParameter(res, "res");
        Intrinsics.checkNotNullParameter(args, "args");
        return (String) CoroutineExJvmKt.variantRunBlocking$default((CoroutineContext) null, new CommonRes$getPluralString$2(res, quantity, args, null), 1, (Object) null);
    }
