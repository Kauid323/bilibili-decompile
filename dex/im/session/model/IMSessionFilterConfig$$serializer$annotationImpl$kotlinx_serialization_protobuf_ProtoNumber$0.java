...
public final /* synthetic */ class IMSessionFilterConfig$$serializer$annotationImpl$kotlinx_serialization_protobuf_ProtoNumber$0 implements ProtoNumber {
    private final /* synthetic */ int number;

    public IMSessionFilterConfig$$serializer$annotationImpl$kotlinx_serialization_protobuf_ProtoNumber$0(int i2) {
        this.number = i2;
    }
