...
import com.bapis.bilibili.app.im.v1.KSessionMainReq;
...
/* compiled from: IMSessionMossRequestService.kt */
@Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0011\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0016\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\tH\u0096@¢\u0006\u0002\u0010\nR\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000b"}, d2 = {"Lim/session/service/request/IMSessionMossRequestService;", "Lim/session/service/IMSessionRequestServiceLike;", "summaryService", "Lim/session/service/IMSummaryCacheService;", "<init>", "(Lim/session/service/IMSummaryCacheService;)V", "load", "Lim/session/model/IMSessionPageData;", "param", "Lim/session/service/IMSessionRequestParam;", "(Lim/session/service/IMSessionRequestParam;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "session_debug"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class IMSessionMossRequestService implements IMSessionRequestServiceLike {
    private final IMSummaryCacheService summaryService;

    @Inject
    public IMSessionMossRequestService(IMSummaryCacheService summaryService) {
    ...
    */
    public Object load(IMSessionRequestParam param, Continuation<? super IMSessionPageData> continuation) {
        ...
        if (continuation instanceof IMSessionMossRequestService$load$1) {
            $continuation = (IMSessionMossRequestService$load$1) continuation;
            if (($continuation.label & Integer.MIN_VALUE) != 0) {
                ...
                switch ($continuation.label) {
                    case 0:
                        ...
                        KSessionMainReq req2 = new KSessionMainReq(IMSessionStateMachineKt.imMode(KRestrictedMode.Companion), param.getPaginationParams(), param.getFilterType());
                        KimMoss $this$iv = new KimMoss((KCallOptions) null, 1, (DefaultConstructorMarker) null);
                        DeserializationStrategy respSerializer$iv = IMSessionHomePageDataSerializer.INSTANCE;
                        SerializationStrategy reqSerializer$iv = KSessionMainReq.Companion.serializer();
                        ...
                        KMossResponseHandler p3$iv = new KMossResponseHandler<IMSessionPageData>() { // from class: im.session.service.request.IMSessionMossRequestService$load$$inlined$sessionMain$default$1
                        ...
                        $this$iv.sessionMain(req2, reqSerializer$iv, respSerializer$iv, p3$iv);
                    ...
                    case 1:
                        ...
                        KSessionMainReq kSessionMainReq = (KSessionMainReq) $continuation.L$3;
                        KimMoss kimMoss = (KimMoss) $continuation.L$2;
                        req = (KSessionMainReq) $continuation.L$1;
                    ...
                    case 2:
                        ...
                        KSessionMainReq kSessionMainReq2 = (KSessionMainReq) $continuation.L$1;
        ...
        $continuation = new IMSessionMossRequestService$load$1(this, continuation);
