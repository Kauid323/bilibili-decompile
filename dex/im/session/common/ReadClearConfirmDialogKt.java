...
/* compiled from: ReadClearConfirmDialog.kt */
@Metadata(d1 = {"\u0000\u001a\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\u001a)\u0010\u0000\u001a\u00020\u00012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u00032\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00010\u0006H\u0001¢\u0006\u0002\u0010\u0007\u001a)\u0010\b\u001a\u00020\u00012\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00010\u00062\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00010\u0006H\u0001¢\u0006\u0002\u0010\n¨\u0006\u000b"}, d2 = {"ReadClearConfirmDialog", "", "show", "Landroidx/compose/runtime/MutableState;", "", "onConfirmed", "Lkotlin/Function0;", "(Landroidx/compose/runtime/MutableState;Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;I)V", "ReadClearConfirmContent", "onCancel", "(Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;I)V", "session-ui_debug"}, k = 2, mv = {2, 2, 0}, xi = 48)
public final class ReadClearConfirmDialogKt {
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit ReadClearConfirmContent$lambda$0(Function0 function0, Function0 function02, int i2, Composer composer, int i3) {
        ReadClearConfirmContent(function0, function02, composer, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit ReadClearConfirmDialog$lambda$2(MutableState mutableState, Function0 function0, int i2, Composer composer, int i3) {
        ReadClearConfirmDialog(mutableState, function0, composer, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
        return Unit.INSTANCE;
    }

    public static final void ReadClearConfirmDialog(final MutableState<Boolean> mutableState, final Function0<Unit> function0, Composer $composer, final int $changed) {
        Intrinsics.checkNotNullParameter(mutableState, "show");
        Intrinsics.checkNotNullParameter(function0, "onConfirmed");
        Composer $composer2 = $composer.startRestartGroup(1077236122);
        ComposerKt.sourceInformation($composer2, "C(ReadClearConfirmDialog)N(show,onConfirmed)22@762L83,27@948L62,27@850L160:ReadClearConfirmDialog.kt#yqxgzx");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (!$composer2.shouldExecute(($dirty2 & 19) != 18, $dirty2 & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1077236122, $dirty2, -1, "im.session.common.ReadClearConfirmDialog (ReadClearConfirmDialog.kt:20)");
            }
            ComposerKt.sourceInformationMarkerStart($composer2, 136798861, "CC(remember):ReadClearConfirmDialog.kt#9igjgp");
            Object it$iv = $composer2.rememberedValue();
            if (it$iv == Composer.Companion.getEmpty()) {
                Object value$iv = new Function0() { // from class: im.session.common.ReadClearConfirmDialogKt$$ExternalSyntheticLambda0
                    public final Object invoke() {
                        Unit ReadClearConfirmDialog$lambda$0$0;
                        ReadClearConfirmDialog$lambda$0$0 = ReadClearConfirmDialogKt.ReadClearConfirmDialog$lambda$0$0(mutableState);
                        return ReadClearConfirmDialog$lambda$0$0;
                    }
                };
            ...
            AndroidDialog_androidKt.Dialog(onCancel, new DialogProperties(false, false, false, 5, (DefaultConstructorMarker) null), ComposableLambdaKt.rememberComposableLambda(-541249551, true, new Function2() { // from class: im.session.common.ReadClearConfirmDialogKt$$ExternalSyntheticLambda1
                public final Object invoke(Object obj, Object obj2) {
                    Unit ReadClearConfirmDialog$lambda$1;
                    ReadClearConfirmDialog$lambda$1 = ReadClearConfirmDialogKt.ReadClearConfirmDialog$lambda$1(onCancel, function0, (Composer) obj, ((Integer) obj2).intValue());
                    return ReadClearConfirmDialog$lambda$1;
                }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: im.session.common.ReadClearConfirmDialogKt$$ExternalSyntheticLambda2
                public final Object invoke(Object obj, Object obj2) {
                    Unit ReadClearConfirmDialog$lambda$2;
                    ReadClearConfirmDialog$lambda$2 = ReadClearConfirmDialogKt.ReadClearConfirmDialog$lambda$2(mutableState, function0, $changed, (Composer) obj, ((Integer) obj2).intValue());
                    return ReadClearConfirmDialog$lambda$2;
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit ReadClearConfirmDialog$lambda$0$0(MutableState $show) {
        $show.setValue(false);
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit ReadClearConfirmDialog$lambda$1(Function0 $onCancel, Function0 $onConfirmed, Composer $composer, int $changed) {
        ComposerKt.sourceInformation($composer, "C28@958L46:ReadClearConfirmDialog.kt#yqxgzx");
        if (!$composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            $composer.skipToGroupEnd();
        } else {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-541249551, $changed, -1, "im.session.common.ReadClearConfirmDialog.<anonymous> (ReadClearConfirmDialog.kt:28)");
            }
            ReadClearConfirmContent($onCancel, $onConfirmed, $composer, 6);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void ReadClearConfirmContent(final Function0<Unit> function0, final Function0<Unit> function02, Composer $composer, final int $changed) {
        Intrinsics.checkNotNullParameter(function0, "onCancel");
        Intrinsics.checkNotNullParameter(function02, "onConfirmed");
        Composer $composer2 = $composer.startRestartGroup(2073569560);
        ComposerKt.sourceInformation($composer2, "C(ReadClearConfirmContent)N(onCancel,onConfirmed)38@1164L48,39@1238L49,40@1314L57,41@1398L57,37@1127L410:ReadClearConfirmDialog.kt#yqxgzx");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (!$composer2.shouldExecute(($dirty & 19) != 18, $dirty & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(2073569560, $dirty, -1, "im.session.common.ReadClearConfirmContent (ReadClearConfirmDialog.kt:36)");
            }
            final String titleString$iv = StringResourcesKt.stringResource(String0_commonMainKt.getIm_global_string_24(Res.string.INSTANCE), $composer2, 0);
            final String contentString$iv = StringResourcesKt.stringResource(String1_commonMainKt.getIm_global_string_871(Res.string.INSTANCE), $composer2, 0);
            ...
            final String positiveString$iv = StringResourcesKt.stringResource(bili.resource.common.String0_commonMainKt.getCommon_global_string_365(Res.string.INSTANCE), $composer2, 0);
            ...
            DialogContent_androidKt.DialogContent(ComposableLambdaKt.rememberComposableLambda(93781831, true, new Function2<Composer, Integer, Unit>() { // from class: im.session.common.ReadClearConfirmDialogKt$ReadClearConfirmContent$$inlined$DialogContent$1
            ...
            }, $composer2, 54), modifier$iv, ComposableLambdaKt.rememberComposableLambda(1990761289, true, new Function2<Composer, Integer, Unit>() { // from class: im.session.common.ReadClearConfirmDialogKt$ReadClearConfirmContent$$inlined$DialogContent$2
                public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                    invoke((Composer) p1, ((Number) p2).intValue());
                    return Unit.INSTANCE;
                }
        ...
        ScopeUpdateScope endRestartGroup = $composer2.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: im.session.common.ReadClearConfirmDialogKt$$ExternalSyntheticLambda3
                public final Object invoke(Object obj, Object obj2) {
                    Unit ReadClearConfirmContent$lambda$0;
                    ReadClearConfirmContent$lambda$0 = ReadClearConfirmDialogKt.ReadClearConfirmContent$lambda$0(function0, function02, $changed, (Composer) obj, ((Integer) obj2).intValue());
                    return ReadClearConfirmContent$lambda$0;
                }
            });
        }
    }
