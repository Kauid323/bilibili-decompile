...
/* compiled from: IMSettingConfirmDialog.kt */
@Metadata(d1 = {"\u0000\u0018\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a9\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00032\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00010\u00062\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00010\u0006H\u0007¢\u0006\u0002\u0010\b¨\u0006\t"}, d2 = {"IMSettingConfirmDialog", "", "title", "", "subtitle", "onCancel", "Lkotlin/Function0;", "onConfirm", "(Ljava/lang/String;Ljava/lang/String;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;I)V", "ui_debug"}, k = 2, mv = {2, 2, 0}, xi = 48)
public final class IMSettingConfirmDialogKt {
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit IMSettingConfirmDialog$lambda$2(String str, String str2, Function0 function0, Function0 function02, int i2, Composer composer, int i3) {
        IMSettingConfirmDialog(str, str2, function0, function02, composer, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
        return Unit.INSTANCE;
    }

    public static final void IMSettingConfirmDialog(final String title, final String subtitle, final Function0<Unit> function0, final Function0<Unit> function02, Composer $composer, final int $changed) {
        ...
        Composer $composer2 = $composer.startRestartGroup(282410730);
        ComposerKt.sourceInformation($composer2, "C(IMSettingConfirmDialog)N(title,subtitle,onCancel,onConfirm)17@426L55,21@559L304,15@379L484:IMSettingConfirmDialog.kt#w7mava");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (!$composer2.shouldExecute(($dirty2 & 1171) != 1170, $dirty2 & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(282410730, $dirty2, -1, "im.setting.IMSettingConfirmDialog (IMSettingConfirmDialog.kt:14)");
            }
            ComposerKt.sourceInformationMarkerStart($composer2, 813777601, "CC(remember):IMSettingConfirmDialog.kt#9igjgp");
            Object it$iv = $composer2.rememberedValue();
            if (it$iv == Composer.Companion.getEmpty()) {
                Object value$iv = new Function0() { // from class: im.setting.IMSettingConfirmDialogKt$$ExternalSyntheticLambda0
                    public final Object invoke() {
                        Unit IMSettingConfirmDialog$lambda$0$0;
                        IMSettingConfirmDialog$lambda$0$0 = IMSettingConfirmDialogKt.IMSettingConfirmDialog$lambda$0$0(function0);
                        return IMSettingConfirmDialog$lambda$0$0;
                    }
                };
            ...
            AndroidDialog_androidKt.Dialog((Function0) it$iv, new DialogProperties(false, false, false, 5, (DefaultConstructorMarker) null), ComposableLambdaKt.rememberComposableLambda(-771221055, true, new Function2() { // from class: im.setting.IMSettingConfirmDialogKt$$ExternalSyntheticLambda1
                public final Object invoke(Object obj, Object obj2) {
                    Unit IMSettingConfirmDialog$lambda$1;
                    IMSettingConfirmDialog$lambda$1 = IMSettingConfirmDialogKt.IMSettingConfirmDialog$lambda$1(title, subtitle, function0, function02, (Composer) obj, ((Integer) obj2).intValue());
                    return IMSettingConfirmDialog$lambda$1;
                }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: im.setting.IMSettingConfirmDialogKt$$ExternalSyntheticLambda2
                public final Object invoke(Object obj, Object obj2) {
                    Unit IMSettingConfirmDialog$lambda$2;
                    IMSettingConfirmDialog$lambda$2 = IMSettingConfirmDialogKt.IMSettingConfirmDialog$lambda$2(title, subtitle, function0, function02, $changed, (Composer) obj, ((Integer) obj2).intValue());
                    return IMSettingConfirmDialog$lambda$2;
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit IMSettingConfirmDialog$lambda$0$0(Function0 $onCancel) {
        $onCancel.invoke();
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit IMSettingConfirmDialog$lambda$1(final String $title, final String $subtitle, final Function0 $onCancel, final Function0 $onConfirm, Composer $composer, int $changed) {
        ComposerKt.sourceInformation($composer, "C26@671L63,30@782L64,22@569L288:IMSettingConfirmDialog.kt#w7mava");
        if ($composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-771221055, $changed, -1, "im.setting.IMSettingConfirmDialog.<anonymous> (IMSettingConfirmDialog.kt:22)");
            }
            ComposerKt.sourceInformationMarkerStart($composer, 1885912000, "CC(remember):IMSettingConfirmDialog.kt#9igjgp");
            Object it$iv = $composer.rememberedValue();
            if (it$iv == Composer.Companion.getEmpty()) {
                Object value$iv = new Function0() { // from class: im.setting.IMSettingConfirmDialogKt$$ExternalSyntheticLambda3
                    public final Object invoke() {
                        Unit IMSettingConfirmDialog$lambda$1$0$0;
                        IMSettingConfirmDialog$lambda$1$0$0 = IMSettingConfirmDialogKt.IMSettingConfirmDialog$lambda$1$0$0($onCancel);
                        return IMSettingConfirmDialog$lambda$1$0$0;
                    }
                };
                $composer.updateRememberedValue(value$iv);
                it$iv = value$iv;
            }
            final Function0 onNegativeClick$iv = (Function0) it$iv;
            ComposerKt.sourceInformationMarkerEnd($composer);
            ComposerKt.sourceInformationMarkerStart($composer, 1885915553, "CC(remember):IMSettingConfirmDialog.kt#9igjgp");
            Object it$iv2 = $composer.rememberedValue();
            if (it$iv2 == Composer.Companion.getEmpty()) {
                Object value$iv2 = new Function0() { // from class: im.setting.IMSettingConfirmDialogKt$$ExternalSyntheticLambda4
                    public final Object invoke() {
                        Unit IMSettingConfirmDialog$lambda$1$1$0;
                        IMSettingConfirmDialog$lambda$1$1$0 = IMSettingConfirmDialogKt.IMSettingConfirmDialog$lambda$1$1$0($onConfirm);
                        return IMSettingConfirmDialog$lambda$1$1$0;
                    }
                };
                $composer.updateRememberedValue(value$iv2);
                it$iv2 = value$iv2;
            }
            final Function0 onPositiveClick$iv = (Function0) it$iv2;
            ComposerKt.sourceInformationMarkerEnd($composer);
            ...
            final String negativeString$iv = StringResourcesKt.stringResource(String0_commonMainKt.getCancel(CommonRes.INSTANCE.getString()), $composer, 0);
            final String positiveString$iv = StringResourcesKt.stringResource(String0_commonMainKt.getConfirm(CommonRes.INSTANCE.getString()), $composer, 0);
            DialogContent_androidKt.DialogContent(ComposableLambdaKt.rememberComposableLambda(93781831, true, new Function2<Composer, Integer, Unit>() { // from class: im.setting.IMSettingConfirmDialogKt$IMSettingConfirmDialog$lambda$1$$inlined$DialogContent$1
                ...
                public final void invoke(Composer $composer2, int $changed2) {
                    ...
                    final Function0 function02 = onNegativeClick$iv;
                    Function0 function03 = onPositiveClick$iv;
                    ...
                    if (str3 != null) {
                        ...
                        Modifier modifier$iv4 = ClickableKt.clickable-oSLSa3U$default(RowScope.-CC.weight$default($this$invoke_u24lambda_u240, SizeKt.fillMaxHeight$default(Modifier.Companion, (float) CropImageView.DEFAULT_ASPECT_RATIO, 1, (Object) null), 1.0f, false, 2, (Object) null), false, (String) null, (Role) null, (MutableInteractionSource) null, new Function0<Unit>() { // from class: im.setting.IMSettingConfirmDialogKt$IMSettingConfirmDialog$lambda$1$$inlined$DialogContent$1.2
                            public /* bridge */ /* synthetic */ Object invoke() {
                                m3384invoke();
                                return Unit.INSTANCE;
                            }
            ...
            }, $composer, 54), modifier$iv, ComposableLambdaKt.rememberComposableLambda(1990761289, true, new Function2<Composer, Integer, Unit>() { // from class: im.setting.IMSettingConfirmDialogKt$IMSettingConfirmDialog$lambda$1$$inlined$DialogContent$2
                public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                    invoke((Composer) p1, ((Number) p2).intValue());
                    return Unit.INSTANCE;
                }
            ...
            }, $composer, 54), $composer, ((3456 >> 9) & TbsListener.ErrorCode.DOWNLOAD_OVER_FLOW) | 390, 0);
            ComposerKt.sourceInformationMarkerEnd($composer);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit IMSettingConfirmDialog$lambda$1$0$0(Function0 $onCancel) {
        $onCancel.invoke();
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit IMSettingConfirmDialog$lambda$1$1$0(Function0 $onConfirm) {
        $onConfirm.invoke();
        return Unit.INSTANCE;
    }
}