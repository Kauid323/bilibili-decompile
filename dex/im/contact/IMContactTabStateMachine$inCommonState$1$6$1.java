...
@DebugMetadata(c = "im.contact.IMContactTabStateMachine$inCommonState$1$6$1", f = "IMContactTabStateMachine.kt", i = {0}, l = {75}, m = "invokeSuspend", n = {"state"}, s = {"L$0"}, v = 1)
public final class IMContactTabStateMachine$inCommonState$1$6$1 extends SuspendLambda implements Function2<State<IMContactTabData>, Continuation<? super ChangedState<? extends IMContactTab>>, Object> {
    ...
    public IMContactTabStateMachine$inCommonState$1$6$1(IMContactTabStateMachine iMContactTabStateMachine, Continuation<? super IMContactTabStateMachine$inCommonState$1$6$1> continuation) {
        super(2, continuation);
        this.this$0 = iMContactTabStateMachine;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> iMContactTabStateMachine$inCommonState$1$6$1 = new IMContactTabStateMachine$inCommonState$1$6$1(this.this$0, continuation);
        iMContactTabStateMachine$inCommonState$1$6$1.L$0 = obj;
        return iMContactTabStateMachine$inCommonState$1$6$1;
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.L$0 = state;
                this.label = 1;
                Object m3159load0E7RQCE$contact_debug$default = ContactLoadService.m3159load0E7RQCE$contact_debug$default(contactLoadService, kContactTabType, null, (Continuation) this, 2, null);
                if (m3159load0E7RQCE$contact_debug$default == coroutine_suspended) {
                    return coroutine_suspended;
                }
                loadResult = m3159load0E7RQCE$contact_debug$default;
                break;
            case 1:
                ResultKt.throwOnFailure($result);
        ...
        return state.mutate(new Function1() { // from class: im.contact.IMContactTabStateMachine$inCommonState$1$6$1$$ExternalSyntheticLambda0
            public final Object invoke(Object obj) {
                IMContactTabData invokeSuspend$lambda$1$0;
                invokeSuspend$lambda$1$0 = IMContactTabStateMachine$inCommonState$1$6$1.invokeSuspend$lambda$1$0(error, (IMContactTabData) obj);
