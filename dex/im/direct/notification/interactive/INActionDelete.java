...
public final class INActionDelete implements INAction {
    ...
    public final INActionDelete copy(INMessageCard iNMessageCard) {
        Intrinsics.checkNotNullParameter(iNMessageCard, "card");
        return new INActionDelete(iNMessageCard);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof INActionDelete) && Intrinsics.areEqual(this.card, ((INActionDelete) obj).card);
    }
    ...
    public String toString() {
        return "INActionDelete(card=" + this.card + ")";
    }

    public INActionDelete(INMessageCard card) {
