...
public final class INActionThank implements INAction {
    ...
    public final INActionThank copy(INMessageCard iNMessageCard) {
        Intrinsics.checkNotNullParameter(iNMessageCard, "card");
        return new INActionThank(iNMessageCard);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof INActionThank) && Intrinsics.areEqual(this.card, ((INActionThank) obj).card);
    }
    ...
    public String toString() {
        return "INActionThank(card=" + this.card + ")";
    }

    public INActionThank(INMessageCard card) {
