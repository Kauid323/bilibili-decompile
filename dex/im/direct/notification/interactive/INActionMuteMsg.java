...
public final class INActionMuteMsg implements INAction {
    ...
    public final INActionMuteMsg copy(INMessageCard iNMessageCard) {
        Intrinsics.checkNotNullParameter(iNMessageCard, "card");
        return new INActionMuteMsg(iNMessageCard);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof INActionMuteMsg) && Intrinsics.areEqual(this.card, ((INActionMuteMsg) obj).card);
    }
    ...
    public String toString() {
        return "INActionMuteMsg(card=" + this.card + ")";
    }

    public INActionMuteMsg(INMessageCard card) {
