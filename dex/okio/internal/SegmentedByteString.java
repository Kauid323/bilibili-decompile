...
public final class SegmentedByteString {
    ...
    public static final int segment(C0043SegmentedByteString $this$segment, int pos) {
    ...
    public static final void forEachSegment(C0043SegmentedByteString $this$forEachSegment, Function3<? super byte[], ? super Integer, ? super Integer, Unit> action) {
    ...
    private static final void forEachSegment(C0043SegmentedByteString $this$forEachSegment, int beginIndex, int endIndex, Function3<? super byte[], ? super Integer, ? super Integer, Unit> function3) {
    ...
    public static final ByteString commonSubstring(C0043SegmentedByteString $this$commonSubstring, int beginIndex, int endIndex) {
        ...
        return new C0043SegmentedByteString(newSegments, newDirectory);
    }

    public static final byte commonInternalGet(C0043SegmentedByteString $this$commonInternalGet, int pos) {
    ...
    public static final int commonGetSize(C0043SegmentedByteString $this$commonGetSize) {
    ...
    public static final byte[] commonToByteArray(C0043SegmentedByteString $this$commonToByteArray) {
    ...
    public static final void commonWrite(C0043SegmentedByteString $this$commonWrite, Buffer buffer, int offset, int byteCount) {
        int $i$f$commonWrite;
    ...
    public static final boolean commonRangeEquals(C0043SegmentedByteString $this$commonRangeEquals, int offset, ByteString other, int otherOffset, int byteCount) {
    ...
    public static final boolean commonRangeEquals(C0043SegmentedByteString $this$commonRangeEquals, int offset, byte[] other, int otherOffset, int byteCount) {
        Intrinsics.checkNotNullParameter($this$commonRangeEquals, "<this>");
        Intrinsics.checkNotNullParameter(other, "other");
    ...
    public static final void commonCopyInto(C0043SegmentedByteString $this$commonCopyInto, int offset, byte[] target, int targetOffset, int byteCount) {
    ...
    public static final boolean commonEquals(C0043SegmentedByteString $this$commonEquals, Object other) {
    ...
    public static final int commonHashCode(C0043SegmentedByteString $this$commonHashCode) {
