...
public final class Buffer {
    ...
    */
    public static final long commonReadDecimalLong(okio.Buffer $this$commonReadDecimalLong) {
        boolean z;
        okio.Buffer buffer;
        byte b;
        boolean z2;
        okio.Buffer buffer2 = $this$commonReadDecimalLong;
        ...
        if ($this$commonReadDecimalLong.size() != 0) {
            ...
            okio.Buffer buffer3 = new okio.Buffer().writeDecimalLong(value).writeByte((int) b);
            if (!negative) {
                buffer3.readByte();
            }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final long commonReadHexadecimalUnsignedLong(okio.Buffer $this$commonReadHexadecimalUnsignedLong) {
        int digit;
    ...
    public static final ByteString commonSnapshot(okio.Buffer $this$commonSnapshot, int byteCount) {
        ...
        return new C0043SegmentedByteString(segments, directory);
    }
