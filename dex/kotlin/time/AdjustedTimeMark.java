...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1239getAdjustmentUwyO8pc() {
    ...
    public /* bridge */ TimeMark mo1236minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1356minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo1235elapsedNowUwyO8pc() {
        return Duration.m1273minusLRDsOJo(this.mark.mo1235elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1238plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1274plusLRDsOJo(this.adjustment, j), null);
    }
}