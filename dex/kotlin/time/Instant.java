...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final long toEpochMilliseconds() {
        if (this.epochSeconds >= 0) {
            ...
            return ((millis ^ sum$iv) >= 0 || (millis ^ b$iv) < 0) ? sum$iv : LongCompanionObject.MAX_VALUE;
        }
    ...
    public final Instant m1345plusLRDsOJo(long j) {
        long secondsToAdd = Duration.m1259getInWholeSecondsimpl(j);
        int nanosecondsToAdd = Duration.m1261getNanosecondsComponentimpl(j);
        ...
        if ((a$iv ^ sum$iv) < 0 && (a$iv ^ secondsToAdd) >= 0) {
            return Duration.m1272isPositiveimpl(j) ? MAX : MIN;
        }
    ...
    public final Instant m1343minusLRDsOJo(long j) {
        return m1345plusLRDsOJo(Duration.m1289unaryMinusUwyO8pc(j));
    }

    /* renamed from: minus-UwyO8pc  reason: not valid java name */
    public final long m1344minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.Companion;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.Companion;
        return Duration.m1274plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
    ...
    public int hashCode() {
        return ComposableSingletons$CustomBottomSheetKt$.ExternalSyntheticBackport0.m(this.epochSeconds) + (this.nanosecondsOfSecond * 51);
    }
