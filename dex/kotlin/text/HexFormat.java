        ...
        public BytesHexFormat(int bytesPerLine, int bytesPerGroup, String groupSeparator, String byteSeparator, String bytePrefix, String byteSuffix) {
            ...
            if (this.bytePrefix.length() == 0) {
                if ((this.byteSuffix.length() == 0) && this.byteSeparator.length() <= 1) {
                    ...
                    this.ignoreCase = (!HexFormatKt.access$isCaseSensitive(this.groupSeparator) || HexFormatKt.access$isCaseSensitive(this.byteSeparator) || HexFormatKt.access$isCaseSensitive(this.bytePrefix) || HexFormatKt.access$isCaseSensitive(this.byteSuffix)) ? true : z2;
                }
            }
            z = false;
            this.shortByteSeparatorNoPrefixAndSuffix = z;
        ...
        public NumberHexFormat(String prefix, String suffix, boolean removeLeadingZeros, int minLength) {
            ...
            if (this.prefix.length() == 0) {
                if (this.suffix.length() == 0) {
                    ...
                    this.ignoreCase = (!HexFormatKt.access$isCaseSensitive(this.prefix) || HexFormatKt.access$isCaseSensitive(this.suffix)) ? true : z2;
                }
            }
            z = false;
            this.isDigitsOnly = z;
