...
public abstract class KPropertyImpl<V> extends KCallableImpl<V> implements KProperty<V> {
    ...
    private KPropertyImpl(KDeclarationContainerImpl container, String name, String signature, PropertyDescriptor descriptorInitialValue, Object rawBoundReceiver) {
        ...
        this._javaField = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0(this) { // from class: kotlin.reflect.jvm.internal.KPropertyImpl$$Lambda$0
            ...
            public Object invoke() {
                Field _javaField$lambda$0;
                _javaField$lambda$0 = KPropertyImpl._javaField$lambda$0(this.arg$0);
                return _javaField$lambda$0;
            }
        });
        ReflectProperties.LazySoftVal<PropertyDescriptor> lazySoft = ReflectProperties.lazySoft(descriptorInitialValue, new Function0(this) { // from class: kotlin.reflect.jvm.internal.KPropertyImpl$$Lambda$1
            private final KPropertyImpl arg$0;
            ...
            @Override // kotlin.jvm.functions.Function0
            public Object invoke() {
                PropertyDescriptor _descriptor$lambda$0;
                _descriptor$lambda$0 = KPropertyImpl._descriptor$lambda$0(this.arg$0);
                return _descriptor$lambda$0;
            }
        });
    ...
    public KPropertyImpl(KDeclarationContainerImpl container, String name, String signature, Object boundReceiver) {
    ...
    */
    ...
    public static final Field _javaField$lambda$0(KPropertyImpl this$0) {
        ...
        if (jvmSignature instanceof JvmPropertySignature.KotlinProperty) {
            ...
            if (it != null) {
                ...
                if (owner != null) {
                    try {
                        return owner.getDeclaredField(it.getName());
    ...
    public final Member computeDelegateSource() {
        if (getDescriptor().isDelegated()) {
            JvmPropertySignature jvmSignature = RuntimeTypeMapper.INSTANCE.mapPropertySignature(getDescriptor());
            if ((jvmSignature instanceof JvmPropertySignature.KotlinProperty) && ((JvmPropertySignature.KotlinProperty) jvmSignature).getSignature().hasDelegateMethod()) {
                ...
                if (method.hasName() && method.hasDesc()) {
                    ...
                    return getContainer().findMethodBySignature(name, desc);
                }
                return null;
            }
            return getJavaField();
    ...
    public final Object getDelegateImpl(Member fieldOrMethod, Object receiver1, Object receiver2) {
        ...
        Object obj2;
        try {
            if ((receiver1 == EXTENSION_PROPERTY_DELEGATE || receiver2 == EXTENSION_PROPERTY_DELEGATE) && getDescriptor().getExtensionReceiverParameter() == null) {
                throw new RuntimeException('\'' + this + "' is not an extension property and thus getExtensionDelegate() is not going to work, use getDelegate() instead");
            }
            Object realReceiver1 = isBound() ? getBoundReceiver() : receiver1;
            Object it = realReceiver1;
            Object it2 = it != EXTENSION_PROPERTY_DELEGATE ? 1 : null;
            if (it2 == null) {
                realReceiver1 = null;
            }
            Object realReceiver2 = isBound() ? receiver1 : receiver2;
            Object it3 = realReceiver2;
            Object it4 = it3 != EXTENSION_PROPERTY_DELEGATE ? 1 : null;
            if (it4 == null) {
                realReceiver2 = null;
            }
            ...
            if (fieldOrMethod instanceof Field) {
                return ((Field) fieldOrMethod).get(realReceiver1);
            }
                ...
                switch (((Method) fieldOrMethod).getParameterTypes().length) {
                    ...
                    case 2:
                        ...
                        if (realReceiver2 == null) {
                            ...
                            obj2 = UtilKt.defaultPrimitiveValue(cls2);
                        } else {
                            obj2 = realReceiver2;
                        }
                        return method2.invoke(null, realReceiver1, obj2);
                    default:
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final PropertyDescriptor _descriptor$lambda$0(KPropertyImpl this$0) {
    ...
    public static abstract class Getter<V> extends Accessor<V, V> implements KProperty.Getter<V> {
        ...
        private final Lazy caller$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0(this) { // from class: kotlin.reflect.jvm.internal.KPropertyImpl$Getter$$Lambda$1
            ...
            public Object invoke() {
                ...
                caller_delegate$lambda$0 = KPropertyImpl.Getter.caller_delegate$lambda$0(this.arg$0);
        ...
        public static final PropertyGetterDescriptor descriptor_delegate$lambda$0(Getter this$0) {
            ...
            if (getter == null) {
                PropertyGetterDescriptorImpl createDefaultGetter = DescriptorFactory.createDefaultGetter(this$0.getProperty().getDescriptor(), Annotations.Companion.getEMPTY());
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final Caller caller_delegate$lambda$0(Getter this$0) {
    ...
    public static abstract class Setter<V> extends Accessor<V, Unit> implements KMutableProperty.Setter<V> {
        ...
        private final Lazy caller$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0(this) { // from class: kotlin.reflect.jvm.internal.KPropertyImpl$Setter$$Lambda$1
            ...
            public Object invoke() {
                Caller caller_delegate$lambda$0;
                caller_delegate$lambda$0 = KPropertyImpl.Setter.caller_delegate$lambda$0(this.arg$0);
                return caller_delegate$lambda$0;
            }
        });
        ...
        public static final PropertySetterDescriptor descriptor_delegate$lambda$0(Setter this$0) {
            ...
            if (setter == null) {
                PropertySetterDescriptorImpl createDefaultSetter = DescriptorFactory.createDefaultSetter(this$0.getProperty().getDescriptor(), Annotations.Companion.getEMPTY(), Annotations.Companion.getEMPTY());
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final Caller caller_delegate$lambda$0(Setter this$0) {
