...
public abstract class VariableDescriptorImpl extends DeclarationDescriptorNonRootImpl implements VariableDescriptor {
    ...
    public VariableDescriptorImpl(DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, KotlinType outType, SourceElement source) {
    ...
    public void setOutType(KotlinType outType) {
        if (this.outType != null && !TypeUtilsKt.shouldBeUpdated(this.outType)) {
