...
public interface JavaClassFinder {
    ...
    public static final class Request {
        ...
        public int hashCode() {
            return (((this.classId.hashCode() * 31) + (this.previouslyFoundClassFileContent == null ? 0 : Arrays.hashCode(this.previouslyFoundClassFileContent))) * 31) + (this.outerClass != null ? this.outerClass.hashCode() : 0);
        }
        ...
        public Request(ClassId classId, byte[] previouslyFoundClassFileContent, JavaClass outerClass) {
