...
public interface JavaResolverCache {
    public static final JavaResolverCache EMPTY = new JavaResolverCache() { // from class: kotlin.reflect.jvm.internal.impl.load.java.components.JavaResolverCache.1
        ...
        @Override // kotlin.reflect.jvm.internal.impl.load.java.components.JavaResolverCache
        public void recordMethod(JavaMember member, SimpleFunctionDescriptor descriptor) {
            if (member == null) {
                $$$reportNull$$$0(1);
            }
            if (descriptor == null) {
        ...
        @Override // kotlin.reflect.jvm.internal.impl.load.java.components.JavaResolverCache
        public void recordConstructor(JavaElement element, ConstructorDescriptor descriptor) {
            if (element == null) {
                $$$reportNull$$$0(3);
            }
            if (descriptor == null) {
        ...
        @Override // kotlin.reflect.jvm.internal.impl.load.java.components.JavaResolverCache
        public void recordField(JavaField field, PropertyDescriptor descriptor) {
            if (field == null) {
                $$$reportNull$$$0(5);
            }
            if (descriptor == null) {
        ...
        @Override // kotlin.reflect.jvm.internal.impl.load.java.components.JavaResolverCache
        public void recordClass(JavaClass javaClass, ClassDescriptor descriptor) {
            if (javaClass == null) {
                $$$reportNull$$$0(7);
            }
            if (descriptor == null) {
