...
public final class DeserializationComponentsForJava {
    ...
    public static final class Companion {
        ...
        public final ModuleData createModuleData(KotlinClassFinder kotlinClassFinder, KotlinClassFinder jvmBuiltInsKotlinClassFinder, JavaClassFinder javaClassFinder, String moduleName, ErrorReporter errorReporter, JavaSourceElementFactory javaSourceElementFactory) {
            ...
            ModuleDescriptorImpl module = new ModuleDescriptorImpl(special, storageManager, builtIns, null, null, null, 56, null);
            builtIns.setBuiltInsModule(module);
            builtIns.initialize(module, true);
            DeserializedDescriptorResolver deserializedDescriptorResolver = new DeserializedDescriptorResolver();
            SingleModuleClassResolver singleModuleClassResolver = new SingleModuleClassResolver();
            NotFoundClasses notFoundClasses = new NotFoundClasses(storageManager, module);
            LazyJavaPackageFragmentProvider lazyJavaPackageFragmentProvider = DeserializationComponentsForJavaKt.makeLazyJavaPackageFragmentProvider$default(javaClassFinder, module, storageManager, notFoundClasses, kotlinClassFinder, deserializedDescriptorResolver, errorReporter, javaSourceElementFactory, singleModuleClassResolver, null, ConstantsKt.MINIMUM_BLOCK_SIZE, null);
            DeserializationComponentsForJava deserializationComponentsForJava = DeserializationComponentsForJavaKt.makeDeserializationComponentsForJava(module, storageManager, notFoundClasses, lazyJavaPackageFragmentProvider, kotlinClassFinder, deserializedDescriptorResolver, errorReporter, MetadataVersion.INSTANCE);
            ...
            JvmBuiltInsPackageFragmentProvider builtinsProvider = new JvmBuiltInsPackageFragmentProvider(storageManager, jvmBuiltInsKotlinClassFinder, module, notFoundClasses, builtIns.getCustomizer(), builtIns.getCustomizer(), DeserializationConfiguration.Default.INSTANCE, NewKotlinTypeChecker.Companion.getDefault(), new SamConversionResolverImpl(storageManager, CollectionsKt.emptyList()));
            module.setDependencies(module);
            module.initialize(new CompositePackageFragmentProvider(CollectionsKt.listOf((Object[]) new PackageFragmentProviderOptimized[]{javaDescriptorResolver.getPackageFragmentProvider(), builtinsProvider}), "CompositeProvider@RuntimeModuleData for " + module));
