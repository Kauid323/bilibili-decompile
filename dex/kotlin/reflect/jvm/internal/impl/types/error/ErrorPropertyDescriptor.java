...
public final class ErrorPropertyDescriptor implements PropertyDescriptor {
    ...
    public ConstantValue<?> mo1163getCompileTimeInitializer() {
        return this.$$delegate_0.mo1163getCompileTimeInitializer();
    }
    ...
    public ErrorPropertyDescriptor() {
        PropertyDescriptorImpl $this$__delegate_0_u24lambda_u240 = PropertyDescriptorImpl.create(ErrorUtils.INSTANCE.getErrorClass(), Annotations.Companion.getEMPTY(), Modality.OPEN, DescriptorVisibilities.PUBLIC, true, Name.special(ErrorEntity.ERROR_PROPERTY.getDebugText()), CallableMemberDescriptor.Kind.DECLARATION, SourceElement.NO_SOURCE, false, false, false, false, false, false);
        $this$__delegate_0_u24lambda_u240.setType(ErrorUtils.INSTANCE.getErrorPropertyType(), CollectionsKt.emptyList(), null, null, CollectionsKt.emptyList());
        this.$$delegate_0 = $this$__delegate_0_u24lambda_u240;
    }
}