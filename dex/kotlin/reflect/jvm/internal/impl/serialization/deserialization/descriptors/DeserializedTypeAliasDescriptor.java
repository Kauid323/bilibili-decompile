...
public final class DeserializedTypeAliasDescriptor extends AbstractTypeAliasDescriptor implements DeserializedMemberDescriptor {
    ...
    */
    public DeserializedTypeAliasDescriptor(StorageManager storageManager, DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, DescriptorVisibility visibility, ProtoBuf.TypeAlias proto, NameResolver nameResolver, TypeTable typeTable, VersionRequirementTable versionRequirementTable, DeserializedContainerSource containerSource) {
    ...
    public ClassDescriptor getClassDescriptor() {
        ...
        ClassifierDescriptor mo1171getDeclarationDescriptor = getExpandedType().getConstructor().mo1171getDeclarationDescriptor();
    ...
    public TypeAliasDescriptor substitute(TypeSubstitutor substitutor) {
        ...
        substituted.initialize(declaredTypeParameters, asSimpleType, TypeSubstitutionKt.asSimpleType(safeSubstitute2));
        return substituted;
    }
