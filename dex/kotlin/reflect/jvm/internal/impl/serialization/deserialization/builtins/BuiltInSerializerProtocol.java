...
public final class BuiltInSerializerProtocol extends SerializerExtensionProtocol {
    ...
    */
    private BuiltInSerializerProtocol() {
        super(p0, packageFqName, constructorAnnotation, classAnnotation, functionAnnotation, null, propertyAnnotation, propertyGetterAnnotation, propertySetterAnnotation, null, null, null, enumEntryAnnotation, compileTimeValue, parameterAnnotation, typeAnnotation, typeParameterAnnotation);
    ...
    public final String getBuiltInsFilePath(FqName fqName) {
        ...
        return StringsKt.replace$default(fqName.asString(), (char) FilenameUtils.EXTENSION_SEPARATOR, '/', false, 4, (Object) null) + '/' + getBuiltInsFileName(fqName);
    }
