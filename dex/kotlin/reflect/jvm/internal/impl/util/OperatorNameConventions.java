...
public final class OperatorNameConventions {
    ...
    static {
        ...
        UNARY_OPERATION_NAMES = SetsKt.setOf((Object[]) new Name[]{INC, DEC, UNARY_PLUS, UNARY_MINUS, NOT, INV});
        SIMPLE_UNARY_OPERATION_NAMES = SetsKt.setOf((Object[]) new Name[]{UNARY_PLUS, UNARY_MINUS, NOT, INV});
        BINARY_OPERATION_NAMES = SetsKt.setOf((Object[]) new Name[]{TIMES, PLUS, MINUS, DIV, REM, RANGE_TO, RANGE_UNTIL});
        SIMPLE_BINARY_OPERATION_NAMES = SetsKt.setOf((Object[]) new Name[]{TIMES, PLUS, MINUS, DIV, REM});
        BITWISE_OPERATION_NAMES = SetsKt.setOf((Object[]) new Name[]{AND, OR, XOR, INV, SHL, SHR, USHR});
        SIMPLE_BITWISE_OPERATION_NAMES = SetsKt.setOf((Object[]) new Name[]{AND, OR, XOR, SHL, SHR, USHR});
        ALL_BINARY_OPERATION_NAMES = SetsKt.plus(SetsKt.plus((Set) BINARY_OPERATION_NAMES, (Iterable) BITWISE_OPERATION_NAMES), (Iterable) SetsKt.setOf((Object[]) new Name[]{EQUALS, CONTAINS, COMPARE_TO}));
        ASSIGNMENT_OPERATIONS = SetsKt.setOf((Object[]) new Name[]{TIMES_ASSIGN, DIV_ASSIGN, REM_ASSIGN, PLUS_ASSIGN, MINUS_ASSIGN});
        ...
        NUMBER_CONVERSIONS = SetsKt.setOf((Object[]) new Name[]{TO_DOUBLE, TO_FLOAT, TO_LONG, TO_INT, TO_SHORT, TO_BYTE, TO_CHAR});
        TOKENS_BY_OPERATOR_NAME = MapsKt.mapOf(TuplesKt.to(INC, "++"), TuplesKt.to(DEC, HelpFormatter.DEFAULT_LONG_OPT_PREFIX), TuplesKt.to(UNARY_PLUS, Marker.ANY_NON_NULL_MARKER), TuplesKt.to(UNARY_MINUS, HelpFormatter.DEFAULT_OPT_PREFIX), TuplesKt.to(NOT, "!"), TuplesKt.to(TIMES, Marker.ANY_MARKER), TuplesKt.to(PLUS, Marker.ANY_NON_NULL_MARKER), TuplesKt.to(MINUS, HelpFormatter.DEFAULT_OPT_PREFIX), TuplesKt.to(DIV, "/"), TuplesKt.to(REM, "%"), TuplesKt.to(RANGE_TO, ".."), TuplesKt.to(RANGE_UNTIL, "..<"));
    }
}