...
final class ConcurrentHashMapCache<V> extends CacheByClass<V> {
    ...
    public V get(Class<?> key) {
        ...
        V v = (V) $this$getOrPut$iv.get(key);
        if (v == null) {
            V invoke = this.compute.invoke(key);
            V v2 = (V) $this$getOrPut$iv.putIfAbsent(key, invoke);
