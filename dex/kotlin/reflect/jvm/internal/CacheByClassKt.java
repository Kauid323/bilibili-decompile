...
public final class CacheByClassKt {
    ...
    static {
        ...
        try {
            ...
            z = Result.constructor-impl(Class.forName("java.lang.ClassValue"));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            z = Result.constructor-impl(ResultKt.createFailure(th));
        }
        if (Result.isSuccess-impl(z)) {
            Result.Companion companion3 = Result.Companion;
            Class cls = (Class) z;
            z = true;
        }
        Object obj = Result.constructor-impl(z);
        if (Result.isFailure-impl(obj)) {
            obj = false;
        }
        useClassValue = ((Boolean) obj).booleanValue();
    }
