...
public final class ComputableClassValue<V> extends ClassValue<SoftReference<V>> {
    ...
    public /* bridge */ /* synthetic */ Object computeValue(Class p0) {
        return m1158computeValue((Class<?>) p0);
    }

    /* renamed from: computeValue  reason: collision with other method in class */
    protected SoftReference<V> m1158computeValue(Class<?> type) {
