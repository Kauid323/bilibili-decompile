...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    private UIntProgressionIterator(int first, int last, int step) {
        ...
        boolean z = true;
        if (step <= 0 ? ConverterUtilsKt$.ExternalSyntheticBackport0.m(first, last) < 0 : ConverterUtilsKt$.ExternalSyntheticBackport0.m(first, last) > 0) {
            z = false;
        }
        this.hasNext = z;
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.box-impl(m1113nextpVg5ArA());
    }
