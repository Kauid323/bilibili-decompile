...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    private ULongProgressionIterator(long first, long last, long step) {
        ...
        boolean z = true;
        if (step <= 0 ? MutableFloatFloatMap$.ExternalSyntheticBackport0.m(first, last) < 0 : MutableFloatFloatMap$.ExternalSyntheticBackport0.m(first, last) > 0) {
            z = false;
        }
        this.hasNext = z;
    ...
    public /* bridge */ /* synthetic */ ULong next() {
        return ULong.box-impl(m1122nextsVKNKU());
    }
