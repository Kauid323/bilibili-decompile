...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int start, int endInclusive, int step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1095getProgressionLastElementNkh28Cs(start, endInclusive, step);
        this.step = step;
    }

    /* renamed from: getFirst-pVg5ArA  reason: not valid java name */
    public final int m1110getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m1111getLastpVg5ArA() {
        return this.last;
    }
    ...
    public boolean isEmpty() {
        if (this.step > 0) {
            if (ConverterUtilsKt$.ExternalSyntheticBackport0.m(this.first, this.last) > 0) {
                return true;
            }
        } else if (ConverterUtilsKt$.ExternalSyntheticBackport0.m(this.first, this.last) < 0) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        int i;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) UInt.toString-impl(this.first)).append("..").append((Object) UInt.toString-impl(this.last)).append(" step ");
            i = this.step;
        } else {
            append = new StringBuilder().append((Object) UInt.toString-impl(this.first)).append(" downTo ").append((Object) UInt.toString-impl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1112fromClosedRangeNkh28Cs(int i, int i2, int step) {
