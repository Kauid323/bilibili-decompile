        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m450contentEqualskV0jMPg(((UByteArray) t).unbox-impl(), ((UByteArray) t2).unbox-impl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m448contentEqualsFGO6Aew(((UShortArray) t).unbox-impl(), ((UShortArray) t2).unbox-impl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m449contentEqualsKJPZfPQ(((UIntArray) t).unbox-impl(), ((UIntArray) t2).unbox-impl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m451contentEqualslec5QzE(((ULongArray) t).unbox-impl(), ((ULongArray) t2).unbox-impl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder result, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                result.append(UArraysKt.m456contentToString2csIQuQ(uByteArray != null ? uByteArray.unbox-impl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                result.append(UArraysKt.m458contentToStringd6D3K8(uShortArray != null ? uShortArray.unbox-impl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                result.append(UArraysKt.m457contentToStringXUkPCBk(uIntArray != null ? uIntArray.unbox-impl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                result.append(UArraysKt.m459contentToStringuLth9ew(uLongArray != null ? uLongArray.unbox-impl() : null));
            } else {
