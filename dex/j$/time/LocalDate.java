...
public final class LocalDate implements Temporal, TemporalAdjuster, ChronoLocalDate, Serializable {
    ...
    public static LocalDate ofInstant(Instant instant, ZoneId zone) {
        ...
        long localEpochDay = LocalDate$$ExternalSyntheticBackport8.m(localSecond, 86400);
    ...
    public static LocalDate parse(CharSequence text, DateTimeFormatter formatter) {
        ...
        return (LocalDate) formatter.parse(text, new TemporalQuery() { // from class: j$.time.LocalDate$$ExternalSyntheticLambda9
    ...
    public DayOfWeek getDayOfWeek() {
        int dow0 = LocalDate$$ExternalSyntheticBackport4.m(toEpochDay() + 3, 7);
    ...
    public LocalDate plus(long amountToAdd, TemporalUnit unit) {
        if (unit instanceof ChronoUnit) {
            ...
            switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[f.ordinal()]) {
                ...
                case 5:
                    return plusYears(LocalDate$$ExternalSyntheticBackport0.m(amountToAdd, 10));
                case 6:
                    return plusYears(LocalDate$$ExternalSyntheticBackport1.m(amountToAdd, 100));
                case 7:
                    return plusYears(LocalDate$$ExternalSyntheticBackport2.m(amountToAdd, 1000));
                case AbstractSpinedBuffer.MIN_SPINE_SIZE /* 8 */:
    ...
    public LocalDate plusMonths(long monthsToAdd) {
        ...
        int newYear = ChronoField.YEAR.checkValidIntValue(LocalDate$$ExternalSyntheticBackport6.m(calcMonths, 12));
        int newMonth = LocalDate$$ExternalSyntheticBackport7.m(calcMonths, 12) + 1;
        return resolvePreviousValid(newYear, newMonth, this.day);
    }

    public LocalDate plusWeeks(long weeksToAdd) {
        return plusDays(LocalDate$$ExternalSyntheticBackport3.m(weeksToAdd, 7));
    }
    ...
    public Period until(ChronoLocalDate endDateExclusive) {
        ...
        return Period.of(LocalDate$$ExternalSyntheticBackport5.m(years), months, days);
    }
    ...
    public Stream<LocalDate> datesUntil(LocalDate endExclusive, Period step) {
        ...
        if (!((sign < 0) ^ (until < 0))) {
            if (months == 0) {
                return LongStream.CC.rangeClosed(0L, (until - sign) / days).mapToObj(new LongFunction() { // from class: j$.time.LocalDate$$ExternalSyntheticLambda10
            ...
            if (sign * addMonths <= maxAddMonths && (plusMonths(addMonths).toEpochDay() + addDays) * sign < sign * end) {
                steps = steps2;
                return LongStream.CC.rangeClosed(0L, steps).mapToObj(new LongFunction() { // from class: j$.time.LocalDate$$ExternalSyntheticLambda11
                    @Override // java.util.function.LongFunction
                    public final Object apply(long j) {
                        return LocalDate.this.m5lambda$datesUntil$1$javatimeLocalDate(months, days, j);
                    }
                });
            }
    ...
    public /* synthetic */ LocalDate m5lambda$datesUntil$1$javatimeLocalDate(long months, long days, long n) {
