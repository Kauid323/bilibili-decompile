...
public final class Period implements ChronoPeriod, Serializable {
    ...
    private static final List<TemporalUnit> SUPPORTED_UNITS = Period$$ExternalSyntheticBackport2.m(ChronoUnit.YEARS, ChronoUnit.MONTHS, ChronoUnit.DAYS);
    ...
    public static Period ofWeeks(int weeks) {
        return create(0, 0, Period$$ExternalSyntheticBackport0.m(weeks, 7));
    }
    ...
    public static Period from(TemporalAmount amount) {
        ...
        for (TemporalUnit unit : amount.getUnits()) {
            ...
            if (unit == ChronoUnit.YEARS) {
                years = LocalDate$$ExternalSyntheticBackport5.m(unitAmount);
            } else if (unit == ChronoUnit.MONTHS) {
                months = LocalDate$$ExternalSyntheticBackport5.m(unitAmount);
            } else if (unit == ChronoUnit.DAYS) {
                days = LocalDate$$ExternalSyntheticBackport5.m(unitAmount);
            } else {
        ...
        if (matcher.matches()) {
            ...
            if (yearStart >= 0 || monthStart >= 0 || weekStart >= 0 || dayStart >= 0) {
                try {
                    ...
                    try {
                        return create(years, months, Period$$ExternalSyntheticBackport3.m(days, Period$$ExternalSyntheticBackport0.m(weeks, 7)));
    ...
    private static int parseNumber(CharSequence text, int start, int end, int negate) {
        ...
        int val = Duration$$ExternalSyntheticBackport4.m(text, start, end, 10);
        try {
            return Period$$ExternalSyntheticBackport0.m(val, negate);
    ...
    public Period plus(TemporalAmount amountToAdd) {
        ...
        return create(Period$$ExternalSyntheticBackport3.m(this.years, isoAmount.years), Period$$ExternalSyntheticBackport3.m(this.months, isoAmount.months), Period$$ExternalSyntheticBackport3.m(this.days, isoAmount.days));
    }
    ...
    public Period plusYears(long yearsToAdd) {
        ...
        return create(LocalDate$$ExternalSyntheticBackport5.m(Clock$OffsetClock$$ExternalSyntheticBackport0.m(this.years, yearsToAdd)), this.months, this.days);
    }
    ...
    public Period plusMonths(long monthsToAdd) {
        ...
        return create(this.years, LocalDate$$ExternalSyntheticBackport5.m(Clock$OffsetClock$$ExternalSyntheticBackport0.m(this.months, monthsToAdd)), this.days);
    }
    ...
    public Period plusDays(long daysToAdd) {
        ...
        return create(this.years, this.months, LocalDate$$ExternalSyntheticBackport5.m(Clock$OffsetClock$$ExternalSyntheticBackport0.m(this.days, daysToAdd)));
    }
    ...
    public Period multipliedBy(int scalar) {
        ...
        return create(Period$$ExternalSyntheticBackport0.m(this.years, scalar), Period$$ExternalSyntheticBackport0.m(this.months, scalar), Period$$ExternalSyntheticBackport0.m(this.days, scalar));
    }
    ...
    public Period normalized() {
        ...
        return create(LocalDate$$ExternalSyntheticBackport5.m(splitYears), splitMonths, this.days);
    }
