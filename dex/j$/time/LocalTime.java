...
public final class LocalTime implements Temporal, TemporalAdjuster, Comparable<LocalTime>, Serializable {
    ...
    public static LocalTime ofInstant(Instant instant, ZoneId zone) {
        ...
        int secsOfDay = LocalTime$$ExternalSyntheticBackport0.m(localSecond, SECONDS_PER_DAY);
    ...
    public static LocalTime parse(CharSequence text, DateTimeFormatter formatter) {
        ...
        return (LocalTime) formatter.parse(text, new TemporalQuery() { // from class: j$.time.LocalTime$$ExternalSyntheticLambda1
    ...
    private int get0(TemporalField field) {
        switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoField[((ChronoField) field).ordinal()]) {
            ...
            case 13:
                return this.hour;
            case 14:
                return this.hour == 0 ? HOURS_PER_DAY : this.hour;
            case 15:
                return this.hour / 12;
            default:
    ...
    public LocalTime with(TemporalField field, long newValue) {
        if (field instanceof ChronoField) {
            ...
            switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoField[f.ordinal()]) {
                ...
                case 6:
                    return ofNanoOfDay(NANOS_PER_MILLI * newValue);
                case 7:
    ...
    public LocalTime plus(long amountToAdd, TemporalUnit unit) {
        if (unit instanceof ChronoUnit) {
            switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) unit).ordinal()]) {
                ...
                case 3:
                    return plusNanos((amountToAdd % MILLIS_PER_DAY) * NANOS_PER_MILLI);
                case 4:
    ...
    public LocalTime plusHours(long hoursToAdd) {
        ...
        int newHour = ((((int) (hoursToAdd % 24)) + this.hour) + HOURS_PER_DAY) % HOURS_PER_DAY;
    ...
    public long until(Temporal endExclusive, TemporalUnit unit) {
        ...
        if (unit instanceof ChronoUnit) {
            ...
            switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) unit).ordinal()]) {
                ...
                case 3:
                    return nanosUntil / NANOS_PER_MILLI;
                case 4:
