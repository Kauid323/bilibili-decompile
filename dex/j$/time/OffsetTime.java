...
public final class OffsetTime implements Temporal, TemporalAdjuster, Comparable<OffsetTime>, Serializable {
    ...
    public static OffsetTime ofInstant(Instant instant, ZoneId zone) {
        ...
        int secsOfDay = OffsetTime$$ExternalSyntheticBackport0.m(localSecond, 86400);
    ...
    public static OffsetTime parse(CharSequence text, DateTimeFormatter formatter) {
        ...
        return (OffsetTime) formatter.parse(text, new TemporalQuery() { // from class: j$.time.OffsetTime$$ExternalSyntheticLambda1
    ...
    public String toString() {
        ...
        return localTime + this.offset.toString();
    }
