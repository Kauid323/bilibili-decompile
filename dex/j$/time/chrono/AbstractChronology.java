...
public abstract class AbstractChronology implements Chronology {
    ...
    */
    ...
    ChronoLocalDate resolveYearOfEra(Map<TemporalField, Long> map, ResolverStyle resolverStyle) {
        ...
        if (yoeLong != null) {
            ...
            if (resolverStyle != ResolverStyle.LENIENT) {
                ...
                yoe = LocalDate$$ExternalSyntheticBackport5.m(yoeLong.longValue());
            }
            if (eraLong != null) {
    ...
    ChronoLocalDate resolveYMAA(Map<TemporalField, Long> map, ResolverStyle resolverStyle) {
        ...
        if (resolverStyle == ResolverStyle.LENIENT) {
            long months = Instant$$ExternalSyntheticBackport6.m(map.remove(ChronoField.MONTH_OF_YEAR).longValue(), 1L);
            long weeks = Instant$$ExternalSyntheticBackport6.m(map.remove(ChronoField.ALIGNED_WEEK_OF_MONTH).longValue(), 1L);
            long days = Instant$$ExternalSyntheticBackport6.m(map.remove(ChronoField.ALIGNED_DAY_OF_WEEK_IN_MONTH).longValue(), 1L);
    ...
    ChronoLocalDate resolveYMAD(Map<TemporalField, Long> map, ResolverStyle resolverStyle) {
        ...
        long months = Instant$$ExternalSyntheticBackport6.m(map.remove(ChronoField.MONTH_OF_YEAR).longValue(), 1L);
        long weeks = Instant$$ExternalSyntheticBackport6.m(map.remove(ChronoField.ALIGNED_WEEK_OF_MONTH).longValue(), 1L);
        long dow2 = Instant$$ExternalSyntheticBackport6.m(map.remove(ChronoField.DAY_OF_WEEK).longValue(), 1L);
    ...
    ChronoLocalDate resolveYAA(Map<TemporalField, Long> map, ResolverStyle resolverStyle) {
        int y = range(ChronoField.YEAR).checkValidIntValue(map.remove(ChronoField.YEAR).longValue(), ChronoField.YEAR);
        if (resolverStyle == ResolverStyle.LENIENT) {
            long weeks = Instant$$ExternalSyntheticBackport6.m(map.remove(ChronoField.ALIGNED_WEEK_OF_YEAR).longValue(), 1L);
            long days = Instant$$ExternalSyntheticBackport6.m(map.remove(ChronoField.ALIGNED_DAY_OF_WEEK_IN_YEAR).longValue(), 1L);
    ...
    ChronoLocalDate resolveAligned(ChronoLocalDate base, long months, long weeks, long dow) {
        ...
        if (dow > 7) {
            ...
            date = date.plus(Instant$$ExternalSyntheticBackport6.m(dow, 7L) / 7, (TemporalUnit) ChronoUnit.WEEKS);
            dow = ((6 + dow) % 7) + 1;
        }
