...
public final class HijrahDate extends ChronoLocalDateImpl<HijrahDate> implements ChronoLocalDate, Serializable {
    ...
    private int getDayOfWeek() {
        int dow0 = HijrahDate$$ExternalSyntheticBackport0.m(toEpochDay() + 3, 7);
        return dow0 + 1;
    }
    ...
    public HijrahDate plusYears(long years) {
        ...
        int newYear = Period$$ExternalSyntheticBackport3.m(this.prolepticYear, (int) years);
    ...
    public HijrahDate plusMonths(long monthsToAdd) {
        ...
        int newYear = this.chrono.checkValidYear(DesugarLocalDate$$ExternalSyntheticBackport0.m(calcMonths, 12L));
    ...
    public ChronoPeriod until(ChronoLocalDate endDate) {
        ...
        return getChronology().period(LocalDate$$ExternalSyntheticBackport5.m(years), months, days);
    }
