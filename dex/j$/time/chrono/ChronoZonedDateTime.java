...
public interface ChronoZonedDateTime<D extends ChronoLocalDate> extends Temporal, Comparable<ChronoZonedDateTime<?>> {
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ int lambda$timeLineOrder$f56e6d02$1(ChronoZonedDateTime dateTime1, ChronoZonedDateTime dateTime2) {
        ...
        public static int $default$compareTo(ChronoZonedDateTime _this, ChronoZonedDateTime chronoZonedDateTime) {
            int cmp = Long.compare(_this.toEpochSecond(), chronoZonedDateTime.toEpochSecond());
            if (cmp == 0) {
