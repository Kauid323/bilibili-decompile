...
public final class JulianFields {
    ...
    private enum Field implements TemporalField {
        ...
        public <R extends Temporal> R adjustInto(R temporal, long newValue) {
            ...
            return (R) temporal.with(ChronoField.EPOCH_DAY, Instant$$ExternalSyntheticBackport6.m(newValue, this.offset));
        }
        ...
        public ChronoLocalDate resolve(Map<TemporalField, Long> map, TemporalAccessor partialTemporal, ResolverStyle resolverStyle) {
            ...
            if (resolverStyle == ResolverStyle.LENIENT) {
                return chrono.dateEpochDay(Instant$$ExternalSyntheticBackport6.m(value, this.offset));
            }
