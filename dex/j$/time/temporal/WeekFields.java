...
public final class WeekFields implements Serializable {
    ...
    public String toString() {
        ...
        return "WeekFields[" + dayOfWeek + "," + this.minimalDays + "]";
    }
    ...
    static class ComputedDayOfField implements TemporalField {
        ...
        public ChronoLocalDate resolve(Map<TemporalField, Long> map, TemporalAccessor partialTemporal, ResolverStyle resolverStyle) {
            ...
            int newValue = LocalDate$$ExternalSyntheticBackport5.m(value);
            if (this.rangeUnit == ChronoUnit.WEEKS) {
        ...
        private ChronoLocalDate resolveWoM(Map<TemporalField, Long> map, Chronology chrono, int year, long month, long wom, int localDow, ResolverStyle resolverStyle) {
            ...
            if (resolverStyle == ResolverStyle.LENIENT) {
                ChronoLocalDate date2 = chrono.date(year, 1, 1).plus(Instant$$ExternalSyntheticBackport6.m(month, 1L), (TemporalUnit) ChronoUnit.MONTHS);
                long weeks = Instant$$ExternalSyntheticBackport6.m(wom, localizedWeekOfMonth(date2));
                int days = localDow - localizedDayOfWeek(date2);
                long m = WeekFields$ComputedDayOfField$$ExternalSyntheticBackport2.m(weeks, 7);
                long weeks2 = days;
        ...
        private ChronoLocalDate resolveWoY(Map<TemporalField, Long> map, Chronology chrono, int year, long woy, int localDow, ResolverStyle resolverStyle) {
            ...
            if (resolverStyle == ResolverStyle.LENIENT) {
                long weeks = Instant$$ExternalSyntheticBackport6.m(woy, localizedWeekOfYear(date2));
                int days = localDow - localizedDayOfWeek(date2);
                date = date2.plus(Clock$OffsetClock$$ExternalSyntheticBackport0.m(WeekFields$ComputedDayOfField$$ExternalSyntheticBackport1.m(weeks, 7), days), (TemporalUnit) ChronoUnit.DAYS);
            } else {
        ...
        private ChronoLocalDate resolveWBY(Map<TemporalField, Long> map, Chronology chrono, int localDow, ResolverStyle resolverStyle) {
            ...
            if (resolverStyle == ResolverStyle.LENIENT) {
                ...
                long weeks = Instant$$ExternalSyntheticBackport6.m(wowby, 1L);
        ...
        public String toString() {
            ...
            return str + "[" + this.weekDef.toString() + "]";
        }
    }
}