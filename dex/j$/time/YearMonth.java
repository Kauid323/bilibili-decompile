...
public final class YearMonth implements Temporal, TemporalAdjuster, Comparable<YearMonth>, Serializable {
    ...
    public static YearMonth parse(CharSequence text, DateTimeFormatter formatter) {
        ...
        return (YearMonth) formatter.parse(text, new TemporalQuery() { // from class: j$.time.YearMonth$$ExternalSyntheticLambda5
    ...
    public YearMonth plus(long amountToAdd, TemporalUnit unit) {
        if (unit instanceof ChronoUnit) {
            switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) unit).ordinal()]) {
                ...
                case 3:
                    return plusYears(YearMonth$$ExternalSyntheticBackport2.m(amountToAdd, 10));
                case 4:
                    return plusYears(YearMonth$$ExternalSyntheticBackport3.m(amountToAdd, 100));
                case 5:
                    return plusYears(YearMonth$$ExternalSyntheticBackport4.m(amountToAdd, 1000));
                case 6:
    ...
    public YearMonth plusMonths(long monthsToAdd) {
        ...
        int newYear = ChronoField.YEAR.checkValidIntValue(YearMonth$$ExternalSyntheticBackport0.m(calcMonths, 12));
        int newMonth = YearMonth$$ExternalSyntheticBackport1.m(calcMonths, 12) + 1;
