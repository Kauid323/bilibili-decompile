...
public final class Year implements Temporal, TemporalAdjuster, Comparable<Year>, Serializable {
    ...
    public static Year parse(CharSequence text, DateTimeFormatter formatter) {
        ...
        return (Year) formatter.parse(text, new TemporalQuery() { // from class: j$.time.Year$$ExternalSyntheticLambda3
    ...
    public Year plus(long amountToAdd, TemporalUnit unit) {
        if (unit instanceof ChronoUnit) {
            switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) unit).ordinal()]) {
                ...
                case DesugarCalendar.LONG_FORMAT /* 2 */:
                    return plusYears(Year$$ExternalSyntheticBackport0.m(amountToAdd, 10));
                case 3:
                    return plusYears(Year$$ExternalSyntheticBackport1.m(amountToAdd, 100));
                case 4:
                    return plusYears(Year$$ExternalSyntheticBackport2.m(amountToAdd, 1000));
                case 5:
