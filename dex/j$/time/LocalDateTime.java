...
public final class LocalDateTime implements Temporal, TemporalAdjuster, ChronoLocalDateTime<LocalDate>, Serializable {
    ...
    public static LocalDateTime ofEpochSecond(long epochSecond, int nanoOfSecond, ZoneOffset offset) {
        ...
        long localEpochDay = LocalDateTime$$ExternalSyntheticBackport4.m(localSecond, 86400);
        int secsOfDay = LocalDateTime$$ExternalSyntheticBackport5.m(localSecond, 86400);
    ...
    public static LocalDateTime parse(CharSequence text, DateTimeFormatter formatter) {
        ...
        return (LocalDateTime) formatter.parse(text, new TemporalQuery() { // from class: j$.time.LocalDateTime$$ExternalSyntheticLambda6
    ...
    private LocalDateTime plusWithOverflow(LocalDate newDate, long hours, long minutes, long seconds, long nanos, int sign) {
        ...
        long totDays2 = (totDays * sign) + DesugarLocalDate$$ExternalSyntheticBackport0.m(totNanos, 86400000000000L);
            ...
            if (unit.isTimeBased()) {
                ...
                switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) unit).ordinal()]) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        amount = LocalDateTime$$ExternalSyntheticBackport0.m(amount, 86400);
                        timePart /= 1000000000;
                        break;
                    case 5:
                        amount = LocalDateTime$$ExternalSyntheticBackport1.m(amount, 1440);
                        timePart /= 60000000000L;
                        break;
                    case 6:
                        amount = LocalDateTime$$ExternalSyntheticBackport2.m(amount, 24);
                        timePart /= 3600000000000L;
                        break;
                    case 7:
                        amount = LocalDateTime$$ExternalSyntheticBackport3.m(amount, 2);
    ...
    public String toString() {
        ...
        return localDate + "T" + this.time.toString();
    }
