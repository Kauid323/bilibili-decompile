...
final class SortedOps {
    ...
    public static final class OfRef<T> extends ReferencePipeline.StatefulOp<T, T> {
        ...
        public <P_IN> Node<T> opEvaluateParallel(PipelineHelper<T> pipelineHelper, Spliterator<P_IN> spliterator, IntFunction<T[]> generator) {
            ...
            T[] flattenedData = pipelineHelper.evaluate(spliterator, true, generator).asArray(generator);
    ...
    public static final class OfInt extends IntPipeline.StatefulOp<Integer> {
        ...
        public <P_IN> Node<Integer> opEvaluateParallel(PipelineHelper<Integer> pipelineHelper, Spliterator<P_IN> spliterator, IntFunction<Integer[]> generator) {
            if (StreamOpFlag.SORTED.isKnown(pipelineHelper.getStreamAndOpFlags())) {
                return pipelineHelper.evaluate(spliterator, false, generator);
            }
            Node.OfInt n = (Node.OfInt) pipelineHelper.evaluate(spliterator, true, generator);
    ...
    public static final class OfLong extends LongPipeline.StatefulOp<Long> {
        ...
        public <P_IN> Node<Long> opEvaluateParallel(PipelineHelper<Long> pipelineHelper, Spliterator<P_IN> spliterator, IntFunction<Long[]> generator) {
            if (StreamOpFlag.SORTED.isKnown(pipelineHelper.getStreamAndOpFlags())) {
                return pipelineHelper.evaluate(spliterator, false, generator);
            }
            Node.OfLong n = (Node.OfLong) pipelineHelper.evaluate(spliterator, true, generator);
    ...
    private static final class OfDouble extends DoublePipeline.StatefulOp<Double> {
        ...
        public <P_IN> Node<Double> opEvaluateParallel(PipelineHelper<Double> pipelineHelper, Spliterator<P_IN> spliterator, IntFunction<Double[]> generator) {
            if (StreamOpFlag.SORTED.isKnown(pipelineHelper.getStreamAndOpFlags())) {
                return pipelineHelper.evaluate(spliterator, false, generator);
            }
            Node.OfDouble n = (Node.OfDouble) pipelineHelper.evaluate(spliterator, true, generator);
