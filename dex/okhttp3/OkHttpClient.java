...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    @Nullable
    final NetworkBridgeInterceptor.Factory bridgeFactory;
    @Nullable
    final Cache cache;
    ...
    OkHttpClient(Builder builder) {
        ...
        this.f14proxy = builder.f15proxy;
        this.protocols = builder.protocols;
        this.connectionSpecs = builder.connectionSpecs;
        this.interceptors = Util.immutableList(builder.interceptors);
        this.bridgeFactory = builder.bridgeFactory;
    ...
    public static final class Builder {
        ...
        @Nullable
        NetworkBridgeInterceptor.Factory bridgeFactory;
        @Nullable
        Cache cache;
        int callTimeout;
        @Nullable
        ...
        Builder(OkHttpClient okHttpClient) {
            ...
            this.f15proxy = okHttpClient.f14proxy;
            this.protocols = okHttpClient.protocols;
            this.connectionSpecs = okHttpClient.connectionSpecs;
            this.interceptors.addAll(okHttpClient.interceptors);
            this.bridgeFactory = okHttpClient.bridgeFactory;
        ...
        private void ensureCallTimeout() {
            if (this.callTimeout != 0) {
                this.callTimeout = Math.max(Math.max(this.callTimeout, this.connectTimeout), Math.max(this.readTimeout, this.writeTimeout));
            }
        }
    }
}