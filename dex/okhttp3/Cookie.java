...
public final class Cookie {
    ...
    private static long parseMaxAge(String s) {
        try {
            ...
            if (s.matches("-?\\d+")) {
                if (s.startsWith(HelpFormatter.DEFAULT_OPT_PREFIX)) {
                    return Long.MIN_VALUE;
                }
    ...
    public int hashCode() {
        ...
        return (((((((((((((((hash * 31) + this.value.hashCode()) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31) + ((int) (this.expiresAt ^ (this.expiresAt >>> 32)))) * 31) + (!this.secure ? 1 : 0)) * 31) + (!this.httpOnly ? 1 : 0)) * 31) + (!this.persistent ? 1 : 0)) * 31) + (!this.hostOnly ? 1 : 0);
    }
}